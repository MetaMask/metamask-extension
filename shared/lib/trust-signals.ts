...
const CHAIN_IDS_LOWERCASED: Record<string, SupportedEVMChain> = {
  ...
  [CHAIN_IDS.ARC.toLowerCase()]: SupportedEVMChain.Arc,
  [CHAIN_IDS.HYPE.toLowerCase()]: SupportedEVMChain.Hyperevm,
  '0x2019': SupportedEVMChain.Kaia,
  [CHAIN_IDS.KATANA.toLowerCase()]: SupportedEVMChain.Katana,
  '0x93e': SupportedEVMChain.KiteAi,
  [CHAIN_IDS.MANTLE.toLowerCase()]: SupportedEVMChain.Mantle,
  [CHAIN_IDS.MEGAETH_MAINNET.toLowerCase()]: SupportedEVMChain.Megaeth,
  [CHAIN_IDS.MONAD.toLowerCase()]: SupportedEVMChain.Monad,
