...
/**
 * Converts a human-readable amount to a hex string suitable for transaction data.
 * Accounts for mUSD's 6 decimal places.
 *
 * @param amount - Human-readable amount (e.g., '100' for $100)
 * @returns Hex string representation of the amount in wei
 */
export function convertAmountToHex(amount: string | number): string {
