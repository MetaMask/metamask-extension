...
export const MESSAGE_TYPE = {
  ...
  WALLET_GET_SUPPORTED_EXECUTION_PERMISSIONS: 'wallet_getSupportedExecutionPermissions',
  WALLET_GET_GRANTED_EXECUTION_PERMISSIONS: 'wallet_getGrantedExecutionPermissions',
