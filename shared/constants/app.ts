...
export const EXTENSION_MESSAGES = {
  ...
  OPEN_EXTENSION_POPUP_FROM_NOTIFICATION:
    'OPEN_EXTENSION_POPUP_FROM_NOTIFICATION', // Message should only ever be sent after notification cancel call has been made
} as const;

export const POPUP_PREPARATION_LOGIC_TYPES = {
  SNAP_NAVIGATION: 'SNAP_NAVIGATION',
} as const;
