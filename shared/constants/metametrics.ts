...
export enum MetaMetricsEventName {
  ...
  UserClickedConnectCustodialAccount = 'User Clicked Connect Custodial Account',
  UserClickedPortfolioButton = 'User Clicked Portfolio Button',
  UserClickedStakeButton = 'User Clicked Stake Button',
  UserClickedCompliance = 'User Clicked Compliance',
  UserClickedRefreshTokenLink = 'User clicked Refresh Token Link',
  ShowsDeeplinkForSignature = 'Shows Deeplink for Signature',
  AddsCustodianTokenInOnboarding = 'Adds Custodian Token in Onboarding',
  ConnectsInstitutionalFeature = 'Connects Institutional Feature',
  CustodianSelected = 'Custodian Selected',
  ConnectsToCustodian = 'Connects to Custodian',
  ConnectionToCustodianCanceled = 'Connection to Custodian Canceled',
  ConnectionToCustodianFailed = 'Connection to Custodian Failed',
