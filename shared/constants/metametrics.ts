...
export enum MetaMetricsEventName {
  ...
  PasswordChangeWithPasskeyStarted = 'Password Change With Passkey Started',
  PasswordChangeWithPasskeyCompleted = 'Password Change With Passkey Completed',
  PasswordChangeWithPasskeyFailed = 'Password Change With Passkey Failed',
  ...
  PasskeyOnboardingSetupCancelled = 'Passkey Onboarding Setup Cancelled',
  PasskeyOnboardingSetupCompleted = 'Passkey Onboarding Setup Completed',
  PasskeyOnboardingSetupFailed = 'Passkey Onboarding Setup Failed',
  PasskeyOnboardingSetupSkipped = 'Passkey Onboarding Setup Skipped',
  PasskeyOnboardingSetupStarted = 'Passkey Onboarding Setup Started',
  PasskeyOnboardingSetupViewed = 'Passkey Onboarding Setup Viewed',
  PasskeyUnlockStarted = 'Passkey Unlock Started',
  PasskeyUnlockSuccessful = 'Passkey Unlock Successful',
  ...
  PasskeyTroubleshootClicked = 'Passkey Troubleshoot Clicked',
  PasskeyTroubleshootCtaClicked = 'Passkey Troubleshoot CTA Clicked',
  PasskeyTurnOffStarted = 'Passkey Turn Off Started',
  PasskeyTurnOffCompleted = 'Passkey Turn Off Completed',
  PasskeyTurnOffFailed = 'Passkey Turn Off Failed',
  PasskeySetupPasswordEntered = 'Passkey Setup Password Entered',
  PasskeySetupStarted = 'Passkey Setup Started',
  PasskeySetupCompleted = 'Passkey Setup Completed',
  PasskeySetupFailed = 'Passkey Setup Failed',
  PasskeySetupCancelled = 'Passkey Setup Cancelled',
