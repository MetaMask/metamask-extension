...
export enum MetaMetricsEventName {
  ...
  DisablingAccountNotifications = 'Account Notifications Disabled',
  EnablingAccountNotifications = 'Account Notifications Enabled',
  DisablingNotifications = 'Notifications Disabled',
  DismissEnablingNotificationsFlow = 'Notifications Enabling Flow Dismissed',
  ...
  OnboardingWalletAdvancedSettingsTurnOffProfileSyncing = 'Wallet Advanced Settings Profile Syncing Turned Off',
  OnboardingWalletAdvancedSettingsTurnOnProfileSyncing = 'Wallet Advanced Settings Profile Syncing Turned On',
  ...
  StartEnablingNotificationsFlow = 'Notifications Enabling Flow Started',
  ...
  ///: END:ONLY_INCLUDE_IF
  TurnOffProfileSyncing = 'Profile Sync Turned Off',
  TurnOnProfileSyncing = 'Profile Sync Turned On',
