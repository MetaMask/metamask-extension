...
export enum MetaMetricsEventName {
  ...
  SlowRpcBannerShown = 'Slow RPC Banner Shown',
  SlowRpcBannerUpdateRpcClicked = 'Slow RPC Banner: Update RPC Clicked',
  ...
  UnavailableRpcBannerShown = 'Unavailable RPC Banner Shown',
  UnavailableRpcBannerUpdateRpcClicked = 'Unavailable RPC Banner: Update RPC Clicked',
