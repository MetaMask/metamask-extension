...
export const EVENT_NAMES = {
  ...
  NAV_CREATE_ACCOUNT_BUTTON_CLICKED: 'Add Account Selected',
  NAV_IMPORT_ACCOUNT_BUTTON_CLICKED: 'Add Account Selected',
  NAV_CONNECT_HARDWARE_BUTTON_CLICKED: 'Add Account Selected',
  ...
  PRIVATE_KEY_EXPORT_SELECTED: 'Private Key Export Selected',
  PRIVATE_KEY_EXPORT_REQUESTED: 'Private Key Export Requested',
  PRIVATE_KEY_EXPORT_FAILED: 'Private Key Export Failed',
  PRIVATE_KEY_EXPORT_CANCELED: 'Private Key Export Canceled',
  PRIVATE_KEY_EXPORT_REVEALED: 'Private Key Revealed',
  PRIVATE_KEY_EXPORT_COPIED: 'Private Key Copied',
