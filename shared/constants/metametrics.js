...
export const EVENT_NAMES = {
  ...
  ONBOARDING_WALLET_SECURITY_STARTED: 'Wallet Security Started',
  ONBOARDING_WALLET_SECURITY_SKIP_INITIATED: 'Wallet Security Skip Initiated',
  ONBOARDING_WALLET_SECURITY_SKIP_CONFIRMED: 'Wallet Security Skip Confirmed',
  ONBOARDING_WALLET_SECURITY_PHRASE_REVEALED: 'Phrase Revealed',
  ONBOARDING_WALLET_SECURITY_PHRASE_WRITTEN_DOWN: 'Phrase Written Down',
  ONBOARDING_WALLET_SECURITY_PHRASE_CONFIRMED: 'Phrase Confirmed',
  ONBOARDING_WALLET_CREATION_COMPLETE: 'Wallet Created',
  ONBOARDING_WALLET_IMPORT_COMPLETE: 'Wallet Imported',
  ONBOARDING_WALLET_SETUP_COMPLETE: 'Wallet Setup Completed',
  ONBOARDING_WALLET_ADVANCED_SETTINGS: 'Wallet Advanced Settings',
