...
export const EVENT_NAMES = {
  ...
  SRP_REVEAL_STARTED: 'Reveal SRP Initiated',
  SRP_REVEAL_CLICKED: 'Clicked Reveal Secret Recovery',
  SRP_REVEAL_VIEWED: 'Views Reveal Secret Recovery',
  SRP_REVEAL_BACK_BUTTON_CLICKED: 'Clicked Back on Reveal SRP Password Page',
  ...
  SRP_HOLD_TO_REVEAL_COMPLETED: 'Reveal SRP Completed',
  SRP_VIEWS_SRP_QR: 'Views SRP QR Code',
  SRP_VIEWS_SRP_TEXT: 'Views SRP',
  SRP_COPIED_TO_CLIPBOARD: 'Copies SRP to clipboard',
