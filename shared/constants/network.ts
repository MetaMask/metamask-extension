...
export const CHAIN_IDS = {
  ...
  MANTLE: '0x1388',
  GENSYN_MAINNET: '0xa7679',
  GENSYN_TESTNET: '0xa7675',
} as const;
...
export const GENSYN_DISPLAY_NAME = 'Gensyn';
export const GENSYN_TESTNET_DISPLAY_NAME = 'Gensyn Testnet';
...
export const GENSYN_IMAGE_URL = './images/gensyn.svg';
export const GENSYN_TESTNET_IMAGE_URL = './images/gensyn-testnet.svg';
...
export const NETWORK_TO_NAME_MAP = {
  ...
  [CHAIN_IDS.GENSYN_MAINNET]: GENSYN_DISPLAY_NAME,
  [CHAIN_IDS.GENSYN_TESTNET]: GENSYN_TESTNET_DISPLAY_NAME,
} as const;
...
export const CHAIN_ID_TO_CURRENCY_SYMBOL_MAP = {
  ...
  [CHAIN_IDS.GENSYN_MAINNET]: CURRENCY_SYMBOLS.ETH,
  [CHAIN_IDS.GENSYN_TESTNET]: CURRENCY_SYMBOLS.ETH,
} as const;
...
export const CHAIN_ID_TO_NETWORK_IMAGE_URL_MAP: Record<string, string> = {
  ...
  [CHAIN_IDS.GENSYN_MAINNET]: GENSYN_IMAGE_URL,
  [CHAIN_IDS.GENSYN_TESTNET]: GENSYN_TESTNET_IMAGE_URL,
} as const;
...
export const CHAIN_ID_TOKEN_IMAGE_MAP = {
  ...
  [CHAIN_IDS.GENSYN_MAINNET]: ETH_TOKEN_IMAGE_URL,
  [CHAIN_IDS.GENSYN_TESTNET]: ETH_TOKEN_IMAGE_URL,
  [MultichainNetworks.SOLANA]: SOLANA_IMAGE_URL,
  [MultichainNetworks.SOLANA_TESTNET]: SOLANA_TESTNET_IMAGE_URL,
  [MultichainNetworks.SOLANA_DEVNET]: SOLANA_DEVNET_IMAGE_URL,
  [MultichainNetworks.BITCOIN]: BITCOIN_IMAGE_URL,
