...
export const ETHEREUM_CLASSIC_DISPLAY_NAME = 'Ethereum Classic';
export const MORDOR_TESTNET_DISPLAY_NAME = 'Mordor Testnet';
...
export const CHAIN_ID_TO_CURRENCY_SYMBOL_MAP = {
  ...
  [CHAINLIST_CHAIN_IDS_MAP.ETHEREUM_CLASSIC]: CHAINLIST_CURRENCY_SYMBOLS_MAP.ETC,
  [CHAINLIST_CHAIN_IDS_MAP.MORDOR_TESTNET]: CHAINLIST_CURRENCY_SYMBOLS_MAP.METC,
...
export const CHAIN_ID_TO_NETWORK_IMAGE_URL_MAP = {
  ...
  [CHAIN_IDS.ETHEREUM_CLASSIC]: ETC_TOKEN_IMAGE_URL,
  [CHAIN_IDS.MORDOR_TESTNET]: TEST_ETC_TOKEN_IMAGE_URL,
...
export const BUYABLE_CHAINS_MAP: {
  [K in Exclude<
    ...
    | typeof CHAIN_IDS.MORDOR_TESTNET
...
export const FEATURED_RPCS: RPCDefinition[] = [
  ...
  {
    chainId: CHAIN_IDS.ETHEREUM_CLASSIC,
    nickname: ETHEREUM_CLASSIC_DISPLAY_NAME,
