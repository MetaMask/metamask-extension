...
export const CRYMADX_IMAGE_URL = './images/crymadx.png';
...
export const NETWORK_TO_NAME_MAP = {
  ...
  [CHAIN_IDS.CRYMADX]: CRYMADX_DISPLAY_NAME,
...
export const CHAIN_ID_TO_CURRENCY_SYMBOL_MAP = {
  ...
  [CHAIN_IDS.CRYMADX]: CURRENCY_SYMBOLS.CRYMADX,
...
export const CHAIN_ID_TO_NETWORK_IMAGE_URL_MAP: Record<string, string> = {
  ...
  [CHAIN_IDS.CRYMADX]: CRYMADX_IMAGE_URL,
