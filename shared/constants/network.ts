...
export const BIGHIVE_DISPLAY_NAME = 'Bighive Mainnet';
...
export const BIGHIVE_IMAGE_URL = './images/bighive.jpg';
...
export const NETWORK_TO_NAME_MAP = {
  ...
  [CHAIN_IDS.BIGHIVE]: BIGHIVE_DISPLAY_NAME,
...
export const CHAIN_ID_TO_CURRENCY_SYMBOL_MAP = {
  ...
  [CHAIN_IDS.BIGHIVE]: CURRENCY_SYMBOLS.BIGHIVE,
...
export const CHAIN_ID_TO_NETWORK_IMAGE_URL_MAP: Record<string, string> = {
  ...
  [CHAIN_IDS.BIGHIVE]: BIGHIVE_IMAGE_URL,
