...
export const CHEESE_BLOCKCHAIN_DISPLAY_NAME = 'CHEESE Blockchain';
...
export const NETWORK_TO_NAME_MAP = {
  ...
  [CHAIN_IDS.CHEESE_BLOCKCHAIN]: CHEESE_BLOCKCHAIN_DISPLAY_NAME,
} as const;
...
export const CHAIN_ID_TO_CURRENCY_SYMBOL_MAP = {
  ...
  [CHAIN_IDS.CHEESE_BLOCKCHAIN]: CURRENCY_SYMBOLS.CHEESE_BLOCKCHAIN,
} as const;
...
export const CHAIN_ID_TO_NETWORK_IMAGE_URL_MAP: Record<string, string> = {
  ...
  [CHAIN_IDS.CHEESE_BLOCKCHAIN]: CHEESE_BLOCKCHAIN_IMAGE_URL,
} as const;
...
export const CHAIN_ID_TOKEN_IMAGE_MAP = {
  ...
  [CHAIN_IDS.CHEESE_BLOCKCHAIN]: CHEESE_BLOCKCHAIN_NATIVE_TOKEN_IMAGE_URL,
  [MultichainNetworks.SOLANA]: SOLANA_IMAGE_URL,
  [MultichainNetworks.SOLANA_TESTNET]: SOLANA_TESTNET_IMAGE_URL,
  [MultichainNetworks.SOLANA_DEVNET]: SOLANA_DEVNET_IMAGE_URL,
  [MultichainNetworks.BITCOIN]: BITCOIN_IMAGE_URL,
