...
export const DATACHAIN_ROPE_DISPLAY_NAME = 'Datachain Rope';
...
export const DATACHAIN_ROPE_IMAGE_URL = './images/datachain-rope.svg';
...
export const NETWORK_TO_NAME_MAP = {
  ...
  [CHAIN_IDS.DATACHAIN_ROPE]: DATACHAIN_ROPE_DISPLAY_NAME,
} as const;
...
export const CHAIN_ID_TO_CURRENCY_SYMBOL_MAP = {
  ...
  [CHAIN_IDS.DATACHAIN_ROPE]: CURRENCY_SYMBOLS.FAT,
} as const;
...
export const CHAIN_ID_TO_NETWORK_IMAGE_URL_MAP: Record<string, string> = {
  ...
  [CHAIN_IDS.DATACHAIN_ROPE]: DATACHAIN_ROPE_IMAGE_URL,
} as const;
