...
export const HYVECHAIN_DISPLAY_NAME = 'HyveChain';
...
export const HYVECHAIN_IMAGE_URL = './images/hyvechain.png';
...
export const NETWORK_TO_NAME_MAP = {
  ...
  [CHAIN_IDS.HYVECHAIN]: HYVECHAIN_DISPLAY_NAME,
...
export const CHAIN_ID_TO_CURRENCY_SYMBOL_MAP = {
  ...
  [CHAIN_IDS.HYVECHAIN]: CURRENCY_SYMBOLS.HYVE,
...
export const CHAIN_ID_TO_NETWORK_IMAGE_URL_MAP: Record<string, string> = {
  ...
  [CHAIN_IDS.HYVECHAIN]: HYVECHAIN_IMAGE_URL,
