...
export const BOUNCEBIT_IMAGE_URL = './images/bouncebit.png';
...
export const CHAIN_ID_TO_CURRENCY_SYMBOL_MAP = {
  ...
  [CHAINLIST_CHAIN_IDS_MAP.BOUNCEBIT]: CHAINLIST_CURRENCY_SYMBOLS_MAP.BOUNCEBIT,
} as const;
...
export const CHAIN_ID_TO_NETWORK_IMAGE_URL_MAP = {
  ...
  [CHAINLIST_CHAIN_IDS_MAP.BOUNCEBIT]: BOUNCEBIT_IMAGE_URL,
