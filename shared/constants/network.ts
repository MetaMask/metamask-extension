...
export const TREASURE_IMAGE_URL = './images/treasure.svg';
export const TREASURE_TESTNET_IMAGE_URL = './images/treasure-testnet.svg';
...
export const CHAIN_ID_TO_NETWORK_IMAGE_URL_MAP = {
  ...
  [CHAINLIST_CHAIN_IDS_MAP.TREASURE]: TREASURE_IMAGE_URL,
  [CHAINLIST_CHAIN_IDS_MAP.TREASURE_TESTNET]: TREASURE_TESTNET_IMAGE_URL,
...
export const CHAIN_ID_TOKEN_IMAGE_MAP = {
  ...
  [CHAIN_IDS.TREASURE]: TREASURE_IMAGE_URL,
  [CHAIN_IDS.TREASURE_TESTNET]: TREASURE_IMAGE_URL,
