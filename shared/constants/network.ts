...
export const HYDRATION_IMAGE_URL = './images/hydration.svg';
...
export const CHAIN_ID_TO_CURRENCY_SYMBOL_MAP = {
  ...
  [CHAINLIST_CHAIN_IDS_MAP.HYDRATION]:
    CHAINLIST_CURRENCY_SYMBOLS_MAP.HYDRATION,
...
export const CHAIN_ID_TO_NETWORK_IMAGE_URL_MAP = {
  ...
  [CHAINLIST_CHAIN_IDS_MAP.HYDRATION]: HYDRATION_IMAGE_URL,
