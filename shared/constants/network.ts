...
export const HYDRADX_IMAGE_URL = './images/hydradx.svg';
...
export const CHAIN_ID_TO_CURRENCY_SYMBOL_MAP = {
  ...
  [CHAINLIST_CHAIN_IDS_MAP.HYDRADX]:
    CHAINLIST_CURRENCY_SYMBOLS_MAP.HYDRADX,
...
export const CHAIN_ID_TO_NETWORK_IMAGE_URL_MAP = {
  ...
  [CHAINLIST_CHAIN_IDS_MAP.HYDRADX]: HYDRADX_IMAGE_URL,
