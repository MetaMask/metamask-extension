...
export const WANCHAIN_DISPLAY_NAME = 'Wanchain';
export const WANCHAIN_TESTNET_DISPLAY_NAME = 'Wanchain Testnet';
...
export const WANCHAIN_TOKEN_IMAGE_URL = './images/wanchain.svg';
...
export const NETWORK_TO_NAME_MAP = {
  ...
  [CHAIN_IDS.WANCHAIN]: WANCHAIN_DISPLAY_NAME,
  [CHAIN_IDS.WANCHAIN_TESTNET]: WANCHAIN_TESTNET_DISPLAY_NAME,
} as const;
...
export const CHAIN_ID_TO_CURRENCY_SYMBOL_MAP = {
  ...
  [CHAIN_IDS.WANCHAIN]: CURRENCY_SYMBOLS.WANCHAIN,
  [CHAIN_IDS.WANCHAIN_TESTNET]: CURRENCY_SYMBOLS.WANCHAIN,
} as const;
...
export const CHAIN_ID_TO_NETWORK_IMAGE_URL_MAP = {
  ...
  [CHAIN_IDS.WANCHAIN]: WANCHAIN_TOKEN_IMAGE_URL,
  [CHAIN_IDS.WANCHAIN_TESTNET]: WANCHAIN_TOKEN_IMAGE_URL,
...
export const FEATURED_RPCS: AddNetworkFields[] = [
  ...
  },
  {
    ...
    name: WANCHAIN_DISPLAY_NAME,
    nativeCurrency: CURRENCY_SYMBOLS.WANCHAIN,
    rpcEndpoints: [
      {
  ...
  {
    chainId: CHAIN_IDS.WANCHAIN_TESTNET,
    name: WANCHAIN_TESTNET_DISPLAY_NAME,
    nativeCurrency: CURRENCY_SYMBOLS.WANCHAIN,
    rpcEndpoints: [
      {
