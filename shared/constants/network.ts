...
export const UNITE_IMAGE_URL = './images/unite.svg';
...
export const CHAIN_ID_TO_NETWORK_IMAGE_URL_MAP = {
  ...
  [CHAINLIST_CHAIN_IDS_MAP.UNITE]: UNITE_IMAGE_URL,
  [CHAINLIST_CHAIN_IDS_MAP.UNITE_TESTNET]: UNITE_IMAGE_URL,
} as const;
...
export const CHAIN_ID_TOKEN_IMAGE_MAP = {
  ...
  [CHAIN_IDS.GRAVITY_ALPHA_TESTNET_SEPOLIA]:
    GRAVITY_ALPHA_TESTNET_SEPOLIA_IMAGE_URL,
  [CHAIN_IDS.UNITE]: UNITE_IMAGE_URL,
  [CHAIN_IDS.UNITE_TESTNET]: UNITE_IMAGE_URL,
} as const;
