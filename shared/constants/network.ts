...
export const INFURA_NETWORK_NAME_BY_CHAIN_ID: Partial<
 ...
 * have no map based failover so callers can fall back to an endpoint's own
 * `failoverUrls`.
 *
...
export function getFailoverUrlsForChainId(chainId: Hex): string[] | undefined {
  const infuraNetworkName = INFURA_NETWORK_NAME_BY_CHAIN_ID[chainId];
