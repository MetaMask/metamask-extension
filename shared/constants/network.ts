...
export const ONE_MONEY_DISPLAY_NAME = '1Money Network';
...
export const ONE_MONEY_IMAGE_URL = './images/1money.svg';
export const ONE_MONEY_NATIVE_TOKEN_IMAGE_URL = './images/1money-native.svg';
...
export const NETWORK_TO_NAME_MAP = {
  ...
  [CHAIN_IDS.ONE_MONEY]: ONE_MONEY_DISPLAY_NAME,
...
export const CHAIN_ID_TO_CURRENCY_SYMBOL_MAP = {
  ...
  [CHAIN_IDS.ONE_MONEY]: CURRENCY_SYMBOLS.FREE,
...
export const CHAIN_ID_TO_NETWORK_IMAGE_URL_MAP: Record<string, string> = {
  ...
  [CHAIN_IDS.ONE_MONEY]: ONE_MONEY_IMAGE_URL,
...
export const CHAIN_ID_TOKEN_IMAGE_MAP = {
  ...
  [CHAIN_IDS.ONE_MONEY]: ONE_MONEY_NATIVE_TOKEN_IMAGE_URL,
