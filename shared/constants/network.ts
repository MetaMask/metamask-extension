...
export const TEMPO_PATHUSD_TESTNET_IMAGE_URL = './images/tempo-path-usd.svg';
...
export const CHAIN_ID_TO_CURRENCY_SYMBOL_MAP = {
  ...
  [CHAIN_IDS.TEMPO_TESTNET]: CURRENCY_SYMBOLS.TEMPO_PATHUSD_TESTNET,
} as const;
