...
export const NETWORK_TYPES = {
  ...
  RPC: 'rpc',
  SEPOLIA: 'sepolia',
  CONSENSYS_ZKEVM: 'consensyszkevm',
} as const;
...
export const CONSENSYS_ZKEVM_DISPLAY_NAME = 'ConsenSys zkEVM';
...
export const CONSENSYS_ZKEVM_RPC_URL = getRpcUrl({
  network: 'consensys-zkevm-goerli-prealpha' as NetworkType,
});
...
export const TEST_NETWORK_TICKER_MAP: {
  ...
  [NETWORK_TYPES.CONSENSYS_ZKEVM]: `${typedCapitalize(
    NETWORK_TYPES.CONSENSYS_ZKEVM,
  )}${CURRENCY_SYMBOLS.ETH}`,
};
...
export const BUILT_IN_NETWORKS = {
  ...
  [NETWORK_TYPES.CONSENSYS_ZKEVM]: {
    networkId: NETWORK_IDS.CONSENSYS_ZKEVM,
...
export const NETWORK_TO_NAME_MAP = {
  ...
  [NETWORK_TYPES.CONSENSYS_ZKEVM]: CONSENSYS_ZKEVM_DISPLAY_NAME,
  [NETWORK_TYPES.LOCALHOST]: LOCALHOST_DISPLAY_NAME,

  [NETWORK_IDS.GOERLI]: GOERLI_DISPLAY_NAME,
  [NETWORK_IDS.SEPOLIA]: SEPOLIA_DISPLAY_NAME,
  [NETWORK_IDS.CONSENSYS_ZKEVM]: CONSENSYS_ZKEVM_DISPLAY_NAME,
  ...
  [CHAIN_IDS.CONSENSYS_ZKEVM]: CONSENSYS_ZKEVM_DISPLAY_NAME,
...
export const CHAIN_ID_TO_TYPE_MAP = {
  ...
  [CHAIN_IDS.CONSENSYS_ZKEVM]: NETWORK_TYPES.CONSENSYS_ZKEVM,
...
export const CHAIN_ID_TO_RPC_URL_MAP = {
  ...
  [CHAIN_IDS.CONSENSYS_ZKEVM]: CONSENSYS_ZKEVM_RPC_URL,
...
export const NETWORK_ID_TO_ETHERS_NETWORK_NAME_MAP = {
  ...
  [NETWORK_IDS.CONSENSYS_ZKEVM]: NETWORK_TYPES.CONSENSYS_ZKEVM,
...
export const CHAIN_ID_TO_NETWORK_ID_MAP = {
  ...
  [CHAIN_IDS.CONSENSYS_ZKEVM]: NETWORK_IDS.CONSENSYS_ZKEVM,
...
export const ETHERSCAN_SUPPORTED_NETWORKS = {
  ...
  [CHAIN_IDS.CONSENSYS_ZKEVM]: {
    ...
    subdomain: 'explorer.goerli.zkevm',
    networkId: CHAIN_ID_TO_NETWORK_ID_MAP[CHAIN_IDS.CONSENSYS_ZKEVM],
  },
  [CHAIN_IDS.BSC]: {
    domain: 'bscscan.com',
    subdomain: defaultEtherscanSubdomainPrefix,
...
export const BUYABLE_CHAINS_MAP: {
  [K in Exclude<
    ...
    | typeof CHAIN_IDS.CONSENSYS_ZKEVM
