...
export const CHAIN_ID_TO_CURRENCY_SYMBOL_MAP = {
  [CHAIN_IDS.AVALANCHE]: CURRENCY_SYMBOLS.AVALANCHE,
  [CHAIN_IDS.BSC]: CURRENCY_SYMBOLS.BNB,
  [CHAIN_IDS.BASE]: CURRENCY_SYMBOLS.BASE,
  [CHAIN_IDS.ARBITRUM]: CURRENCY_SYMBOLS.ARBITRUM,
  [CHAIN_IDS.LINEA_MAINNET]: CURRENCY_SYMBOLS.LINEA_MAINNET,
  [CHAIN_IDS.MAINNET]: CURRENCY_SYMBOLS.ETH,
  [CHAIN_IDS.OPBNB]: CURRENCY_SYMBOLS.OPBNB,
  [CHAIN_IDS.OPTIMISM]: CURRENCY_SYMBOLS.OPTIMISM,
  [CHAIN_IDS.POLYGON]: CURRENCY_SYMBOLS.MATIC,
  [CHAIN_IDS.ZKSYNC_ERA]: CURRENCY_SYMBOLS.ZKSYNC_ERA,
  [CHAIN_IDS.GOERLI]: EST_NETWORK_TICKER_MAP[NETWORK_TYPES.GOERLI],
  [CHAIN_IDS.SEPOLIA]: TEST_NETWORK_TICKER_MAP[NETWORK_TYPES.SEPOLIA],
  [CHAIN_IDS.LINEA_GOERLI]: TEST_NETWORK_TICKER_MAP[NETWORK_TYPES.LINEA_GOERLI],
} as const;
