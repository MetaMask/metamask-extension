...
export const CROSSFI_IMAGE_URL = './images/crossfi.svg';
...
export const CHAIN_ID_TO_CURRENCY_SYMBOL_MAP = {
  ...
  [CHAINLIST_CHAIN_IDS_MAP.CROSSFI_TESTNET]: CHAINLIST_CURRENCY_SYMBOLS_MAP.CROSSFI_TESTNET,
  [CHAINLIST_CHAIN_IDS_MAP.CROSSFI_TESTNET]:
    CHAINLIST_CURRENCY_SYMBOLS_MAP.CROSSFI_TESTNET,
  [CHAINLIST_CHAIN_IDS_MAP.CROSSFI]: CHAINLIST_CURRENCY_SYMBOLS_MAP.CROSSFI,
} as const;
...
export const CHAIN_ID_TO_NETWORK_IMAGE_URL_MAP = {
  ...
  [CHAINLIST_CHAIN_IDS_MAP.CROSSFI_TESTNET]: CROSSFI_IMAGE_URL,
  [CHAINLIST_CHAIN_IDS_MAP.CROSSFI]: CROSSFI_IMAGE_URL,
} as const;
