...
export const MIRASMANDA_DISPLAY_NAME = 'Mirasmanda';
...
export const MIRASMANDA_IMAGE_URL = './images/mirasmanda.svg';
...
export const NETWORK_TO_NAME_MAP = {
  ...
  [CHAIN_IDS.MIRASMANDA]: MIRASMANDA_DISPLAY_NAME,
...
export const CHAIN_ID_TO_CURRENCY_SYMBOL_MAP = {
  ...
  [CHAIN_IDS.MIRASMANDA]: CURRENCY_SYMBOLS.MIRASMANDA,
...
export const CHAIN_ID_TO_NETWORK_IMAGE_URL_MAP: Record<string, string> = {
  ...
  [CHAIN_IDS.MIRASMANDA]: MIRASMANDA_IMAGE_URL,
