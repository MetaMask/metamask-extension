...
export const NETWORK_TYPES_TO_CHAIN_IDS_MAP = {
  [NETWORK_TYPES.MAINNET]: CHAIN_IDS.MAINNET,
  [NETWORK_TYPES.GOERLI]: CHAIN_IDS.GOERLI,
  [NETWORK_TYPES.SEPOLIA]: CHAIN_IDS.SEPOLIA,
  [NETWORK_TYPES.LINEA_GOERLI]: CHAIN_IDS.LINEA_GOERLI,
  [NETWORK_TYPES.LINEA_MAINNET]: CHAIN_IDS.LINEA_MAINNET,
  [NETWORK_TYPES.LOCALHOST]: CHAIN_IDS.LOCALHOST,
} as const;
