...
export const BTH_TOKEN_IMAGE_URL = './images/bth-token.svg';
...
export const BTH_IMAGE_URL = './images/bth.svg';
...
export const CHAIN_ID_TO_CURRENCY_SYMBOL_MAP = {
  ...
  [CHAINLIST_CHAIN_IDS_MAP.BTH]: CHAINLIST_CURRENCY_SYMBOLS_MAP.BTH,
...
export const CHAIN_ID_TO_NETWORK_IMAGE_URL_MAP = {
  ...
  [CHAINLIST_CHAIN_IDS_MAP.BTH_TESTNET]: BTH_IMAGE_URL,
  [CHAINLIST_CHAIN_IDS_MAP.BTH_MAINNET]: BTH_IMAGE_URL,
...
export const CHAIN_ID_TOKEN_IMAGE_MAP = {
  ...
  [CHAINLIST_CHAIN_IDS_MAP.BTH_MAINNET]: BTH_TOKEN_IMAGE_URL,
