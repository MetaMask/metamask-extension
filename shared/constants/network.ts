...
export const BUYABLE_CHAINS_MAP: {
  ...
  [CHAIN_IDS.MAINNET]: {
    ...
    transakCurrencies: [
      CURRENCY_SYMBOLS.ETH,
      CURRENCY_SYMBOLS['1INCH'],
      CURRENCY_SYMBOLS.AAVE,
      CURRENCY_SYMBOLS.AGEUR,
      CURRENCY_SYMBOLS.BUSD,
      CURRENCY_SYMBOLS.CHAIN,
      CURRENCY_SYMBOLS.CLV,
      CURRENCY_SYMBOLS.COMP,
      CURRENCY_SYMBOLS.CTSI,
      CURRENCY_SYMBOLS.DAI,
      CURRENCY_SYMBOLS.DAO,
      CURRENCY_SYMBOLS.ENJ,
      CURRENCY_SYMBOLS.EURT,
      CURRENCY_SYMBOLS.GTH,
      CURRENCY_SYMBOLS.HEX,
      CURRENCY_SYMBOLS.LINK,
      CURRENCY_SYMBOLS.MANA,
      CURRENCY_SYMBOLS.MASK,
      CURRENCY_SYMBOLS.MINDS,
      CURRENCY_SYMBOLS.MKR,
      CURRENCY_SYMBOLS.PLA,
      CURRENCY_SYMBOLS.POLS,
      CURRENCY_SYMBOLS.SAND,
      CURRENCY_SYMBOLS.STETH,
      CURRENCY_SYMBOLS.SUSHI,
      CURRENCY_SYMBOLS.SWAP,
      CURRENCY_SYMBOLS.TXL,
      CURRENCY_SYMBOLS.UNI,
      CURRENCY_SYMBOLS.USDC,
      CURRENCY_SYMBOLS.USDT,
      CURRENCY_SYMBOLS.VRA,
      CURRENCY_SYMBOLS.WBTC,
      CURRENCY_SYMBOLS.YLD,
    ],
    moonPay: {
    ...
    coinbasePayCurrencies: [
      ...
      CURRENCY_SYMBOLS['1INCH'],
      CURRENCY_SYMBOLS.AAVE,
      CURRENCY_SYMBOLS.ABT,
      CURRENCY_SYMBOLS.ACH,
      CURRENCY_SYMBOLS.AGLD,
      CURRENCY_SYMBOLS.AMP,
      CURRENCY_SYMBOLS.ANKR,
      CURRENCY_SYMBOLS.APE,
      CURRENCY_SYMBOLS.ARPA,
      CURRENCY_SYMBOLS.ASM,
      CURRENCY_SYMBOLS.AUCTION,
      CURRENCY_SYMBOLS.AXS,
      CURRENCY_SYMBOLS.BADGER,
      CURRENCY_SYMBOLS.BAL,
      CURRENCY_SYMBOLS.BAND,
      CURRENCY_SYMBOLS.BAT,
      CURRENCY_SYMBOLS.BNT,
      CURRENCY_SYMBOLS.BOBA,
      CURRENCY_SYMBOLS.BOND,
      CURRENCY_SYMBOLS.BTRST,
      CURRENCY_SYMBOLS.CHZ,
      CURRENCY_SYMBOLS.CLV,
      CURRENCY_SYMBOLS.COMP,
      CURRENCY_SYMBOLS.COTI,
      CURRENCY_SYMBOLS.CRO,
      CURRENCY_SYMBOLS.CRV,
      CURRENCY_SYMBOLS.CTSI,
      CURRENCY_SYMBOLS.CVC,
      CURRENCY_SYMBOLS.DAI,
      CURRENCY_SYMBOLS.DDX,
      CURRENCY_SYMBOLS.DNT,
      CURRENCY_SYMBOLS.ENJ,
      CURRENCY_SYMBOLS.ENS,
      CURRENCY_SYMBOLS.FARM,
      CURRENCY_SYMBOLS.FET,
      CURRENCY_SYMBOLS.FORTH,
      CURRENCY_SYMBOLS.FX,
      CURRENCY_SYMBOLS.GNO,
      CURRENCY_SYMBOLS.GRT,
      CURRENCY_SYMBOLS.GTC,
      CURRENCY_SYMBOLS.IOTX,
      CURRENCY_SYMBOLS.JASMY,
      CURRENCY_SYMBOLS.KEEP,
      CURRENCY_SYMBOLS.KNC,
      CURRENCY_SYMBOLS.KRL,
      CURRENCY_SYMBOLS.LCX,
      CURRENCY_SYMBOLS.LINK,
      CURRENCY_SYMBOLS.LPT,
      CURRENCY_SYMBOLS.LRC,
      CURRENCY_SYMBOLS.MANA,
      CURRENCY_SYMBOLS.MASK,
      CURRENCY_SYMBOLS.MATIC,
      CURRENCY_SYMBOLS.MIR,
      CURRENCY_SYMBOLS.MKR,
      CURRENCY_SYMBOLS.MLN,
      CURRENCY_SYMBOLS.MTL,
      CURRENCY_SYMBOLS.NKN,
      CURRENCY_SYMBOLS.NMR,
      CURRENCY_SYMBOLS.NU,
      CURRENCY_SYMBOLS.OGN,
      CURRENCY_SYMBOLS.OMG,
      CURRENCY_SYMBOLS.OXT,
      CURRENCY_SYMBOLS.PAX,
      CURRENCY_SYMBOLS.PERP,
      CURRENCY_SYMBOLS.PLA,
      CURRENCY_SYMBOLS.POLY,
      CURRENCY_SYMBOLS.QNT,
      CURRENCY_SYMBOLS.QUICK,
      CURRENCY_SYMBOLS.RAD,
      CURRENCY_SYMBOLS.RAI,
      CURRENCY_SYMBOLS.RARI,
      CURRENCY_SYMBOLS.REN,
      CURRENCY_SYMBOLS.REP,
      CURRENCY_SYMBOLS.REQ,
      CURRENCY_SYMBOLS.RLC,
      CURRENCY_SYMBOLS.RLY,
      CURRENCY_SYMBOLS.SAND,
      CURRENCY_SYMBOLS.SHIB,
      CURRENCY_SYMBOLS.SKL,
      CURRENCY_SYMBOLS.SNX,
      CURRENCY_SYMBOLS.STORJ,
      CURRENCY_SYMBOLS.SUKU,
      CURRENCY_SYMBOLS.SUSHI,
      CURRENCY_SYMBOLS.SWFTC,
      CURRENCY_SYMBOLS.TRAC,
      CURRENCY_SYMBOLS.TRB,
      CURRENCY_SYMBOLS.TRIBE,
      CURRENCY_SYMBOLS.TRU,
      CURRENCY_SYMBOLS.UMA,
      CURRENCY_SYMBOLS.UNI,
      CURRENCY_SYMBOLS.USDC,
      CURRENCY_SYMBOLS.USDT,
      CURRENCY_SYMBOLS.WBTC,
      CURRENCY_SYMBOLS.WCFG,
      CURRENCY_SYMBOLS.XYO,
      CURRENCY_SYMBOLS.YFII,
      CURRENCY_SYMBOLS.ZRX,
    ],
  },
  [CHAIN_IDS.ROPSTEN]: {
