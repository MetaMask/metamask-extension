...
export const CHAIN_ID_TO_NETWORK_IMAGE_URL_MAP = {
  ...
  [CHAINLIST_CHAIN_IDS_MAP.GRAVITY_ALPHA_MAINNET]: GRAVITY_ALPHA_MAINNET_IMAGE_URL,
  [CHAINLIST_CHAIN_IDS_MAP.GRAVITY_ALPHA_TESTNET_SEPOLIA]: GRAVITY_ALPHA_TESTNET_SEPOLIA_IMAGE_URL,
...
export const CHAIN_ID_TOKEN_IMAGE_MAP = {
  ...
  [CHAIN_IDS.GRAVITY_ALPHA_TESTNET_SEPOLIA]: GRAVITY_ALPHA_TESTNET_SEPOLIA_IMAGE_URL,
