...
export const COTI_DISPLAY_NAME = 'COTI';
export const COTI_TESTNET_DISPLAY_NAME = 'COTI Testnet';
...
export const COTI_IMAGE_URL = './images/coti.png';
export const COTI_TESTNET_IMAGE_URL = './images/coti-testnet.png';
export const COTI_NATIVE_TOKEN_IMAGE_URL = './images/coti-token.png';
...
export const NETWORK_TO_NAME_MAP = {
  ...
  [CHAIN_IDS.COTI]: COTI_DISPLAY_NAME,
  [CHAIN_IDS.COTI_TESTNET]: COTI_TESTNET_DISPLAY_NAME,
...
export const CHAIN_ID_TO_CURRENCY_SYMBOL_MAP = {
  ...
  [CHAIN_IDS.COTI]: CURRENCY_SYMBOLS.COTI,
  [CHAIN_IDS.COTI_TESTNET]: CURRENCY_SYMBOLS.COTI_TESTNET,
  [CHAIN_IDS.MONAD_TESTNET]:
...
export const CHAIN_ID_TO_NETWORK_IMAGE_URL_MAP: Record<string, string> = {
  ...
  [CHAIN_IDS.COTI]: COTI_IMAGE_URL,
  [CHAIN_IDS.COTI_TESTNET]: COTI_TESTNET_IMAGE_URL,
...
export const CHAIN_ID_TOKEN_IMAGE_MAP = {
  ...
  [CHAIN_IDS.FLOW]: FLOW_IMAGE_URL,
  [CHAIN_IDS.KATANA]: KATANA_IMAGE_URL,
  [CHAIN_IDS.COTI]: COTI_NATIVE_TOKEN_IMAGE_URL,
  [CHAIN_IDS.COTI_TESTNET]: COTI_NATIVE_TOKEN_IMAGE_URL,
  [CHAIN_IDS.MONAD_TESTNET]: MONAD_TESTNET_IMAGE_URL,
  [CHAIN_IDS.SOPHON]: SOPHON_IMAGE_URL,
  [CHAIN_IDS.SOPHON_TESTNET]: SOPHON_TESTNET_IMAGE_URL,
