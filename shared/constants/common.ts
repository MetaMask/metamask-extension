...
export const CHAINID_DEFAULT_BLOCK_EXPLORER_URL_MAP: BlockExplorerUrlMap = {
  ...
  [CHAIN_IDS.ARC]: ARC_DEFAULT_BLOCK_EXPLORER_URL,
  [CHAIN_IDS.ROBINHOOD_CHAIN]: ROBINHOOD_DEFAULT_BLOCK_EXPLORER_URL,
} as const;
...
export const CHAINID_DEFAULT_BLOCK_EXPLORER_HUMAN_READABLE_URL_MAP: BlockExplorerUrlMap =
  {
    ...
    [CHAIN_IDS.ARC]: ARC_DEFAULT_BLOCK_EXPLORER_HUMAN_READABLE_URL,
    [CHAIN_IDS.ROBINHOOD_CHAIN]:
      ROBINHOOD_DEFAULT_BLOCK_EXPLORER_HUMAN_READABLE_URL,
  } as const;
