...
const SWAPS_TESTNET_CHAIN_ID: CaipChainId = 'eip155:1337';
...
export const SWAPS_CHAINID_CONTRACT_ADDRESS_MAP = {
  [CAIP_CHAIN_IDS.MAINNET]: MAINNET_CONTRACT_ADDRESS,
  [SWAPS_TESTNET_CHAIN_ID]: TESTNET_CONTRACT_ADDRESS,
  [CAIP_CHAIN_IDS.BSC]: BSC_CONTRACT_ADDRESS,
  [CAIP_CHAIN_IDS.POLYGON]: POLYGON_CONTRACT_ADDRESS,
  [CAIP_CHAIN_IDS.GOERLI]: TESTNET_CONTRACT_ADDRESS,
  [CAIP_CHAIN_IDS.AVALANCHE]: AVALANCHE_CONTRACT_ADDRESS,
  [CAIP_CHAIN_IDS.OPTIMISM]: OPTIMISM_CONTRACT_ADDRESS,
  [CAIP_CHAIN_IDS.ARBITRUM]: ARBITRUM_CONTRACT_ADDRESS,
} as const;

export const SWAPS_WRAPPED_TOKENS_ADDRESSES = {
  [CAIP_CHAIN_IDS.MAINNET]: WETH_CONTRACT_ADDRESS,
  [SWAPS_TESTNET_CHAIN_ID]: WETH_CONTRACT_ADDRESS,
  [CAIP_CHAIN_IDS.BSC]: WBNB_CONTRACT_ADDRESS,
  [CAIP_CHAIN_IDS.POLYGON]: WMATIC_CONTRACT_ADDRESS,
  [CAIP_CHAIN_IDS.GOERLI]: WETH_GOERLI_CONTRACT_ADDRESS,
  [CAIP_CHAIN_IDS.AVALANCHE]: WAVAX_CONTRACT_ADDRESS,
  [CAIP_CHAIN_IDS.OPTIMISM]: WETH_OPTIMISM_CONTRACT_ADDRESS,
  [CAIP_CHAIN_IDS.ARBITRUM]: WETH_ARBITRUM_CONTRACT_ADDRESS,
} as const;

export const ALLOWED_CONTRACT_ADDRESSES = {
  [CAIP_CHAIN_IDS.MAINNET]: [
    SWAPS_CHAINID_CONTRACT_ADDRESS_MAP[CAIP_CHAIN_IDS.MAINNET],
    SWAPS_WRAPPED_TOKENS_ADDRESSES[CAIP_CHAIN_IDS.MAINNET],
  ],
  [SWAPS_TESTNET_CHAIN_ID]: [
  ...
  [CAIP_CHAIN_IDS.GOERLI]: [
    ...
    SWAPS_WRAPPED_TOKENS_ADDRESSES[CAIP_CHAIN_IDS.GOERLI],
  ],
  [CAIP_CHAIN_IDS.BSC]: [
    SWAPS_CHAINID_CONTRACT_ADDRESS_MAP[CAIP_CHAIN_IDS.BSC],
    SWAPS_WRAPPED_TOKENS_ADDRESSES[CAIP_CHAIN_IDS.BSC],
  ],
  [CAIP_CHAIN_IDS.POLYGON]: [
    SWAPS_CHAINID_CONTRACT_ADDRESS_MAP[CAIP_CHAIN_IDS.POLYGON],
    SWAPS_WRAPPED_TOKENS_ADDRESSES[CAIP_CHAIN_IDS.POLYGON],
  ],
  [CAIP_CHAIN_IDS.AVALANCHE]: [
    SWAPS_CHAINID_CONTRACT_ADDRESS_MAP[CAIP_CHAIN_IDS.AVALANCHE],
    SWAPS_WRAPPED_TOKENS_ADDRESSES[CAIP_CHAIN_IDS.AVALANCHE],
  ],
  [CAIP_CHAIN_IDS.OPTIMISM]: [
    SWAPS_CHAINID_CONTRACT_ADDRESS_MAP[CAIP_CHAIN_IDS.OPTIMISM],
    SWAPS_WRAPPED_TOKENS_ADDRESSES[CAIP_CHAIN_IDS.OPTIMISM],
  ],
  [CAIP_CHAIN_IDS.ARBITRUM]: [
    SWAPS_CHAINID_CONTRACT_ADDRESS_MAP[CAIP_CHAIN_IDS.ARBITRUM],
    SWAPS_WRAPPED_TOKENS_ADDRESSES[CAIP_CHAIN_IDS.ARBITRUM],
  ],
} as const;

export const SWAPS_CHAINID_DEFAULT_TOKEN_MAP: Record<
  CaipChainId,
  SwapsTokenObject
> = {
  [CAIP_CHAIN_IDS.MAINNET]: ETH_SWAPS_TOKEN_OBJECT,
  [SWAPS_TESTNET_CHAIN_ID]: TEST_ETH_SWAPS_TOKEN_OBJECT,
  [CAIP_CHAIN_IDS.BSC]: BNB_SWAPS_TOKEN_OBJECT,
  [CAIP_CHAIN_IDS.POLYGON]: MATIC_SWAPS_TOKEN_OBJECT,
  [CAIP_CHAIN_IDS.GOERLI]: GOERLI_SWAPS_TOKEN_OBJECT,
  [CAIP_CHAIN_IDS.AVALANCHE]: AVAX_SWAPS_TOKEN_OBJECT,
  [CAIP_CHAIN_IDS.OPTIMISM]: OPTIMISM_SWAPS_TOKEN_OBJECT,
  [CAIP_CHAIN_IDS.ARBITRUM]: ARBITRUM_SWAPS_TOKEN_OBJECT,
};

export const SWAPS_CHAINID_DEFAULT_BLOCK_EXPLORER_URL_MAP: Record<
  CaipChainId,
  string
> = {
  [CAIP_CHAIN_IDS.BSC]: BSC_DEFAULT_BLOCK_EXPLORER_URL,
  [CAIP_CHAIN_IDS.MAINNET]: MAINNET_DEFAULT_BLOCK_EXPLORER_URL,
  [CAIP_CHAIN_IDS.POLYGON]: POLYGON_DEFAULT_BLOCK_EXPLORER_URL,
  [CAIP_CHAIN_IDS.GOERLI]: GOERLI_DEFAULT_BLOCK_EXPLORER_URL,
  [CAIP_CHAIN_IDS.AVALANCHE]: AVALANCHE_DEFAULT_BLOCK_EXPLORER_URL,
  [CAIP_CHAIN_IDS.OPTIMISM]: OPTIMISM_DEFAULT_BLOCK_EXPLORER_URL,
  [CAIP_CHAIN_IDS.ARBITRUM]: ARBITRUM_DEFAULT_BLOCK_EXPLORER_URL,
};
