...
export const CNDL_SWAPS_TOKEN_OBJECT = {
  symbol: CNDL_SYMBOL,
  name: 'Candle',
  address: DEFAULT_TOKEN_ADDRESS,
  decimals: 18,
  iconUrl: CNDL_TOKEN_IMAGE_URL,
};
...
const CANDLE_DEFAULT_BLOCK_EXPLORER_URL = 'https://candleexplorer.com/';
...
export const SWAPS_CHAINID_CONTRACT_ADDRESS_MAP = {
  ...
  [CANDLE_CHAIN_ID]: CANDLE_CONTRACT_ADDRESS,
...
export const SWAPS_WRAPPED_TOKENS_ADDRESSES = {
  ...
  [CANDLE_CHAIN_ID]: WCNDL_CONTRACT_ADDRESS,
...
export const ALLOWED_CONTRACT_ADDRESSES = {
  ...
  [CANDLE_CHAIN_ID]: [
    SWAPS_CHAINID_CONTRACT_ADDRESS_MAP[CANDLE_CHAIN_ID],
    SWAPS_WRAPPED_TOKENS_ADDRESSES[CANDLE_CHAIN_ID],
  ],
  [AVALANCHE_CHAIN_ID]: [
...
export const SWAPS_CHAINID_DEFAULT_TOKEN_MAP = {
  ...
  [CANDLE_CHAIN_ID]: CNDL_SWAPS_TOKEN_OBJECT,
};
...
export const SWAPS_CHAINID_DEFAULT_BLOCK_EXPLORER_URL_MAP = {
  ...
  [CANDLE_CHAIN_ID]: CANDLE_DEFAULT_BLOCK_EXPLORER_URL,
};
