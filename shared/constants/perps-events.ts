...
export const PERPS_EVENT_VALUE = {
  ...
  BUTTON_LOCATION: {
    ...
    WALLET_HOME_PERPS_TAB: CONTROLLER_PERPS_EVENT_VALUE.BUTTON_LOCATION.PERPS_TAB,
  ...
  BUTTON_CLICKED: {
    ...
    REDUCE_EXPOSURE: CONTROLLER_PERPS_EVENT_VALUE.BUTTON_CLICKED.REDUCE_EXPOSURE,
  },
  INTERACTION_TYPE: {
