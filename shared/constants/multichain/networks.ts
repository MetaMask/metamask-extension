...
export enum MultichainNetworks {
  ...
  // TODO: Fix in https://github.com/MetaMask/metamask-extension/issues/31860
  // eslint-disable-next-line @typescript-eslint/naming-convention
  STELLAR_TESTNET = XlmScope.Testnet,
}
...
export const MULTICHAIN_NETWORK_TO_NICKNAME: Record<CaipChainId, string> = {
  ...
  [MultichainNetworks.STELLAR_TESTNET]: 'Stellar Testnet',
} as const;
...
export const STELLAR_TESTNET_TOKEN_IMAGE_URL = './images/stellar-logo.svg';
...
export const STELLAR_BLOCK_EXPLORER_URL = 'https://stellar.expert/explorer/public';
export const STELLAR_BLOCK_EXPLORER_NAME = 'Stellar Expert';
export const STELLAR_TESTNET_BLOCK_EXPLORER_URL =
...
> = {
  ...
  [MultichainNetworks.STELLAR]: {
    ...
    address: `${STELLAR_BLOCK_EXPLORER_URL}/account/{address}`,
    transaction: `${STELLAR_BLOCK_EXPLORER_URL}/tx/{txId}`,
  },
  [MultichainNetworks.STELLAR_TESTNET]: {
    name: STELLAR_BLOCK_EXPLORER_NAME,
    url: STELLAR_TESTNET_BLOCK_EXPLORER_URL,
    address: `${STELLAR_TESTNET_BLOCK_EXPLORER_URL}/account/{address}`,
    transaction: `${STELLAR_TESTNET_BLOCK_EXPLORER_URL}/tx/{txId}`,
  },
} as const;
...
export const MULTICHAIN_TOKEN_IMAGE_MAP: Record<CaipChainId, string> = {
  ...
  [MultichainNetworks.STELLAR_TESTNET]: STELLAR_TESTNET_TOKEN_IMAGE_URL,
} as const;
...
> = {
  ...
  [MultichainNetworks.STELLAR_TESTNET]: {
    ...
    rpcUrl: '',
    ticker: 'XLM',
    nickname: 'Stellar (testnet)',
    id: 'stellar-testnet',
    type: 'rpc',
    decimals: 7,
    rpcPrefs: {
      imageUrl: MULTICHAIN_TOKEN_IMAGE_MAP[MultichainNetworks.STELLAR_TESTNET],
      blockExplorerUrl:
        MULTICHAIN_NETWORK_BLOCK_EXPLORER_FORMAT_URLS_MAP[
          MultichainNetworks.STELLAR_TESTNET
        ].url,
...
export const STELLAR_TEST_CHAINS: CaipChainId[] = [XlmScope.Testnet];
