...
`SOURCE_DATE_EPOCH` is also supported for reproducible zip artifacts. It is the standard unprefixed environment variable,
specified as a Unix timestamp in seconds:
