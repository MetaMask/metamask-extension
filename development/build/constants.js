...
exports.ENVIRONMENT = exports.MANIFEST_RELEASE_CANDIDATE_KEY = exports.MANIFEST_DEV_KEY = exports.TASKS = exports.BUILD_TARGETS = void 0;
const build_environment_json_1 = __importDefault(require("../../shared/constants/build-environment.json"));
exports.ENVIRONMENT = build_environment_json_1.default;
/**
 * The build target. This describes the overall purpose of the build.
 *
...
exports.TASKS = {
    ...
    RELOAD: 'reload',
    SCRIPTS_CORE_DEV_STANDARD_ENTRY_POINTS: 'scripts:core:dev:standardEntryPoints',
    ...
    SCRIPTS_CORE_DIST_STANDARD_ENTRY_POINTS: 'scripts:core:dist:standardEntryPoints',
    ...
    SCRIPTS_CORE_PROD_STANDARD_ENTRY_POINTS: 'scripts:core:prod:standardEntryPoints',
    ...
    SCRIPTS_CORE_TEST_LIVE_STANDARD_ENTRY_POINTS: 'scripts:core:test-live:standardEntryPoints',
    SCRIPTS_CORE_TEST_LIVE_CONTENTSCRIPT: 'scripts:core:test-live:contentscript',
    SCRIPTS_CORE_TEST_LIVE_DISABLE_CONSOLE: 'scripts:core:test-live:disable-console',
    SCRIPTS_CORE_TEST_LIVE_SENTRY: 'scripts:core:test-live:sentry',
    SCRIPTS_CORE_TEST_LIVE_PHISHING_DETECT: 'scripts:core:test-live:phishing-detect',
    SCRIPTS_CORE_TEST_STANDARD_ENTRY_POINTS: 'scripts:core:test:standardEntryPoints',
...
exports.MANIFEST_DEV_KEY = '';
// only for builds from the release candidate branch
exports.MANIFEST_RELEASE_CANDIDATE_KEY = '';
