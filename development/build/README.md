...
From the repository root, the build system entry file is located at [`./development/build/index.js`](/development/build/index.js).
...
Source file bundling tasks are implemented in the [`./development/build/scripts.js`](/development/build/scripts.js).
