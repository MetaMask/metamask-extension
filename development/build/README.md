...
This directory contains the Widllet build system, which is used to build the Widllet Extension such that it can be used in a supported browser.
From the repository root, the build system entry file is located at [`./development/build/index.js`](https://github.com/widllet-extension/blob/main/development/build/index.js).
...
Source file bundling tasks are implemented in the [`./development/build/scripts.js`](https://github.com/widllet-extension/blob/main/development/build/scripts.js).
