...
[![Architecture Diagram](./docs/architecture.png)](https://docs.metamask.io/wallet/concepts/architecture/)
...
- [Extend MetaMask's features using MetaMask Snaps.](https://docs.metamask.io/snaps/)
- [Enable a seamless connection from your dapp to MetaMask using MetaMask SDK.](https://docs.metamask.io/wallet/how-to/connect/set-up-sdk/)
...
See more resources in the [MetaMask developer docs](https://docs.metamask.io/).
