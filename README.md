...
If you are using VS Code and are unable to make commits from the source control menu due to a "command not found" error, try these steps from the [Husky docs](https://typicode.github.io/husky/troubleshooting.html#command-not-found).
