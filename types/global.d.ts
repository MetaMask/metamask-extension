...
import type { PostUpdateReloadCoordinator } from '../app/scripts/lib/post-update-reload-coordinator';
import type {
  LongTaskMetrics,
...
type StateHooks = {
  ...
  /** MV3 post-update reload coordination shared with `background.js`. */
  postUpdateReloadCoordinator?: PostUpdateReloadCoordinator;
  /**
