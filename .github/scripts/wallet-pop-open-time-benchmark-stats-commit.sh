...
BENCHMARK_FILE="../test-artifacts/benchmarks/wallet-pop-open-time-benchmark-results.json"
STATS_FILE="stats/wallet_pop_open_time_data.json"
TEMP_FILE="stats/wallet_pop_open_time_data.temp.json"
...
git commit --message "Adding wallet pop open time benchmark data at commit: ${GITHUB_SHA}"
