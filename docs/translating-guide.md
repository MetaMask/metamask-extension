...
- Add the language to the [locales index](https://github.com/Conflux-Chain/conflux-portal/blob/master/app/_locales/index.json) `app/_locales/index.json` 
...
To verify that your translation works in the app, you will need to [build a local copy](https://github.com/Conflux-Chain/conflux-portal#building-locally) of MetaMask. You will need to change your browser language, your operating system language, and restart your browser (sorry it's so much work!).
