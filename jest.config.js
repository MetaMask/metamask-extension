module.exports = {
  ...
  testMatch: [
    '<rootDir>/ui/components/app/signature-request-original/signature-request-original.test.js',
    '<rootDir>/ui/components/app/signature-request-siwe/signature-request-siwe.test.js',
