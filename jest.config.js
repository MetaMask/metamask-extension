module.exports = {
  collectCoverageFrom: [
    ...
    '<rootDir>/ui/components/app/mmi/**/*.js',
    '<rootDir>/ui/components/app/mmi/modals/**/**/*.component.js',
    '<rootDir>/ui/components/ui/mmi/**/**/*.component.js',
    '<rootDir>/ui/components/ui/mmi/icon/*.component.js',
    '<rootDir>/ui/ducks/mmi/institutional/*.js',
    '<rootDir>/ui/pages/mmi/**/*.component.js',
    '<rootDir>/ui/pages/create-account/mmi/connect-custody/**/*.component.js',
    '<rootDir>/ui/pages/mmi/institutional-entity-done/index.js',
    '<rootDir>/ui/pages/swaps/mmi/**/*.js',
  ],
