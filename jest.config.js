module.exports = {
  collectCoverageFrom: [
    ...
    '<rootDir>/app/scripts/account-import-strategies/*.js',
    '<rootDir>/app/scripts/controllers/backup.js',
    '<rootDir>/app/scripts/controllers/cached-balances.js',
    '<rootDir>/app/scripts/controllers/incoming-transactions.js',
  ...
  testMatch: [
    ...
    '<rootDir>/app/scripts/account-import-strategies/account-import-strategies.test.js',
    '<rootDir>/app/scripts/controllers/backup.test.js',
    '<rootDir>/app/scripts/controllers/cached-balances.test.js',
    '<rootDir>/app/scripts/controllers/incoming-transactions.test.js',
