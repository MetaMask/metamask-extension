...
class UserOperationController extends base_controller_1.BaseController {
     ...
     */
    constructor({ interval, messenger, state }) {
        super({
            name: controllerName,
...
_UserOperationController_pendingUserOperationTracker = new WeakMap(), _UserOperationController_instances = new WeakSet(), _UserOperationController_addUserOperation = function _UserOperationController_addUserOperation(request, options) {
    return __awaiter(this, void 0, void 0, function* () {
        const { chainId, transaction } = options;
        const metadata = __classPrivateFieldGet(this, _UserOperationController_instances, "m", _UserOperationController_createMetadata).call(this, chainId, transaction);
        const { id } = metadata;
        let throwError = false;
        const hashValue = (() => __awaiter(this, void 0, void 0, function* () {
            try {
                return yield __classPrivateFieldGet(this, _UserOperationController_instances, "m", _UserOperationController_prepareAndSubmitUserOperation).call(this, metadata, request, options);
            }
            catch (error) {
        ...
        const transactionHash = () => __awaiter(this, void 0, void 0, function* () {
            ...
            return finalTransactionHash !== null && finalTransactionHash !== void 0 ? finalTransactionHash : undefined;
        });
        return {
            id,
            hash,
...
}, _UserOperationController_prepareAndSubmitUserOperation = function _UserOperationController_prepareAndSubmitUserOperation(metadata, request, options) {
    return __awaiter(this, void 0, void 0, function* () {
        const { data, maxFeePerGas, maxPriorityFeePerGas, to, value } = request;
        const { chainId, requireApproval, smartContractAccount } = options;
        let resultCallbacks;
        try {
            yield __classPrivateFieldGet(this, _UserOperationController_instances, "m", _UserOperationController_prepareUserOperation).call(this, to, value, data, metadata, smartContractAccount, chainId);
            ...
            if (requireApproval !== false) {
                resultCallbacks = yield __classPrivateFieldGet(this, _UserOperationController_instances, "m", _UserOperationController_approveUserOperation).call(this, metadata);
            }
...
}, _UserOperationController_createMetadata = function _UserOperationController_createMetadata(chainId, transaction) {
    var _a;
    const metadata = {
        actualGasCost: null,
        actualGasUsed: null,
    ...
    return metadata;
}, _UserOperationController_prepareUserOperation = function _UserOperationController_prepareUserOperation(to, value, data, metadata, smartContractAccount, chainId) {
    var _a, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { bundler: bundlerUrl, callData, dummyPaymasterAndData, dummySignature, gas, initCode, nonce, sender, } = response;
        userOperation.callData = callData;
        userOperation.callGasLimit = (_a = gas === null || gas === void 0 ? void 0 : gas.callGasLimit) !== null && _a !== void 0 ? _a : constants_1.EMPTY_BYTES;
        ...
        userOperation.preVerificationGas = (_b = gas === null || gas === void 0 ? void 0 : gas.preVerificationGas) !== null && _b !== void 0 ? _b : constants_1.EMPTY_BYTES;
        ...
        userOperation.verificationGasLimit =
            (_c = gas === null || gas === void 0 ? void 0 : gas.verificationGasLimit) !== null && _c !== void 0 ? _c : constants_1.EMPTY_BYTES;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (userOperation.callGasLimit !== constants_1.EMPTY_BYTES) {
            (0, logger_1.projectLogger)('Skipping gas estimation as already set', {
        ...
        const { preVerificationGas, verificationGas, callGasLimit } = yield bundler.estimateUserOperationGas(payload, constants_1.ENTRYPOINT);
        const normalizeGas = (value) => (0, controller_utils_1.toHex)(Math.round(value * GAS_BUFFER));
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (transactionParams && updatedTransaction) {
            ...
            if (userOperation.paymasterAndData === constants_1.EMPTY_BYTES) {
    ...
    return {
        ...
        maxFeePerGas: constants_1.EMPTY_BYTES,
        maxPriorityFeePerGas: constants_1.EMPTY_BYTES,
