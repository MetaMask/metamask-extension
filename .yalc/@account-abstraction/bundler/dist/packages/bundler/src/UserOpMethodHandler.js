...
class UserOpMethodHandler {
    ...
    async _validateParameters(userOp1, entryPointInput, requireSignature = true, requireGasParams = true) {
        (0, src_1.requireCond)(entryPointInput != null, 'No entryPoint param', -32602);
        ...
        (0, src_1.requireCond)(userOp1 != null, 'No UserOperation param');
        ...
        fields.forEach(key => {
            (0, src_1.requireCond)(userOp[key] != null, 'Missing userOp field: ' + key + JSON.stringify(userOp), -32602);
            const value = userOp[key].toString();
            (0, src_1.requireCond)(value.match(HEX_REGEX) != null, `Invalid hex value for property ${key}:${value} in UserOp`, -32602);
        });
    }
    /**
    ...
    async estimateUserOperationGas(userOp1, entryPointInput) {
        const userOp = Object.assign(Object.assign({}, await (0, utils_1.resolveProperties)(userOp1)), { paymasterAndData: '0x', maxFeePerGas: 0, maxPriorityFeePerGas: 0, preVerificationGas: 0, verificationGasLimit: 10e6 });
        // todo: checks the existence of parameters, but since we hexlify the inputs, it fails to validate
        await this._validateParameters((0, src_1.deepHexlify)(userOp), entryPointInput);
        ...
        if (errorResult.errorName === 'FailedOp') {
            throw new src_1.RpcError(errorResult.errorArgs.at(-1), src_1.ValidationErrors.SimulateValidation);
        }
        ...
        const callGasLimit = await this.provider.estimateGas({
            ...
            throw new src_1.RpcError(message, src_1.ValidationErrors.UserOperationReverted);
        });
    ...
    async sendUserOperation(userOp1, entryPointInput) {
        ...
        const userOp = await (0, utils_1.resolveProperties)(userOp1);
        console.log(`UserOperation: Sender=${userOp.sender}  Nonce=${(0, src_1.tostr)(userOp.nonce)} EntryPoint=${entryPointInput} Paymaster=${(0, src_1.getAddr)(userOp.paymasterAndData)}`);
    ...
    async getUserOperationByHash(userOpHash) {
        var _a, _b, _c;
        (0, src_1.requireCond)(((_a = userOpHash === null || userOpHash === void 0 ? void 0 : userOpHash.toString()) === null || _a === void 0 ? void 0 : _a.match(HEX_REGEX)) != null, 'Missing/invalid userOpHash', -32601);
    ...
    clientVersion() {
        ...
        return 'aa-bundler/' + src_1.erc4337RuntimeVersion + (this.config.unsafe ? '/unsafe' : '');
    }
}
