...
export interface TestStorageAccountFactory extends BaseContract {
    ...
    functions: {
        ...
        create(salt: PromiseOrValue<BigNumberish>, rule: PromiseOrValue<string>, overrides?: Overrides & {
    ...
    callStatic: {
        coin(overrides?: CallOverrides): Promise<string>;
        create(salt: PromiseOrValue<BigNumberish>, rule: PromiseOrValue<string>, overrides?: CallOverrides): Promise<string>;
    };
    filters: {};
    estimateGas: {
