...
export interface TestStorageAccountInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "addStake" | "coin" | "postOp" | "runRule" | "setCoin" | "setState" | "validatePaymasterUserOp" | "validateUserOp"): FunctionFragment;
...
export interface TestStorageAccount extends BaseContract {
    ...
    callStatic: {
        ...
        validatePaymasterUserOp(userOp: UserOperationStruct, userOpHash: PromiseOrValue<BytesLike>, maxCost: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[string, BigNumber] & {
            context: string;
            deadline: BigNumber;
        }>;
