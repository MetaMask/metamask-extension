...
function parseEntitySlots(stakeInfoEntities, keccak) {
    ...
    keccak.forEach(k => {
        Object.values(stakeInfoEntities).forEach(info => {
            ...
            if (addr == null)
                return;
            const addrPadded = (0, src_1.toBytes32)(addr);
...
function tracerResultParser(userOp, tracerResults, validationResult, entryPoint) {
    ...
    // [OP-054]
    (0, src_1.requireCond)(callInfoEntryPoint == null, `illegal call into EntryPoint during validation ${callInfoEntryPoint === null || callInfoEntryPoint === void 0 ? void 0 : callInfoEntryPoint.method}`, src_1.ValidationErrors.OpcodeValidation);
    // [OP-061]
    ...
    (0, src_1.requireCond)(illegalNonZeroValueCall == null, 'May not may CALL with value', src_1.ValidationErrors.OpcodeValidation);
    ...
    Object.entries(stakeInfoEntities).forEach(([entityTitle, entStakes]) => {
        ...
        // [OP-020]
        (0, src_1.requireCond)(!((_b = currentNumLevel.oog) !== null && _b !== void 0 ? _b : false), `${entityTitle} internally reverts on oog`, src_1.ValidationErrors.OpcodeValidation);
        // opcodes from [OP-011]
        Object.keys(opcodes).forEach(opcode => (0, src_1.requireCond)(!bannedOpCodes.has(opcode), `${entityTitle} uses banned opcode: ${opcode}`, src_1.ValidationErrors.OpcodeValidation));
        // [OP-031]
        if (entityTitle === 'factory') {
            (0, src_1.requireCond)(((_c = opcodes.CREATE2) !== null && _c !== void 0 ? _c : 0) <= 1, `${entityTitle} with too many CREATE2`, src_1.ValidationErrors.OpcodeValidation);
        }
        else {
            (0, src_1.requireCond)(opcodes.CREATE2 == null, `${entityTitle} uses banned opcode: CREATE2`, src_1.ValidationErrors.OpcodeValidation);
        }
        Object.entries(access).forEach(([addr, { reads, writes }]) => {
            ...
            debug('dump keccak calculations and reads', {
                entityTitle,
                entityAddr,
                k: (0, src_1.mapOf)(tracerResults.keccak, k => (0, utils_1.keccak256)(k)),
                reads
            });
            ...
            [...Object.keys(writes), ...Object.keys(reads)].forEach(slot => {
                ...
                if (associatedWith(slot, sender, entitySlots)) {
                    ...
                    (0, src_1.requireCond)(false, `${entityTitle} has forbidden ${readWrite} ${nameAddr(addr, entityTitle)} slot ${slot}`, src_1.ValidationErrors.OpcodeValidation, { [entityTitle]: entStakes === null || entStakes === void 0 ? void 0 : entStakes.addr });
                }
            });
        ...
        function requireCondAndStake(cond, entStake, failureMessage) {
            ...
            (0, src_1.requireCond)(isStaked(entStake), failureMessage, src_1.ValidationErrors.OpcodeValidation, { [entityTitle]: entStakes === null || entStakes === void 0 ? void 0 : entStakes.addr });
        ...
        // [OP-041]
        (0, src_1.requireCond)(illegalZeroCodeAccess == null, `${entityTitle} accesses un-deployed contract address ${illegalZeroCodeAccess === null || illegalZeroCodeAccess === void 0 ? void 0 : illegalZeroCodeAccess.address} with opcode ${illegalZeroCodeAccess === null || illegalZeroCodeAccess === void 0 ? void 0 : illegalZeroCodeAccess.opcode}`, src_1.ValidationErrors.OpcodeValidation);
        ...
        (0, src_1.requireCond)(illegalEntryPointCodeAccess == null, `${entityTitle} accesses EntryPoint contract address ${entryPointAddress} with opcode ${illegalEntryPointCodeAccess}`, src_1.ValidationErrors.OpcodeValidation);
    });
