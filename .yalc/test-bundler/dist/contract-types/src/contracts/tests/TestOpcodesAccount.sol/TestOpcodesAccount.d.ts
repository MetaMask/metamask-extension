...
export interface TestOpcodesAccountInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "addStake" | "execEvent" | "postOp" | "runRule" | "setState" | "validatePaymasterUserOp" | "validateUserOp"): FunctionFragment;
...
export type ExecutionMessageEventFilter = TypedEventFilter<ExecutionMessageEvent>;
