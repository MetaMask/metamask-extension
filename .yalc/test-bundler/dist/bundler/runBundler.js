...
async function runBundler(argv, overrideExit = true) {
    ...
    program
        .version(utils_1.erc4337RuntimeVersion)
    ...
    if (chainId === 31337) {
        ...
        if ((await wallet.getBalance()).eq(0)) {
            ...
            await signer.sendTransaction({ to: await wallet.getAddress(), value: (0, utils_2.parseEther)('1') });
        }
    }
    if (config.conditionalRpc && !await (0, utils_1.supportsRpcMethod)(provider, 'eth_sendRawTransactionConditional', [{}, {}])) {
    ...
    const debugHandler = ((_a = config.debugRpc) !== null && _a !== void 0 ? _a : false)
        ...
        : new Proxy({}, {
            get(target, method, receiver) {
                throw new utils_1.RpcError(`method debug_bundler_${method} is not supported`, -32601);
            }
        });
