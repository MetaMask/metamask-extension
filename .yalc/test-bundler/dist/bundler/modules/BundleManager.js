...
class BundleManager {
    ...
    async createBundle() {
        ...
        mainLoop: for (const entry of entries) {
            ...
            // [SREP-030]
            if (paymaster != null && ((_a = paymasterStatus === ReputationManager_1.ReputationStatus.THROTTLED) !== null && _a !== void 0 ? _a : ((_b = stakedEntityCount[paymaster]) !== null && _b !== void 0 ? _b : 0) > THROTTLED_ENTITY_BUNDLE_COUNT)) {
                debug('skipping throttled paymaster', entry.userOp.sender, entry.userOp.nonce);
                continue;
            }
            // [SREP-030]
            if (factory != null && ((_c = deployerStatus === ReputationManager_1.ReputationStatus.THROTTLED) !== null && _c !== void 0 ? _c : ((_d = stakedEntityCount[factory]) !== null && _d !== void 0 ? _d : 0) > THROTTLED_ENTITY_BUNDLE_COUNT)) {
