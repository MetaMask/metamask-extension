...
class ValidationManager {
    ...
    validateInputParameters(userOp, entryPointInput, requireSignature = true, requireGasParams = true) {
        ...
        (0, utils_1.requireCond)(userOp.paymasterAndData.length === 2 || userOp.paymasterAndData.length >= 42, 'paymasterAndData: must contain at least an address', utils_1.ValidationErrors.InvalidFields);
