...
export const getInsufficientNativeReserveError = createSelector(
  ...
  (
    ...
    let maxSwappableNativeBalance = new BigNumber(nativeBalance ?? 0).sub(
    ...
    maxSwappableNativeBalance = BigNumber.max(maxSwappableNativeBalance, 0);
