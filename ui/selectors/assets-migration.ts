 ...
 */
export const selectedEvmAccount = createDeepEqualSelector(
  [
 ...
 */
export const getAllTokens = createDeepEqualSelector(
  [
    getIsAssetsUnifyStateEnabled,
  ...
  (
    ...
    for (const [accountId, accountBalances] of Object.entries(assetsBalance)) {
      ...
      for (const [assetId, _balanceData] of Object.entries(accountBalances)) {
...
export const getAllIgnoredTokens = createDeepEqualSelector(
  [
    getIsAssetsUnifyStateEnabled,
    (state: { metamask: TokensControllerState }) =>
