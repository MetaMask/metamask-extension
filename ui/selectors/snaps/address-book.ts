 ...
 */
const getFullAddressBook = (state: AddressBookMetaMaskState) =>
 ...
 * @returns The full address book.
 */
const getMemoizedFullAddressBook = createDeepEqualSelector(
  [getFullAddressBook],
 ...
 */
const getAddressBookByNetwork = createDeepEqualSelector(
  [
