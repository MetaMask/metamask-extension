...
import { AccountAbstractionState, getIsUsingPaymaster, getUserOperation, getUserOperations, } from './account-abstraction';
...
describe('Account Abstraction Selectors', () => {
    describe('getUserOperations', () => {
        it('returns user operations object', () => {
            ...
            const state = {} as unknown as AccountAbstractionState;
