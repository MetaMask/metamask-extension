...
describe('gas-modal-page-container container', () => {
  describe('mapDispatchToProps()', () => {
    ...
    describe('useCustomGasFee()', () => {
      it('should dispatch a useCustomGasFee action', () => {
        mapDispatchToPropsObject.useCustomGasFee();
        expect(dispatchSpy.calledOnce).toStrictEqual(true);
        expect(useCustomGasFee).toHaveBeenCalled();
      });
    });
  ...
  describe('mergeProps', () => {
    ...
    it('should return the expected props when isConfirm is true', () => {
      ...
      expect(dispatchProps.useCustomGasFee.callCount).toStrictEqual(0);
    ...
    it('should return the expected props when isConfirm is false', () => {
      ...
      expect(dispatchProps.useCustomGasFee.callCount).toStrictEqual(1);
