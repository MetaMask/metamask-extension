...
const PERPS_TOAST_PRESENTATION_BY_KEY: Record<
  ...
  PerpsToastPresentation
> = {
  [PERPS_TOAST_KEYS.CLOSE_FAILED]: PERPS_ORDER_FAILED_PRESENTATION,
  ...
  [PERPS_TOAST_KEYS.MARGIN_ADJUSTMENT_FAILED]: PERPS_ORDER_FAILED_PRESENTATION,
  ...
  [PERPS_TOAST_KEYS.UPDATE_FAILED]: PERPS_ORDER_FAILED_PRESENTATION,
