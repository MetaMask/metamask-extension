...
export const PERPS_TOAST_PRESENTATION_BY_KEY: Record<
  ...
  PerpsToastPresentation
> = {
  [PERPS_TOAST_KEYS.CANCEL_ORDER_ALREADY_CLOSED]:
    PERPS_TOAST_PRESENTATION_BY_VARIANT.success,
  [PERPS_TOAST_KEYS.CANCEL_ORDER_FAILED]: PERPS_ERROR_PRESENTATION,
  [PERPS_TOAST_KEYS.CLOSE_ALL_FAILED]: PERPS_ERROR_PRESENTATION,
  [PERPS_TOAST_KEYS.CLOSE_ALL_IN_PROGRESS]:
    PERPS_TOAST_PRESENTATION_BY_VARIANT.info,
  [PERPS_TOAST_KEYS.CLOSE_ALL_PARTIAL]: PERPS_ERROR_PRESENTATION,
  [PERPS_TOAST_KEYS.CLOSE_ALL_SUCCESS]:
    PERPS_TOAST_PRESENTATION_BY_VARIANT.success,
  ...
  [PERPS_TOAST_KEYS.SUBMIT_IN_PROGRESS]:
    PERPS_TOAST_PRESENTATION_BY_VARIANT.info,
  [PERPS_TOAST_KEYS.TRADE_ENTRY_FAILED]: PERPS_ERROR_PRESENTATION,
