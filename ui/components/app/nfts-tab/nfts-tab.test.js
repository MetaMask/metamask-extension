...
describe('Nft Items', () => {
  ...
  setBackgroundConnection({
    setNftsDetectionNoticeDismissed: setNftsDetectionNoticeDismissedStub,
  ...
  describe('Nfts Detection Notice', () => {
    ...
    it('should call setCollectibesDetectionNoticeDismissed when users clicks "X"', () => {
      ...
      expect(setNftsDetectionNoticeDismissedStub).not.toHaveBeenCalled();
      fireEvent.click(screen.queryByTestId('nfts-detection-notice-close'));
      expect(setNftsDetectionNoticeDismissedStub).toHaveBeenCalled();
    });
  });
