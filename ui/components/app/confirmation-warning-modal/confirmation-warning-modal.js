  ...
  return (
    <Popover className="confirmation-warning-modal__content" footer={footer}>
      ...
      {/* <Box
        ...
        padding={4}
        justifyContent={JUSTIFY_CONTENT.SPACE_BETWEEN}
        className="confirmation-warning-modal__content__account"
      >
        <Box display={DISPLAY.FLEX}>
          ...
          <Typography
            ...
            marginLeft={2}
            className="confirmation-warning-modal__content__account-name"
          >
      ...
      >
        {/* {t('nftWarningContent', [
          <strong
            ...
            className="confirmation-warning-modal__content__bold"
          >
