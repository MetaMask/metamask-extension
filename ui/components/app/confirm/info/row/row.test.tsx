...
describe('ConfirmInfoRow', () => {
  ...
  it('should match snapshot', () => {
    const { container } = renderWithProvider(
      <ConfirmInfoRow label={KEY_ALERT_KEY_MOCK} children={<Text>value</Text>} />,
      mockStore,
    );
  ...
  it('renders row with alert', () => {
    const { getAllByTestId } = renderWithProvider(
      <ConfirmInfoRow label={KEY_ALERT_KEY_MOCK} children={<Text>value</Text>} alertKey={KEY_ALERT_KEY_MOCK} />,
      mockStore,
    );
