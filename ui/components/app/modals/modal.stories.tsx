...
export const HideTokenConfirmation = createModalStory('HIDE_TOKEN_CONFIRMATION');
...
export const RampsEligibilityFailed = createModalStory('RAMPS_ELIGIBILITY_FAILED');
export const RampsServiceDisruption = createModalStory('RAMPS_SERVICE_DISRUPTION');
