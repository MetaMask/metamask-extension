...
describe('QRCodeView', () => {
    ...
    it('renders QR code image', () => {
        ...
        const qrCodeImage = container.querySelector('[data-testid="qr-code-image"]');
    ...
    it.each([
    ...
    ])('it renders the $test', async ({ data, message, expected, }: {
        data: string;
        message: string;
        expected: string;
    }) => {
        ...
        const qrCodeImage = container.querySelector('[data-testid="qr-code-image"]');
        expect(qrCodeImage).toBeInTheDocument();
        const copyButton = container.querySelector('[data-testid="address-copy-button-text"]');
