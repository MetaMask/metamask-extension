...
<Box width={[BLOCK_SIZES.HALF, BLOCK_SIZES.THREE_FOURTHS, BLOCK_SIZES.ONE_FIFTH, BLOCK_SIZES.THREE_SIXTHS]}>
  Responsive box at width sizes: [{BLOCK_SIZES.HALF}, {BLOCK_SIZES.THREE_FOURTHS}, {BLOCK_SIZES.ONE_FIFTH}]
</Box>
```
