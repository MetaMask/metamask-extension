...
Use the `overflowWrap` prop and the `OverFlow` enum from `./ui/helpers/constants/design-system.js` to change the overflow wrap of the Typography component.
...
// If importing from ui/components/app/[YOUR_COMPONENT]/ directory
import Typography from '../../ui/typography';
import { OverFlow } from '../../../helpers/constants/design-system';
...
>
  <Typography overflowWrap={OverFlow.Normal}>
    {OverFlow.Normal}: 0x39013f961c378f02c2b82a6e1d31e9812786fd9d
  </Typography>
  <Typography overflowWrap={OverFlow.BreakWord}>
    {OverFlow.BreakWord}: 0x39013f961c378f02c2b82a6e1d31e9812786fd9d
  </Typography>
</div>;
```
