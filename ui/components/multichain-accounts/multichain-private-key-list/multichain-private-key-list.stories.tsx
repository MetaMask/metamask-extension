...
const meta: Meta<typeof MultichainPrivateKeyList> = {
  title: 'Components/MultichainAccounts/MultichainPrivateKeyList',
...
export default meta;
type Story = StoryObj<typeof MultichainPrivateKeyList>;

export const MultipleDifferentAccounts: Story = {
  args: {
    groupId: 'entropy:1234/0',
  },
};
