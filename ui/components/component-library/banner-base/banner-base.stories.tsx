...
export default {
  ...
  parameters: {
    docs: {
      page: README,
      description: {
        component: '**Deprecated**: This component is deprecated and will be removed in a future release. Please use BannerBase from @metamask/design-system-react instead.',
      },
    },
