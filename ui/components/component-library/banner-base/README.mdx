...
import * as BannerBaseStories from './banner-base.stories';
...
<Canvas of={BannerBaseStories.DefaultStory} />

## Props

<Controls of={BannerBaseStories.DefaultStory} />
...
<Canvas of={BannerBaseStories.ActionButton} />
