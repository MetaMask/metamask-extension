...
The `ButtonSecondary` accepts all props below as well as all [Box](/docs/components-componentlibrary-box--docs#props) and [ButtonBase](/docs/components-componentlibrary-buttonbase--default-story#props) component props

<ArgsTable of={ButtonSecondary} />

### Size

Use the `size` prop and the `ButtonSecondarySize` enum from `./ui/components/component-
library` to change the size of `ButtonSecondary`. Defaults to `ButtonSecondarySize.Md`
