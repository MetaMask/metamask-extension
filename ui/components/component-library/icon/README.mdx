...
<Canvas>
  <Story id="ui-components-component-library-icon-icon-stories-js--default-story" />
</Canvas>
...
<Icon name={ICON_NAMES.ADD_SQUARE} size={SIZES.XS} />
<Icon name={ICON_NAMES.ADD_SQUARE} size={SIZES.SM} />
<Icon name={ICON_NAMES.ADD_SQUARE} size={SIZES.MD} />
...
<Canvas>
  <Story id="ui-components-component-library-icon-icon-stories-js--color" />
</Canvas>
...
<Icon name={ICON_NAMES.ADD_SQUARE} color={COLORS.INHERIT} />
<Icon name={ICON_NAMES.ADD_SQUARE} color={COLORS.ICON_DEFAULT} />
<Icon name={ICON_NAMES.ADD_SQUARE} color={COLORS.ICON_ALTERNATIVE} />
<Icon name={ICON_NAMES.ADD_SQUARE} color={COLORS.ICON_MUTED} />
<Icon name={ICON_NAMES.ADD_SQUARE} color={COLORS.OVERLAY_INVERSE} />
<Icon name={ICON_NAMES.ADD_SQUARE} color={COLORS.PRIMARY_DEFAULT} />
<Icon name={ICON_NAMES.ADD_SQUARE} color={COLORS.PRIMARY_INVERSE} />
<Icon name={ICON_NAMES.ADD_SQUARE} color={COLORS.ERROR_DEFAULT} />
<Icon name={ICON_NAMES.ADD_SQUARE} color={COLORS.ERROR_INVERSE} />
<Icon name={ICON_NAMES.ADD_SQUARE} color={COLORS.SUCCESS_DEFAULT} />
<Icon name={ICON_NAMES.ADD_SQUARE} color={COLORS.SUCCESS_INVERSE} />
<Icon name={ICON_NAMES.ADD_SQUARE} color={COLORS.WARNING_DEFAULT} />
<Icon name={ICON_NAMES.ADD_SQUARE} color={COLORS.WARNING_INVERSE} />
<Icon name={ICON_NAMES.ADD_SQUARE} color={COLORS.INFO_DEFAULT} />
<Icon name={ICON_NAMES.ADD_SQUARE} color={COLORS.INFO_INVERSE} />
```
