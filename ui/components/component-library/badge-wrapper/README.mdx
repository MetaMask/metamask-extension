...
import * as BadgeWrapperStories from './badge-wrapper.stories';
...
<Canvas of={BadgeWrapperStories.DefaultStory} />

## Props

<Controls of={BadgeWrapperStories.DefaultStory} />
...
<Canvas of={BadgeWrapperStories.Children} />
...
<Canvas of={BadgeWrapperStories.PositionObj} />
...
<Canvas of={BadgeWrapperStories.AnchorElementShape} />
