...
import * as SelectWrapperStories from './select-wrapper.stories';

# SelectWrapper

`SelectWrapper` wraps and handles the state and logic for `SelectOption` and `SelectButton`

<Canvas of={SelectWrapperStories.DefaultStory} />

## Props

<Controls of={SelectWrapperStories.DefaultStory} />
...
<Canvas of={SelectWrapperStories.TriggerComponent} />
...
<Canvas of={SelectWrapperStories.Children} />
...
<Canvas of={SelectWrapperStories.ControlledOpen} />
...
<Canvas of={SelectWrapperStories.UncontrolledOpen} />
...
<Canvas of={SelectWrapperStories.ControlledValue} />
...
<Canvas of={SelectWrapperStories.UncontrolledValue} />
...
<Canvas of={SelectWrapperStories.IsMultiSelect} />
...
<Canvas of={SelectWrapperStories.UseSelectContext} />
...
<Canvas of={SelectWrapperStories.Placeholder} />
...
<Canvas of={SelectWrapperStories.IsDisabled} />
...
<Canvas of={SelectWrapperStories.IsDanger} />
...
<Canvas of={SelectWrapperStories.PopoverProps} />
...
<Canvas of={SelectWrapperStories.OnBlur} />
