...
The `FormTextField` is an input component to create forms. It bundles the [Label](/docs/ui-components-component-library-label-label-stories-js--default-story), [TextField](/docs/ui-components-component-library-text-field-text-field-stories-js--default-story) and [HelpText](/docs/ui-components-component-library-help-text-help-text-stories-js--default-story) components together.
...
The `FormTextField` accepts all props below as well as all [Box](/docs/ui-components-ui-box-box-stories-js--default-story#props), [TextField](/docs/ui-components-component-library-text-field-text-field-stories-js--default-story#props) component props
