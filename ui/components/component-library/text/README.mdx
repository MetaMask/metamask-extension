...
Use the `textTransform` prop and the `TextTransform` enum from `./ui/helpers/constants/design-system.js` to change the text alignment of the `Text` component
...
Use the `textAlign` prop and the `TextAlign` enum from `./ui/helpers/constants/design-system.js` to change the text alignment of the `Text` component
...
Use the `overflowWrap` prop and the `OverflowWrap` enum from `./ui/helpers/constants/design-system.js` to change the overflow wrap of the `Text` component
...
Values and using the `TextAlign` object from `./ui/helpers/constants/design-system.js` remain the same

```jsx
// Before
<Typograpghy align={TextAlign.Center}>Demo</Typograpghy>;
