...
Optional: `TEXT` from ./text object can be used as instead.
...
```jsx
import { Text, TEXT } from '../../ui/components/component-library';
...
Optional: `TEXT_COLORS` from ./text object can be used as instead.
...
Optional: `FONT_WEIGHT` from ./text object can be used as instead.
...
Optional: `FONT_STYLE` from ./text object can be used as instead.
...
Optional: `TEXT_TRANSFORM` from ./text object can be used as instead.
...
Optional: `TEXT_ALIGN` from ./text object can be used as instead.
...
Optional: `OVERFLOW_WRAP` from ./text object can be used as instead.
