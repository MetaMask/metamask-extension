...
> **⚠️ DEPRECATED**: This component is deprecated and will be removed in a future release. Please use the [Input component from @metamask/design-system-react](https://metamask.github.io/metamask-design-system/?path=/docs/react-components-input--docs) instead.
>
> - **Storybook Documentation**: https://metamask.github.io/metamask-design-system/?path=/docs/react-components-input--docs
> - **Component Source**: https://github.com/MetaMask/metamask-design-system/tree/main/packages/design-system-react/src/components/Input
