...
export const Type = (args) => (
  ...
  >
    ...
    <Input {...args} type={InputTypes.Password} placeholder="Password" />
    <Input {...args} type={InputTypes.Number} placeholder="Number" />
    <Input {...args} type={InputTypes.Search} placeholder="Search" />
  </Box>
);
