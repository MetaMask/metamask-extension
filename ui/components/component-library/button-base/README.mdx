...
You can use the `SIZES` object from `./ui/helpers/constants/design-system.js` as well, but it will not include the `ZERO_PADDING` option used for `ButtonTertiary`.

Possible sizes include:

- `BUTTON_SIZES.ZERO_PADDING` 22px
...
<ButtonBase size={BUTTON_SIZES.ZERO_PADDING} />
