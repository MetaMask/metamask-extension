...
describe('ModalFocus', () => {
  ...
  it('should render with modalDialogRef and focus if focusable', () => {
    const ref: React.RefObject<HTMLInputElement> = React.createRef();
    const { getByTestId } = render(
      <ModalFocus autoFocus={false} modalDialogRef={ref}>
        <input data-testid="modal-dialog-ref" ref={ref} />
      </ModalFocus>,
    );
    expect(getByTestId('modal-dialog-ref')).toHaveFocus();
  });
