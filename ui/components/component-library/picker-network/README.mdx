...
<PickerNetwork label="Arbitrum" />
<PickerNetwork label="Polygon" />
<PickerNetwork label="Optimism" />
<PickerNetwork label="BNB Smart Chain (previously BNB Chain)" style={{ maxWidth: '200px' }} />
```
...
```jsx
import { PickerNetwork } from '../../ui/component-library';
<PickerNetwork src="./images/arbitrum.svg" label="Arbitrum" />
<PickerNetwork src="./images/pol-token.svg" label="Polygon" />
