...
Use the `ariaLabel` prop to set the name of the AvatarIcon for proper accessibility

<Canvas>
  <Story id="ui-components-component-library-avatar-icon-avatar-icon-stories-js--aria-label" />
</Canvas>

```jsx
import { AvatarIcon } from '../ui/component-library';

<AvatarIcon icon={ICON_NAMES.EXPORT} ariaLabel="Visit MetaMask.io" />;
```
