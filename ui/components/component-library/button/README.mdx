...
The `Button` accepts all [ButtonPrimary](/docs/ui-components-component-library-button-primary-button-primary-stories-js--default-story) and [ButtonSecondary](/docs/ui-components-component-library-button-secondary-button-secondary-stories-js--default-story) component props

<ArgsTable of={ButtonPrimary} />

The `Button` accepts all [ButtonLink](/docs/ui-components-component-library-button-link-button-link-stories-js--default-story) component props
