...
import { Tag, IconName as IconNameLegacy } from '../../component-library';
...
type UseGlobalMenuProps = {
  closeMenu: () => void;
};

export const useGlobalMenu = ({ closeMenu }: UseGlobalMenuProps) => {
  ...
  const hasThirdPartyNotifySnaps =
    useSelector(getThirdPartyNotifySnaps).length > 0;
  ...
  // Support text and link - conditional based on build type
  ...
  const menuContent = (
    <>
      {basicFunctionality && (
        <>
          <MenuItem
            iconNameLegacy={IconNameLegacy.Notification}
      ...
      {(isPopup || isSidepanel) && (
        <MenuItem
          iconNameLegacy={IconNameLegacy.Export}
          onClick={() => {
      ...
      {getBrowserName() !== PLATFORM_FIREFOX &&
        ...
        (isPopup || isSidepanel) && (
          <MenuItem
            iconNameLegacy={
              isSidepanel ? IconNameLegacy.Popup : IconNameLegacy.Sidepanel
            }
            onClick={async () => {
      ...
      <MenuItem
        ...
        iconNameLegacy={IconNameLegacy.SecurityTick}
        onClick={() => {
          trackEvent({
      ...
      <MenuItem
        ...
        iconNameLegacy={IconNameLegacy.Hierarchy}
        onClick={() => {
      ...
      <MenuItem
        to={SNAPS_ROUTE}
        iconNameLegacy={IconNameLegacy.Snaps}
        onClick={closeMenu}
      ...
      <MenuItem
        iconNameLegacy={IconNameLegacy.MessageQuestion}
        ...
        >
          ...
          {showPriorityTag && (
            <Tag
              label={t('priority')}
              labelProps={{
                variant: TextVariantLegacy.bodySmMedium,
                color: TextColorLegacy.successDefault,
              }}
              startIconName={IconNameLegacy.Sparkle}
              startIconProps={{
                color: IconColorLegacy.successDefault,
              }}
      ...
      <MenuItem
        to={SETTINGS_ROUTE}
        iconNameLegacy={IconNameLegacy.Setting}
        disabled={hasUnapprovedTransactions}
        onClick={() => {
          trackEvent({
            category: MetaMetricsEventCategory.Navigation,
      ...
      <MenuItem
        ...
        iconNameLegacy={IconNameLegacy.Lock}
        onClick={() => {
