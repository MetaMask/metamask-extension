...
import NftsItems from '../../../app/assets/nfts-items/nfts-items';
import {
  Box,
  Text,
  ButtonLink,
...
import NFTsDetectionNoticeNFTsTab from '../../../app/assets/nfts-detection-notice-nfts-tab/nfts-detection-notice-nfts-tab';
