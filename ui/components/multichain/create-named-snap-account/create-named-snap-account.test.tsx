...
import { CreateNamedSnapAccount, CreateNamedSnapAccountProps, } from './create-named-snap-account';
...
const render = (props: CreateNamedSnapAccountProps = {
                ...
                accounts: {
                    ...
                    [mockSnapAccount1.id]: {
                        ...
                        metadata: {
                            ...
                            name: overrideAccountNames?.[mockSnapAccount1.id] ||
                    ...
                    [mockSnapAccount2.id]: {
                        ...
                        metadata: {
                            ...
                            name: overrideAccountNames?.[mockSnapAccount2.id] ||
...
describe('CreateNamedSnapAccount', () => {
    ...
    it('displays account name input and suggested name', async () => {
        ...
        await waitFor(() => expect(getByPlaceholderText(mockSnapSuggestedAccountName)).toBeInTheDocument());
    });
    it('renames account and fires onActionComplete with true when clicking "Add account"', async () => {
        ...
        const input = await waitFor(() => getByPlaceholderText(mockSnapSuggestedAccountName));
    ...
    it('increases suffix on snap account names when suggested name is already taken', async () => {
        ...
        await waitFor(() => getByPlaceholderText(`${mockSnapSuggestedAccountName} 2`));
        fireEvent.click(getByText(messages.addAccount.message));
        await waitFor(() => {
            expect(onActionComplete).toHaveBeenCalledTimes(1);
            expect(onActionComplete).toHaveBeenCalledWith({
