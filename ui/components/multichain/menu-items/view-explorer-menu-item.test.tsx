...
import { MULTICHAIN_NETWORK_BLOCK_EXPLORER_URL_MAP, MultichainNetworks, } from '../../../../shared/constants/multichain/networks';
...
const render = (account = mockAccount) => {
    ...
    return renderWithProvider(<ViewExplorerMenuItem>metricsLocation, "Global Menu", closeMenu = { jest, : .fn() }, account = { account }
        /  > , store);
};
describe('ViewExplorerMenuItem', () => {
    ...
    it('renders "View on explorer" for non-EVM account', () => {
        const expectedExplorerUrl = `${MULTICHAIN_NETWORK_BLOCK_EXPLORER_URL_MAP[MultichainNetworks.BITCOIN]}/${mockNonEvmAccount.address}`;
