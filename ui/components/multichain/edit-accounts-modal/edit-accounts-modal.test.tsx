...
const render = (props: {
    ...
    const accounts = Object.values(mockState.metamask.internalAccounts.accounts) as unknown as MergedInternalAccount[];
    return renderWithProvider(<EditAccountsModal>accounts, { accounts }, defaultSelectedAccountAddresses = { [accounts[0].address]:  }, { ...props }
        /  > , store);
};
