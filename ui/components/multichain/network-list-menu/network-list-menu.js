        ...
        {actionMode === ACTION_MODES.ADD ? (
          <Box>
            <NetworksForm
              ...
              setActiveOnSubmit
              networksToRender={[]}
              cancelCallback={() => setActionMode(ACTION_MODES.LIST)}
              submitCallback={() => setActionMode(ACTION_MODES.LIST)}
            />
          </Box>
        ) : null}
        {actionMode === ACTION_MODES.EDIT ? <Box>TODO: FORM HERE</Box> : null}
      </ModalContent>
    </Modal>
  );
};
