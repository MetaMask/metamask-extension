...
import { detectNfts, setSelectedAccount, setAccountDisconnectedToast } from '../../../store/actions';
import {
  MetaMetricsEventAccountType,
  MetaMetricsEventCategory,
  MetaMetricsEventName,
} from '../../../../shared/constants/metametrics';
import { isCurrentTabSolanaDapp } from '../../../helpers/utils/dapp-utils';
...
export const AccountListMenu = ({
  ...
  const onAccountListItemItemClicked = useCallback(
    (account: MergedInternalAccount) => {
      // Check if switching to a disconnected Solana account over a Solana dapp
      ...
      if (
        ...
        !connectedSite &&
        currentTabOrigin &&
        isCurrentTabSolanaDapp(currentTabOrigin)
      ) {
        dispatch(setAccountDisconnectedToast({
          accountType: 'Solana',
