...
export const StackCardEmpty: React.FC<React.PropsWithChildren<StackCardEmptyProps>> = ({
  isBackground = true,
  className = '',
}) => {
...
export const EmptyStateComponent: React.FC<React.PropsWithChildren<EmptyStateComponentProps>> = ({
  onComplete,
  isBackground = false,
}) => {
  const t = useI18nContext();
