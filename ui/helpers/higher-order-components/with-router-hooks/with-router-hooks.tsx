...
function withRouterHooks<Props extends object>(
  WrappedComponent: React.ComponentType<React.PropsWithChildren<Props & RouterHooksProps>>,
): React.ComponentType<React.PropsWithChildren<Props & Partial<RouterHooksProps>>> {
