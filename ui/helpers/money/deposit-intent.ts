...
/**
 * Clears the recorded intent for a deposit batch. Called when the transaction
 * reaches a terminal state (confirmed, failed, dropped, rejected) or when
 * deposit setup fails before submission.
 *
 * @param batchId - The batch id of the deposit.
 */
