...
function createMockState(metamaskState: Partial<MetaMaskReduxState['metamask']>): MetaMaskReduxState {
    return {};
}
describe('Tags Utils', () => {
    ...
    describe('getStartupTraceTags', () => {
        ...
        it('includes pending approval type', () => {
            ...
            const tags = getStartupTraceTags(state);
            expect(tags['wallet.pending_approval']).toStrictEqual('eth_sendTransaction');
        });
