...
describe('util', () => {
  ...
  describe('isDomainReadyForResolution', () => {
    it('should return true for complete ENS domain', () => {
      expect(util.isDomainReadyForResolution('vitalik.eth')).toStrictEqual(
        true,
      );
    });

    it('should return true for complete domain with common TLD', () => {
      expect(util.isDomainReadyForResolution('example.com')).toStrictEqual(
        true,
      );
    });

    it('should return true for complete domain with crypto TLD', () => {
      expect(util.isDomainReadyForResolution('wallet.crypto')).toStrictEqual(
        true,
      );
    });
    ...
    it('should return true for subdomain', () => {
      expect(
        util.isDomainReadyForResolution('subdomain.vitalik.eth'),
      ).toStrictEqual(true);
    });

    it('should return false for very short partial domain', () => {
      expect(util.isDomainReadyForResolution('v.e')).toStrictEqual(false);
    });

    it('should return false for partial domain without TLD', () => {
      expect(util.isDomainReadyForResolution('vitalik')).toStrictEqual(false);
    });

    it('should return false for domain without period', () => {
      expect(util.isDomainReadyForResolution('example')).toStrictEqual(false);
    });

    it('should return false for empty string', () => {
      expect(util.isDomainReadyForResolution('')).toStrictEqual(false);
    });

    it('should return false for null', () => {
      expect(util.isDomainReadyForResolution(null)).toStrictEqual(false);
    });

    it('should return false for undefined', () => {
      expect(util.isDomainReadyForResolution(undefined)).toStrictEqual(false);
    });

    it('should return false for invalid domain format', () => {
      expect(util.isDomainReadyForResolution('$.eth')).toStrictEqual(false);
    });

    it('should return true for domain with 2-character TLD', () => {
      expect(util.isDomainReadyForResolution('example.io')).toStrictEqual(true);
    });

    it('should return true for domain with uncommon but valid TLD', () => {
      expect(util.isDomainReadyForResolution('example.xyz')).toStrictEqual(
        true,
      );
    });

    it('should return false for single character domain', () => {
      expect(util.isDomainReadyForResolution('a.b')).toStrictEqual(false);
    });

    it('should return true for minimum length complete domain', () => {
      expect(util.isDomainReadyForResolution('abc.eth')).toStrictEqual(true);
    });

    it('should return true for Solana domain', () => {
      expect(util.isDomainReadyForResolution('example.sol')).toStrictEqual(
        true,
      );
    });

    it('should return true for Bitcoin domain', () => {
      expect(util.isDomainReadyForResolution('example.btc')).toStrictEqual(
        true,
      );
    });
  });
