...
import { TS_TOURNIQUET } from '../../../shared/lib/typescript-migration-tools';
 ...
 */
export const fetchTokenExchangeRates = TS_TOURNIQUET<
 ...
 */
export const getCalculatedTokenAmount1dAgo = TS_TOURNIQUET<
