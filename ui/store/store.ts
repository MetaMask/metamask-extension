...
/** Typed dispatch for thunks and plain actions. Prefer over `useDispatch` from react-redux. */
export const useAppDispatch = (): MetaMaskReduxDispatch =>
  useDispatch<MetaMaskReduxDispatch>();
