...
export function setAccountDisconnectedToast(
  accountDisconnectedToast: { accountType: string; accountName: string } | null,
): PayloadAction<{ accountType: string; accountName: string } | null> {
  return {
    type: actionConstants.SET_ACCOUNT_DISCONNECTED_TOAST,
    payload: accountDisconnectedToast,
  };
}
