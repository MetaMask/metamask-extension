...
export const SET_SKIP_PASSKEY_AUTO_ON_NEXT_UNLOCK =
  'SET_SKIP_PASSKEY_AUTO_ON_NEXT_UNLOCK';
// error handling
...
export const SET_SHOW_PASSKEY_SETTINGS_TOAST =
  'SET_SHOW_PASSKEY_SETTINGS_TOAST';

export const SET_SHOW_COPY_ADDRESS_TOAST = 'SET_SHOW_COPY_ADDRESS_TOAST';

export const SET_SHOW_CLAIM_SUBMIT_TOAST = 'SET_SHOW_CLAIM_SUBMIT_TOAST';
