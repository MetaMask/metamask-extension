...
// Failed Transactions
export const ADD_TX_TO_FAILED_TXES_TO_DISPLAY = 'ADD_TX_TO_FAILED_TXES_TO_DISPLAY';
export const REMOVE_TX_TO_FAILED_TXES_TO_DISPLAY = 'REMOVE_TX_TO_FAILED_TXES_TO_DISPLAY';
