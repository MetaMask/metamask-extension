...
export const ONBOARDING_TOGGLE_BACKUP_AND_SYNC_ON =
  'ONBOARDING_TOGGLE_BACKUP_AND_SYNC_ON';
export const ONBOARDING_TOGGLE_BACKUP_AND_SYNC_OFF =
  'ONBOARDING_TOGGLE_BACKUP_AND_SYNC_OFF';
...
export const COMPLETE_ONBOARDING_WITH_SIDEPANEL =
  'COMPLETE_ONBOARDING_WITH_SIDEPANEL';
export const SET_HAS_SEEN_ONBOARDING_COMPLETION_PAGE =
  'SET_HAS_SEEN_ONBOARDING_COMPLETION_PAGE';
...
export const SET_SHOW_INFURA_SWITCH_TOAST = 'SET_SHOW_INFURA_SWITCH_TOAST';
...
// Home deep-link QR code modal
export const SET_HOME_DEEP_LINK_QR_CODE = 'SET_HOME_DEEP_LINK_QR_CODE';
export const CLEAR_HOME_DEEP_LINK_QR_CODE = 'CLEAR_HOME_DEEP_LINK_QR_CODE';
