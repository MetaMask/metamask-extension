...
export const SET_SELECTED_NETWORK_CONFIGURATION_ID = 'SET_SELECTED_NETWORK_CONFIGURATION_ID';
export const SET_ADDED_NETWORK_CONFIGURATION_ID = 'SET_ADDED_NETWORK_CONFIGURATION_ID';
