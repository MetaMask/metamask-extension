...
export const PERFORM_SIGN_IN = 'PERFORM_SIGN_IN';
export const PERFORM_SIGN_OUT = 'PERFORM_SIGN_OUT';
export const ENABLE_PROFILE_SYNCING = 'ENABLE_PROFILE_SYNCING';
export const DISABLE_PROFILE_SYNCING = 'DISABLE_PROFILE_SYNCING';
export const CREATE_ON_CHAIN_TRIGGERS = 'CREATE_ON_CHAIN_TRIGGERS';
export const DELETE_ON_CHAIN_TRIGGERS_BY_ACCOUNT =
  'DELETE_ON_CHAIN_TRIGGERS_BY_ACCOUNT';
export const UPDATE_ON_CHAIN_TRIGGERS_BY_ACCOUNT =
  'UPDATE_ON_CHAIN_TRIGGERS_BY_ACCOUNT';
export const FETCH_AND_UPDATE_METAMASK_NOTIFICATIONS =
  'FETCH_AND_UPDATE_METAMASK_NOTIFICATIONS';
export const MARK_METAMASK_NOTIFICATIONS_AS_READ =
  'MARK_METAMASK_NOTIFICATIONS_AS_READ';
export const SET_METAMASK_NOTIFICATIONS_ENABLED =
  'SET_METAMASK_NOTIFICATIONS_ENABLED';
export const SET_SNAP_NOTIFICATIONS_ENABLED = 'SET_SNAP_NOTIFICATIONS_ENABLED';
export const SET_FEATURE_ANNOUNCEMENTS_ENABLED =
  'SET_FEATURE_ANNOUNCEMENTS_ENABLED';
export const CHECK_ACCOUNTS_PRESENCE = 'CHECK_ACCOUNTS_PRESENCE';
export const SHOW_CONFIRM_TURN_OFF_PROFILE_SYNCING_MODAL =
  'SHOW_CONFIRM_TURN_OFF_PROFILE_SYNCING_MODAL';
export const SET_METAMASK_NOTIFICATIONS_FEATURE_SEEN =
