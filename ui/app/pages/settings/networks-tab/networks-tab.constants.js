const defaultNetworksData = [
  ...
  },
  {
    ...
    iconColor: '#4aef7f',
    providerType: 'ebakus',
    rpcUrl: 'https://rpc.ebakus.com',
    chainId: '10',
    ticker: 'EBK',
    blockExplorerUrl: 'https://explorer.ebakus.com',
  },
  {
    labelKey: 'ebakusTestnet',
    iconColor: '#000',
    providerType: 'ebakusTestnet',
    rpcUrl: 'https://rpc.ebakus-testnet.com',
    chainId: '7',
    ticker: 'EBK',
    blockExplorerUrl: 'https://explorer.ebakus-testnet.com',
  },
  {
    labelKey: 'localhost',
    iconColor: 'white',
