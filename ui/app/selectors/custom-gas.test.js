...
describe('custom-gas selectors', function () {
  ...
  describe('getCustomGasLimit()', function () {
    it('should return gas.customData.limit', function () {
      const mockState = { gas: { customData: { limit: 'mockGasLimit' } } }
      assert.equal(getCustomGasLimit(mockState), 'mockGasLimit')
    })
  })
  ...
  describe('getCustomStorageLimit()', function () {
    it('should return gas.customData.limit', function () {})
    const mockState = {
      storageLimit: { customData: { limit: 'mockStorageLimit' } },
    }
    assert.equal(getCustomStorageLimit(mockState), 'mockStorageLimit')
  })
})
