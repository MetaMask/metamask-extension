...
import {
  getFromDropdownOpen,
} from './deposit-layer2-app-from-row.selectors.js'
...
import DepositLayer2AppFromRow from './deposit-layer2-app-from-row.component'

export default connect(mapStateToProps, mapDispatchToProps)(DepositLayer2AppFromRow)
