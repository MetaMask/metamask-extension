...
import DepositLayer2AppDropdownList from '../../../deposit-layer2-app-dropdown-list/deposit-layer2-app-dropdown-list.component'
...
describe('FromDropdown Component', function () {
  ...
  describe('render', () => {
    ...
    it('should not render a SendDropdownList when dropdownOpen is false', () => {
      assert.equal(wrapper.find(DepositLayer2AppDropdownList).length, 0)
    })

    it('should render a SendDropdownList when dropdownOpen is true', () => {
      wrapper.setProps({ dropdownOpen: true })
      assert(wrapper.find(DepositLayer2AppDropdownList).length, 1)
    })
    ...
    it('should pass the correct props to the SendDropdownList]', () => {
      ...
      const {
        ...
        onSelect,
        activeAddress,
      } = wrapper.find(DepositLayer2AppDropdownList).props()
