...
class CustomizeGasModal extends Component {
  static contextTypes = {
    t: PropTypes.func,
  ...
  static propTypes = {
    ...
    setGasTotal: PropTypes.func.isRequired,
    maxModeOn: PropTypes.bool.isRequired,
    selectedToken: PropTypes.object.isRequired,
    balance: PropTypes.string.isRequired,
    amount: PropTypes.string.isRequired,
    amountConversionRate: PropTypes.number.isRequired,
    conversionRate: PropTypes.number.isRequired,
    updateSendAmount: PropTypes.func.isRequired,
    forceGasMin: PropTypes.bool.isRequired,
    gasIsLoading: PropTypes.bool.isRequired,
  ...
  save (gasPrice, gasLimit, gasTotal) {
  ...
  convertAndSetGasLimit (newGasLimit) {
  ...
  convertAndSetGasPrice (newGasPrice) {
