...
import { ConfirmSeedPageContainerContent } from '.'
import { SeriousPageContainerFooter } from '../../ui/serious-page-container'

export default class ConfirmSeedPageContainer extends Component {
  ...
  render () {
    ...
    return (
      <div className="page-container seed-approval-container">
        <ConfirmSeedPageContainerContent
        ...
        { !redirect
          ? (
            <SeriousPageContainerFooter
              cancelButtonType="primary"
              onCancel={() => this.onCancel()}
              cancelText={this.context.t('cancel')}
              doSubmit={() => this.onSubmit()}
