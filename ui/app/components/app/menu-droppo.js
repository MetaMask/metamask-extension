...
MenuDroppoComponent.prototype.render = function () {
  ...
  // changed this because I was getting:
  // TypeError: Cannot assign to read only property 'zIndex' of object '#<Object>'
  const _style = Object.assign({}, { zIndex }, style, !('position' in style) && {
    position: 'fixed',
  })
