...
import { tokenDetectionStartPolling, tokenDetectionStopPollingByPollingToken, } from '../store/actions';
...
describe('useTokenDetectionPolling', () => {
    ...
    it('should poll token detection for chain IDs when enabled and stop on dismount', async () => {
        ...
        expect(tokenDetectionStopPollingByPollingToken).toHaveBeenCalledWith('0x1,0x89_detection');
    });
