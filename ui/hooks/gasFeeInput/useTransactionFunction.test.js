...
const TEST_GAS_FEE_1_AS_HEX = TEST_GAS_FEE_1.toPrefixedHexString();
const TEST_GAS_FEE_2 = new Numeric(1500000016, 10);
const TEST_GAS_FEE_2_AS_HEX = TEST_GAS_FEE_2.toPrefixedHexString();

const MEDIUM_FEE_MARKET_ESTIMATE_IN_DEC_GWEI =
  FEE_MARKET_ESTIMATE_RETURN_VALUE.gasFeeEstimates.medium
    .suggestedMaxPriorityFeePerGas;
const MEDIUM_FEE_MARKET_ESTIMATE_IN_HEX_WEI = new Numeric(
  MEDIUM_FEE_MARKET_ESTIMATE_IN_DEC_GWEI,
  10,
  'GWEI',
)
  .toBase(16)
    ...
    () =>
      useTransactionFunctions({
        ...
        transaction: {
          ...
          txParams: {
            maxFeePerGas: TEST_GAS_FEE_1_AS_HEX,
            maxPriorityFeePerGas: TEST_GAS_FEE_1_AS_HEX,
          },
        },
        ...props,
      }),
...
describe('useMaxPriorityFeePerGasInput', () => {
  ...
  it('invokes action updateTransaction with 10% increased max priority fee and medium fee + 10% when updateTransactionToTenPercentIncreasedGasFee callback is invoked while original priority fee is 0', async () => {
    ...
    expect(mockUpdateGasFees).toHaveBeenCalledWith(undefined, {
      ...
      gas: '5208',
      gasLimit: '5208',
      maxFeePerGas: TEST_GAS_FEE_1.times(1.1, 10).toPrefixedHexString(),
      maxPriorityFeePerGas: MEDIUM_FEE_MARKET_ESTIMATE_IN_HEX_WEI.times(
        1.1,
        10,
      ).toPrefixedHexString(),
      userEditedGasLimit: undefined,
