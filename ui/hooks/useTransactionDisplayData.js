...
export function useTransactionDisplayData(transactionGroup) {
  ...
  if (signatureTypes.includes(type)) {
    ...
    title = t('sentTokenAsToken', [
      initialTransaction.sourceTokenSymbol ?? t('swapUnknown'),
      initialTransaction.destinationTokenSymbol ?? t('swapUnknown'),
    ]);
    primarySuffix =
    ...
    title = t('bridgeApproval', [
      bridgeTokenDisplayData.sourceTokenSymbol ?? t('swapUnknown'),
    ]);
    primarySuffix =
      bridgeTokenDisplayData.sourceTokenSymbol ?? t('swapUnknown');
