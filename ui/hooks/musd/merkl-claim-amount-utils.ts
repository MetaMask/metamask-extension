 ...
 *
 * For confirmed txs, tries receipt logs first (exact per-tx payout) then
 * falls back to contract call (total minus claimed). For non-confirmed txs
 * (failed/dropped), uses the contract call approach directly.
 *
