...
- Display the component's api using the `<Props of={YourComponent} />` component from storybook docs
...
<!-- import the component to use for the props table under ## Component API  -->
...
<!-- Display the component api using the prop table  -->
<Props of={Button} />
...
Nice work! You're now ready to start creating comphrehensive documentation using storybook 🎉👍
