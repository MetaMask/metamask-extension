  ...
  if (showNavbar) {
    return (
      <div className="flex h-full min-h-0 flex-col">
        <AppHeader />
        <ScrollContainer className="group/shell flex min-h-0 flex-1 flex-col overflow-y-auto overscroll-contain [container-type:scroll-state] [scrollbar-gutter:stable]">
