...
import { getIsSmartTransaction, SmartTransactionsState } from "../../../../../shared/modules/selectors";
...
export function useGaslessSupportedSmartTransactions(): {
  ...
  const isSmartTransaction = useSelector((state : SmartTransactionsState) => getIsSmartTransaction(state, chainId));
