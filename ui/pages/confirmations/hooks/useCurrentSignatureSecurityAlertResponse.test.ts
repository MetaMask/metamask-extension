...
const getMockCurrentState = () => getMockPersonalSignConfirmStateForRequest(currentConfirmationMock, {
...
describe('useCurrentSignatureSecurityAlertResponse', () => {
    it('returns security alert response for current signature request', () => {
        const { result } = renderHookWithConfirmContextProvider(() => useCurrentSignatureSecurityAlertResponse(), getMockCurrentState());
