import { TransactionMeta, TransactionParams, UserFeeLevel, } from '@metamask/transaction-controller';
import { GasEstimateTypes } from '../../../../../../shared/constants/gas';
import { genUnapprovedContractInteractionConfirmation } from '../../../../../../test/data/confirmations/contract-interaction';
import { getMockConfirmState, getMockConfirmStateForTransaction, } from '../../../../../../test/data/confirmations/helper';
...
function runHook(state: Record<string, unknown>) {
    const response = renderHookWithConfirmContextProvider(useNoGasPriceAlerts, state);
...
describe('useNoGasPriceAlerts', () => {
    ...
    it('returns no alerts if transaction has custom gas fee and no fee estimate', () => {
        expect(runHook(getMockConfirmStateForTransaction({
            ...CONFIRMATION_MOCK,
    ...
    it('returns alert if gas fee is not custom and no fee estimate', () => {
        const alerts = runHook(getMockConfirmStateForTransaction({
            ...CONFIRMATION_MOCK,
            userFeeLevel: UserFeeLevel.MEDIUM,
        }, {
            GasFeeController: {
