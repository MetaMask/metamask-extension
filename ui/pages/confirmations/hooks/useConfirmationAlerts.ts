...
import { usePayQuoteValidationAlert } from './alerts/transactions/usePayQuoteValidationAlert';
...
function useTransactionAlerts(): Alert[] {
  ...
  const payQuoteValidationAlerts = usePayQuoteValidationAlert();
