...
import { useSignatureRecipientAlerts } from './alerts/useSignatureRecipientAlerts';
...
export default function useConfirmationAlerts(): Alert[] {
  ...
  const signatureRecipientAlerts = useSignatureRecipientAlerts();
