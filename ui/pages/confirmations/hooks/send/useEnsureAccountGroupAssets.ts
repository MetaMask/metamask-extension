 ...
 *
 * Loading is limited to the override group's accounts: fanning asset fetches
 * out across a large wallet is a known performance cost, so only the account
 * actually being paid from is fetched.
 *
...
export function useEnsureAccountGroupAssets(
  ...
  }, [accountGroupId, accounts, caipChainIds, dispatch]);
