...
describe('<AdvancedDetails />', () => {
    ...
    it('does not render component when the state property is false', () => {
        ...
        const { container } = renderWithConfirmContextProvider(<AdvancedDetails>/>,, mockStore);
    ...
    it('renders component when the prop override is passed', () => {
        ...
        const mockStore = configureMockStore(middleware)(state);
        const { container } = renderWithConfirmContextProvider(<AdvancedDetails>overrideVisibility /  > , mockStore);
        expect(container).toMatchSnapshot();
    });
});
