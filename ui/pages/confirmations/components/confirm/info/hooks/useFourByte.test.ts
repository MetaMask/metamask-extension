...
import { CONTRACT_INTERACTION_SENDER_ADDRESS, genUnapprovedContractInteractionConfirmation, } from '../../../../../../../test/data/confirmations/contract-interaction';
...
describe('useFourByte', () => {
    ...
    it('returns the method name and params', () => {
        ...
        const { result } = renderHookWithProvider(() => useFourByte(currentConfirmation), {
