...
const render = (securityAlertResponse: SecurityAlertResponse = mockSecurityAlertResponse) => {
    ...
    return renderWithConfirmContextProvider(<BlockaidLoadingIndicator>/>,, defaultStore);
};
