...
describe('ConfirmFooter', () => {
  ...
  it('renders SingleActionFooter for a batch transaction with a moneyAccountDeposit nested transaction', () => {
    jest.spyOn(confirmContext, 'useConfirmContext').mockReturnValue({
      currentConfirmation: {
        ...genUnapprovedContractInteractionConfirmation(),
        // Money account transactions are submitted via
        // `addTransactionBatch`, which always sets the top-level type to
        // `batch` — the money-account type only appears on the nested
        // transactions.
  ...
  it('renders SingleActionFooter for a batch transaction with a moneyAccountWithdraw nested transaction', () => {
    jest.spyOn(confirmContext, 'useConfirmContext').mockReturnValue({
      currentConfirmation: {
        ...genUnapprovedContractInteractionConfirmation(),
        type: TransactionType.batch,
