...
import { getMockPersonalSignConfirmState, getMockTypedSignConfirmStateForRequest, } from '../../../../../../../test/data/confirmations/helper';
...
describe('SnapsSection', () => {
    it('renders section personal sign request', () => {
        ...
        const { container, getByText } = renderWithConfirmContextProvider(<SnapsSection>/>,, mockStore);
