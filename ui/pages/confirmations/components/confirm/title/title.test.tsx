...
describe('ConfirmTitle', () => {
  it('should render a skeleton loader when there is no current confirmation', () => {
    ...
    expect(container.querySelector('[data-testid="confirm-title-skeleton"]')).toBeInTheDocument();
  });
  ...
  it('should not render title skeleton when loader is send', () => {
    ...
    expect(container.querySelector('[data-testid="confirm-title-skeleton"]')).not.toBeInTheDocument();
  });
