...
export default function ContractDetailsModal({
  ...
  return (
    <>
      <Box
        paddingTop={6}
        paddingRight={inline ? 0 : 4}
        paddingBottom={inline ? 6 : 8}
        paddingLeft={inline ? 0 : 4}
        ...
        {!isContractRequestingSignature && (
          <>
            ...
            <Box
              ...
              className="contract-details__contract"
            >
              {nft ? (
                <Box margin={4}>
                  <NftCollectionImage
                ...
                <Identicon
                  className="contract-details__contract__identicon"
