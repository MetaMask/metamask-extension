...
describe('NotificationsSettingsAllowNotifications', () => {
    it('renders correctly', () => {
        const { getByTestId } = render(<Provider>store, { store } >
            <MetamaskNotificationsProvider><NotificationsSettingsAllowNotifications>disabled, { false:  }, loading = { false:  }, setLoading = {}());
        {
            return null;
        }
    }, />
        ...
        < /Provider>,);
    expect(getByTestId('notifications-settings-allow-notifications')).toBeInTheDocument();
});
;
