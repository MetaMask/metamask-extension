...
describe('NotificationsListTurnOnNotifications', () => {
    it('renders correctly', () => {
        render(<Provider>store, { store } >
            <MetamaskNotificationsProvider><NotificationsListTurnOnNotifications>/>
            < /MetamaskNotificationsProvider>
            < /Provider>,);
        expect(screen.getByTestId('notifications-list-turn-on-notifications')).toBeInTheDocument();
    });
});
