...
import ImportTokensConfirmation from '.';
...
export default {
  title: 'Pages/ImportTokensConfirmation',
  component: ImportTokensConfirmation,
  argTypes: {
    onBackClick: {
      action: 'onClose',
    },
...
export const DefaultStory = (args) => <ImportTokensConfirmation {...args} />;
