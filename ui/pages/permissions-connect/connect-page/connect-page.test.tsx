...
import { CaveatTypes, EndowmentTypes, RestrictedMethods, } from '../../../../shared/constants/permissions';
import { overrideAccountsFromMockState } from '../../../../test/jest/mocks';
import { MOCK_ACCOUNT_BIP122_P2WPKH, MOCK_ACCOUNT_EOA, } from '../../../../test/data/mock-accounts';
...
describe('ConnectPage', () => {
    ...
    it('should render account connectionListItem', () => {
        const { getByText } = render();
        expect(getByText('See your accounts and suggest transactions')).toBeDefined();
    });
    ...
    it('should render a disabled confirm if current account is a non-EVM account', () => {
        ...
        const mockAccountsState = overrideAccountsFromMockState(mockState, mockAccounts, mockSelectedAccountId);
        const { getByText } = render({
