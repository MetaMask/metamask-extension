...
import { MultichainConnectPage } from './connect-page/multichain-connect-page';
...
export default class PermissionConnect extends Component {
  static propTypes = {
    ...
    useMultichainRedesign: PropTypes.bool.isRequired,
  };
          ...
          <Switch>
            <Route
              ...
              render={() => {
                ...
                if (useMultichainRedesign) {
                  return (
                    <MultichainConnectPage
