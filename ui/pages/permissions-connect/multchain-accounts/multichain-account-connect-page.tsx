...
import { getMultichainAccountGroups } from '../../../selectors/multichain-accounts/account-tree';
...
export type MultichainAccountConnectPageProps = {
...
export const MultichainAccountConnectPage: React.FC<
...
> = ({
  ...
  const allAccounts = useSelector(getMultichainAccountGroups);

  const selectedAccountsGroups = allAccounts.filter((accountGroup) =>
    selectedAccountGroupIds.includes(accountGroup.id as AccountGroupId),
  );

  console.log(
    'selectedAccountsGroups',
    selectedAccountsGroups.map((group) => group.id),
  );
        ...
        >
          ...
          >
            <Box marginTop={4}>
              ...
              >
                {selectedAccountsGroups.map((accountGroup) => (
              ...
              {/*
              // TODO: Add new multichain edit accounts modal component here
              */}
          ...
          >
            <Box marginTop={4}>
              {/*
              // TODO: Add new multichain site cell component here
              <MultichainSiteCell
