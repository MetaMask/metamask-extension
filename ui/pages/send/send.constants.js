...
const UNS_NOT_REGISTERED = 'noAddressForName';
const UNS_RECORD_NOT_FOUND = 'unsNoRecord';
const UNS_UNSPECIFIED_RESOLVER = 'unsNoResolver';
const UNS_RESOLUTION_ERROR = 'unsResolutionError';
