...
export default function ViewQuote() {
  ...
  const gasTotalInWeiHex = calcGasTotal(
    maxGasLimit,
    networkAndAccountSupportsEIP1559 ? maxFeePerGas : gasPrice,
  );
  ...
  const renderablePopoverData = useMemo(() => {
    return quotesToRenderableData(
      quotes,
      networkAndAccountSupportsEIP1559 ? baseAndPriorityFeePerGas : gasPrice,
      conversionRate,
      currentCurrency,
      approveGas,
  ...
  const { feeInFiat, feeInEth } = getRenderableNetworkFeesForQuote({
    ...
    approveGas,
    gasPrice: networkAndAccountSupportsEIP1559
      ? baseAndPriorityFeePerGas
      : gasPrice,
    currentCurrency,
    conversionRate,
  ...
  const {
    ...
    approveGas,
    gasPrice: networkAndAccountSupportsEIP1559 ? maxFeePerGas : gasPrice,
    currentCurrency,
    conversionRate,
    tradeValue,
    sourceSymbol: sourceTokenSymbol,
  ...
  return (
    <div className="view-quote">
      ...
      >
        ...
        {showEditGasPopover && networkAndAccountSupportsEIP1559 && (
          <EditGasPopover
            transaction={{
              txParams: {
                maxFeePerGas,
        ...
        >
          <FeeCard
            ...
            chainId={chainId}
            networkAndAccountSupportsEIP1559={networkAndAccountSupportsEIP1559}
