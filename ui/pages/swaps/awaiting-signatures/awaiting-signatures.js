...
export default function AwaitingSignatures({
  ...
  const needsTwoConfirmations = false;
  ...
  descriptionText = t('swapOnceTransactionHasProcess', [
    <span
      ...
      className="awaiting-signatures__amount-and-symbol"
    >
    ...
    <div className="awaiting-signatures">
      <div className="awaiting-signatures__content">
        ...
        {needsTwoConfirmations && (
          <>
            <p>{t('swapToConfirmWithHwWallet')}</p>
            <ul>
              <li>1. {t('swapAllowSwappingOf', ['MKR'])}</li>
              <li>2. {t('swapFromTo', ['MKR', 'ETH'])}</li>
            </ul>
            <div className="awaiting-signatures__main-descrption">
              {t('swapGasFeesSplit')}
            </div>
            {content}
          </>
