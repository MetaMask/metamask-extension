...
import { Display, FlexDirection, JustifyContent, TextColor, TextVariant } from "../../../helpers/constants/design-system";
import { useI18nContext } from "../../../hooks/useI18nContext";
import { localizeLargeNumber } from "../util";
import { getCurrentCurrency } from "../../../ducks/metamask/metamask";
import { useSelector } from "react-redux";
import { useMultichainSelector } from "../../../hooks/useMultichainSelector";
import { getMultichainConversionRate, getMultichainIsEvm, getMultichainNativeCurrency } from "../../../selectors/multichain";
...
export const AssetMarketDetails = ({
  ...
  const nonEvmExchangeRate = nonEvmConversionRates?.[address as CaipAssetType]?.rate || 0;

  const tokenExchangeRate = isEvm
    ? evmTokenExchangeRate
    : nonEvmExchangeRate;
  ...
  const nonEvmMarketData = type === AssetType.native
  ...
  if (isEvm) {
    ...
    totalVolume = tokenExchangeRate * totalVolume;
    circulatingSupply = tokenExchangeRate * circulatingSupply;
    allTimeHigh = tokenExchangeRate * allTimeHigh;
    allTimeLow = tokenExchangeRate * allTimeLow;
  }

  return <Box paddingLeft={4} paddingRight={4}>
