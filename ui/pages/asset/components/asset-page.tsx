...
import { isArcERC20USDC } from '../../../components/app/assets/enablement/arc';
...
const AssetPage = ({
  ...
  const assetWithBalance = accountGroupIdAssets[chainId]?.find(
    (item) =>
      ...
      // TODO: Check with Assets team if this is the logic to display the native page if user goes to 0x360000 page.
      isArcERC20USDC(chainId, address, item) ||
