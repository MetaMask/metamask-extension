  ...
  const routeConfig = useMemo(
    () => [
      ...
      createRouteWithLayout({
        ...
        layout: RootLayout,
        authenticated: true,
        basicFunctionalityFeatureName: 'Notifications',
      }),
      createRouteWithLayout({
      ...
      createRouteWithLayout({
        ...
        layout: LegacyLayout,
        authenticated: true,
        basicFunctionalityFeatureName: 'Swap',
      }),
      createRouteWithLayout({
      ...
      createRouteWithLayout({
        ...
        layout: RootLayout,
        authenticated: true,
        basicFunctionalityFeatureName: 'DeFi',
      }),
      createRouteWithLayout({
        path: PERMISSIONS,
      ...
      createRouteWithLayout({
        ...
        layout: LegacyLayout,
        authenticated: true,
        basicFunctionalityFeatureName: 'Create account',
      }),
      createRouteWithLayout({
        ...
        layout: LegacyLayout,
        authenticated: true,
        basicFunctionalityFeatureName: 'Transaction Shield',
      }),
      createRouteWithLayout({
        path: REWARDS_ROUTE,
        ...
        layout: RootLayout,
        authenticated: true,
        basicFunctionalityFeatureName: 'Rewards',
      }),
      createRouteWithLayout({
        ...
        layout: RootLayout,
        authenticated: true,
        basicFunctionalityFeatureName: 'Perps',
      }),
      createRouteWithLayout({
