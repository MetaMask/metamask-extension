...
describe('FormFooter Component', () => {
  ...
  beforeAll(() => {
    sinon.spy(FormFooter.prototype, 'onCancel');
    sinon.spy(FormFooter.prototype, 'onSubmit');
  });
  ...
  afterEach(() => {
    ...
    FormFooter.prototype.onCancel.resetHistory();
    FormFooter.prototype.onSubmit.resetHistory();
  });
  ...
  describe('render', () => {
    ...
    it('should pass the correct props to PageContainerFooter', () => {
      ...
      expect(FormFooter.prototype.onSubmit.callCount).toStrictEqual(0);
      onSubmit(MOCK_EVENT);
      expect(FormFooter.prototype.onSubmit.callCount).toStrictEqual(1);

      expect(FormFooter.prototype.onCancel.callCount).toStrictEqual(0);
      onCancel();
      expect(FormFooter.prototype.onCancel.callCount).toStrictEqual(1);
    });
  });
