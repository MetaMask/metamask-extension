...
describe('hardware-wallet-signatures utils', () => {
  ...
  describe('getTitle', () => {
    it('returns submitted title', () => {
      ...
      ).toBe('hardwareWalletsHwAllSetTitle');
    });
    ...
    it('returns rejected title', () => {
      ...
      ).toBe('hardwareWalletsHwTransactionRejected');
    });
    ...
    it('returns disconnected title', () => {
      ...
      ).toBe('hardwareWalletsHwDeviceDisconnected');
    });
    ...
    it('returns almost there title when needs two confirmations and awaiting final', () => {
      ...
      ).toBe('hardwareWalletsHwAlmostThereTitle');
    });
  ...
  describe('getFinalStepLabel', () => {
    it('returns sent amount when submitted', () => {
      ...
      ).toBe('hardwareWalletsHwSentAmount[1.5,ETH]');
    });
    ...
    it('returns sending amount when active', () => {
      ...
      ).toBe('hardwareWalletsHwSendingAmount[1.5,ETH]');
    });
    ...
    it('returns send amount when pending', () => {
      ...
      ).toBe('hardwareWalletsHwSendAmount[1.5,ETH]');
    });
  });
  ...
  describe('getFirstStepDescription', () => {
    it('returns rejected text', () => {
      ...
      ).toBe('hardwareWalletsHwRejected');
    });
    ...
    it('returns reconnect text', () => {
      ...
      ).toBe('hardwareWalletsHwReconnectDevice');
    });
    ...
    it('returns spender address text', () => {
      ...
      ).toBe('hardwareWalletsHwSpender[0x12345...45678]');
    });
  ...
  describe('getFinalStepDescription', () => {
    it('returns to address text', () => {
      ...
      ).toBe('hardwareWalletsHwToAddress[0x12345...45678]');
    });
  ...
  describe('getQrHardwareSigningPageTitle', () => {
    it('returns the approval step title when awaiting the first signature', () => {
      ...
      ).toBe('hardwareWalletsQrHardwareSignStepTitle[2,4]');
    });
    ...
    it('returns the last step title when awaiting the final signature', () => {
      ...
      ).toBe('hardwareWalletsQrHardwareSignLastStepTitle');
    });
  });
