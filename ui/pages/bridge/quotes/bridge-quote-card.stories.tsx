...
const mockTokenFee = {};
export const GasIncluded = () => {
  return <BridgeQuotesModal onClose={() => {}} isOpen={true} />;
};
GasIncluded.decorators = [
  (story) => (
    <Provider
      store={configureStore(
        createBridgeMockStore({
          ...
          // TODO add gas included quote mock
          bridgeStateOverrides: {
            quotes: mockBridgeQuotesErc20Erc20.map((q) => ({
              ...q,
              quote: { ...q.quote, isGasIncluded: true }, // TODO remove when mock quotes are ready
            })),
          },
          metamaskStateOverrides: {
            currencyRates: {
