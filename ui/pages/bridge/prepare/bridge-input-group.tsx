...
import { BridgeAssetList } from './components/bridge-asset-picker/asset-list';
import { BridgeAssetPickerButton } from './components/bridge-asset-picker/trigger-button';
import { BridgeAssetPicker } from './components/bridge-asset-picker';
import { NetworkPicker } from './components/bridge-asset-picker/network-picker';
...
export const BridgeInputGroup = ({
  ...
  'header' | 'onAssetChange' | 'accountAddress'
> &
  Pick<React.ComponentProps<typeof NetworkPicker>, 'networks'> &
  Pick<React.ComponentProps<typeof BridgeAssetList>, 'excludedAssetId'>) => {
