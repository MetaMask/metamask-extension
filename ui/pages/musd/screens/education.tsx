...
import { RouteMessengerInstance } from './education/messenger';
...
const MusdEducationScreen: React.FC = () => {
  ...
  // `RouteMessengerContext.Provider`. Note that since we are in a non-shared
  // component we can pass a type parameter to narrow the type.
  //========
  ...
  const handleContinue = useCallback(async () => {
    ...
    await messenger.call(
      // @ts-expect-error This action is not actually defined on UIMessenger,
      // but we can certainly add it in the future.
