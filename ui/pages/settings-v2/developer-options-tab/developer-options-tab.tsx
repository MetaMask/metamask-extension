...
export const DEVELOPER_OPTIONS_SETTING_ITEMS: SettingItemConfig[] = [
  { id: 'show-fiat-in-testnets', titleKey: 'showFiatConversionInTestnets', component: ShowConversionInTestnetsItem },
  { id: 'auto-reset-account', titleKey: 'clearActivity', component: AutoResetAccountItem },
];
