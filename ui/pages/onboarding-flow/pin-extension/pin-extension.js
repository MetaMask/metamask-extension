...
function getBillboard(t) {
  return (
    <svg width="332" height="198" viewBox="0 0 332 198" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
      ...
      <text fill="white" xml:space="preserve" style="white-space: pre" font-family="Open Sans" font-size="12" font-weight="600" letter-spacing="0px"><tspan x="47" y="58.1553">{t('onboardingPinExtensionBillboardTitle')}</tspan></text>
      <text fill="white" xml:space="preserve" style="white-space: pre" font-family="Open Sans" font-size="10" font-weight="bold" letter-spacing="-0.4px"><tspan x="47" y="83.8794">{t('onboardingPinExtensionBillboardAccess')}</tspan></text>
      <text fill="white" xml:space="preserve" style="white-space: pre" font-family="Open Sans" font-size="9" font-weight="bold" letter-spacing="0px"><tspan x="73.1465" y="140.991">{t('appName')}</tspan></text>
      <text fill="white" xml:space="preserve" style="white-space: pre" font-family="Open Sans" font-size="10" letter-spacing="-0.3px"><tspan x="47" y="101.379">{t('onboardingPinExtensionBillboardDescription')}&#10;</tspan><tspan x="47" y="116.379">{t('onboardingPinExtensionBillboardDescription2')}</tspan></text>
