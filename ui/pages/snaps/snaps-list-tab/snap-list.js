...
const SnapList = () => {
  ...
  return (
    <div className="main-container snaps">
      <div className="snaps__header">
        <div className="snaps__header__title-container">
          <ButtonIcon
            ...
            ariaLabel="back"
          />
          <div className="snaps__header__title-container__title">
            {t('snaps')}
          </div>
        </div>
      </div>
