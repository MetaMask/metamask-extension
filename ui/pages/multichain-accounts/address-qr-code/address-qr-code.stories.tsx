...
EthereumAddressQR.parameters = {
  initialEntries: [`/address-qr-code/${MOCK_ETH_ACCOUNT.address}`],
  path: '/address-qr-code/:address',
}
...
SolanaAddressQR.parameters = {
  initialEntries: [`/address-qr-code/${MOCK_SOLANA_ACCOUNT.address}`],
  path: '/address-qr-code/:address',
}
