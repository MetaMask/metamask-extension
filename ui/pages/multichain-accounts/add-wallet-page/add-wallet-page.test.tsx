...
jest.mock("../../../components/multichain/import-account/import-account", () => ({
  ImportAccount: ({ onActionComplete }: { onActionComplete: (success?: boolean) => void }) => (
    <div>
      <button onClick={() => onActionComplete(true)}>Mock Import Success</button>
      <button onClick={() => onActionComplete(false)}>Mock Import Failure</button>
