...
const transformScripts = {
  '.js': 'node unflattenMetamaskCode.js',
  '.jsx': 'node unflattenMetamaskCode.js',
  '.ts': 'yarn ts-node unflattenMetamaskObject.ts',
  '.tsx': 'yarn ts-node unflattenMetamaskObject.ts',
};
