...
- [#8932](https://github.com/MetaMask/metamask-extension/pull/8932): Remove ramda (#8932)
- [#8628](https://github.com/MetaMask/metamask-extension/pull/8628): Use string network and chain IDs (#8628)
- [#8944](https://github.com/MetaMask/metamask-extension/pull/8944): Throw error upon currency update failure (#8944)
- [#8950](https://github.com/MetaMask/metamask-extension/pull/8950): Update material-ui/core (#8950)
...
- [#9025](https://github.com/MetaMask/metamask-extension/pull/9023): Catch gas estimate errors (#9025)
- [#9026](https://github.com/MetaMask/metamask-extension/pull/9023): Clear transactions on createNewVaultAndRestore (#9026)
