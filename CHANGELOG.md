...
## [12.22.0]
### Added
- bump semvar version to 12.22.0
- feat: add new multichain-accounts-list-menu (using new tree view) ([#33657](https://github.com/MetaMask/metamask-extension/pull/33657))
- feat: remove snap confirmation page from Swap/Bridge page ([#33778](https://github.com/MetaMask/metamask-extension/pull/33778))
- fix: handle Srp quiz words with non-unique words in confirm seed phrase ([#33781](https://github.com/MetaMask/metamask-extension/pull/33781))
- feat: indicate enforced simulations are active ([#33699](https://github.com/MetaMask/metamask-extension/pull/33699))
- refactor: adding comments to `OperationSafener` helpers; and other internal improvements to `OperationSafener` ([#33520](https://github.com/MetaMask/metamask-extension/pull/33520))
- fix: don't show onboarding header on popup mode ([#33771](https://github.com/MetaMask/metamask-extension/pull/33771))
- fix: setting correct metrics parameter for Future ETH ([#33585](https://github.com/MetaMask/metamask-extension/pull/33585))
- fix: cp-12.20.1 case where internal accounts can be undefined ([#33768](https://github.com/MetaMask/metamask-extension/pull/33768))
- feat: adds a hook to confirmation alerts for address trust signals ([#33671](https://github.com/MetaMask/metamask-extension/pull/33671))
- feat(deeplinks): install deep link feature with routes to home, swap, and notifications ([#33663](https://github.com/MetaMask/metamask-extension/pull/33663))
- fix: flaky test `Ledger Hardware unlocks multiple accounts at once and removes one` ([#33770](https://github.com/MetaMask/metamask-extension/pull/33770))
- fix: flaky test `Lock and unlock successfully unlocks after lock` ([#33763](https://github.com/MetaMask/metamask-extension/pull/33763))
- feat: trust signals for addresses on transactions and signatures ([#33670](https://github.com/MetaMask/metamask-extension/pull/33670))
- fix: onboarding flow fixes ([#33767](https://github.com/MetaMask/metamask-extension/pull/33767))
- feat: add berachain, edu, apechain logos ([#33587](https://github.com/MetaMask/metamask-extension/pull/33587))
- chore: Bump Snaps dependencies ([#33722](https://github.com/MetaMask/metamask-extension/pull/33722))
- chore: bitcoin to beta build ([#33680](https://github.com/MetaMask/metamask-extension/pull/33680))
- feat: form text field margin and helptext ([#33710](https://github.com/MetaMask/metamask-extension/pull/33710))
- feat(deeplinks): add deep link router ([#33660](https://github.com/MetaMask/metamask-extension/pull/33660))
- feat: replaced block explorer url link in view explorer menu item com… ([#33667](https://github.com/MetaMask/metamask-extension/pull/33667))
- test: Migrating snap pom ([#33593](https://github.com/MetaMask/metamask-extension/pull/33593))
- fix: flaky test `Migrate vault with old encryption` and `Forgot password` ([#33721](https://github.com/MetaMask/metamask-extension/pull/33721))
- fix: Display "Switch back" instead of "Switch" for smart accounts - extension  ([#33724](https://github.com/MetaMask/metamask-extension/pull/33724))
- fix: update identity event name ([#33749](https://github.com/MetaMask/metamask-extension/pull/33749))
- test: Migrate flask multichain-api e2e tests to Page object modal (part 1) ([#33723](https://github.com/MetaMask/metamask-extension/pull/33723))
- feat: 1.16 metametrics new flow ([#33380](https://github.com/MetaMask/metamask-extension/pull/33380))
- feat(deeplinks): allow `unlock` to navigate to the originally intended screen after unlock ([#33639](https://github.com/MetaMask/metamask-extension/pull/33639))
- feat: trust signals middleware settings toggle ([#33747](https://github.com/MetaMask/metamask-extension/pull/33747))
- refactor: split account-list-menu into account-menu re-usable component ([#33729](https://github.com/MetaMask/metamask-extension/pull/33729))
- feat: eth_requestAccounts dapp scanning ([#33627](https://github.com/MetaMask/metamask-extension/pull/33627))
- feat: 1.19 UI Changes in the Setting Security Tab and Backup SRP ([#33704](https://github.com/MetaMask/metamask-extension/pull/33704))
- feat: upgrade notification controller to use v2 endpoints ([#33564](https://github.com/MetaMask/metamask-extension/pull/33564))
- ci(workflow): Ignore lavamoat policy files in `check-pr-max-lines` workflow ([#33706](https://github.com/MetaMask/metamask-extension/pull/33706))
- feat(identity): sync address book contacts ([#32632](https://github.com/MetaMask/metamask-extension/pull/32632))
- feat: enforce simulation hook ([#33531](https://github.com/MetaMask/metamask-extension/pull/33531))
- fix: fix missing notification services controller selectors ([#33708](https://github.com/MetaMask/metamask-extension/pull/33708))
- fix: flaky test 'Custom RPC history deletes a custom RPC' ([#33730](https://github.com/MetaMask/metamask-extension/pull/33730))
- feat: Display amount of nested transaction in a batch confirmation ([#33558](https://github.com/MetaMask/metamask-extension/pull/33558))
- feat: new users to be opted in for smart account by default ([#33548](https://github.com/MetaMask/metamask-extension/pull/33548))
- test: fix flaky "Preinstalled example Snap can display the Snap settings page" ([#33717](https://github.com/MetaMask/metamask-extension/pull/33717))
- feat: Switch account option should not be available for hardware wallet account ([#33569](https://github.com/MetaMask/metamask-extension/pull/33569))
- feat: 1.18 update with metamask password ui ([#33695](https://github.com/MetaMask/metamask-extension/pull/33695))
- feat: 1.17 srp flow fixes ([#33677](https://github.com/MetaMask/metamask-extension/pull/33677))
- fix: ensure safe nft URI fetch ([#33700](https://github.com/MetaMask/metamask-extension/pull/33700))
- ci: attribute change to +x `validate-changelog-in-rc.sh` ([#33709](https://github.com/MetaMask/metamask-extension/pull/33709))
- fix: flaky tests `Gas Fee Tokens - EIP-7702` ([#33694](https://github.com/MetaMask/metamask-extension/pull/33694))
- release: Master sync v12.20.0 into main ([#33664](https://github.com/MetaMask/metamask-extension/pull/33664))
- Merge branch 'main' into master-sync
- ci: overnight cron job ([#33682](https://github.com/MetaMask/metamask-extension/pull/33682))
- fix: `clipboardRead` permission request in Firefox ([#33701](https://github.com/MetaMask/metamask-extension/pull/33701))
- feat: bitcoin snap bump 0.15.0 ([#33662](https://github.com/MetaMask/metamask-extension/pull/33662))
- build: bump `@metamask/assets-controllers@68.2.0` ([#33654](https://github.com/MetaMask/metamask-extension/pull/33654))
- feat: enable backup & sync for all users ([#33551](https://github.com/MetaMask/metamask-extension/pull/33551))
- fix: missing property policies for firebase push notifications ([#33665](https://github.com/MetaMask/metamask-extension/pull/33665))
- feat: Adding details about alternateGasFees in wallet_getCapabilities ([#33533](https://github.com/MetaMask/metamask-extension/pull/33533))
- ci: add `bump` and `release` to conventional commit types ([#33672](https://github.com/MetaMask/metamask-extension/pull/33672))
- feat: 1.15 social flow header and unlock page ([#33360](https://github.com/MetaMask/metamask-extension/pull/33360))
- fix: add assets traces ([#33611](https://github.com/MetaMask/metamask-extension/pull/33611))
- Merge origin/main into master-sync
- feat: 1.14 social flow account not found ([#33359](https://github.com/MetaMask/metamask-extension/pull/33359))
- fix: comma in publish-prerelease ([#33666](https://github.com/MetaMask/metamask-extension/pull/33666))
- fix: Solana network position ([#33644](https://github.com/MetaMask/metamask-extension/pull/33644))
- chore: Make accounts code owners more specific ([#33651](https://github.com/MetaMask/metamask-extension/pull/33651))
- test: fix timeout type for `Driver.waitForUrl` ([#33643](https://github.com/MetaMask/metamask-extension/pull/33643))
- fix: enable multichain API connections in MV2 (webpack) builds ([#33640](https://github.com/MetaMask/metamask-extension/pull/33640))
- feat: 1.13 add social flow account exist ([#33298](https://github.com/MetaMask/metamask-extension/pull/33298))
- fix: prevent the possibility of a future prototype pollution vulnerability on `PATH_NAME_MAP` in `routes.ts` ([#33638](https://github.com/MetaMask/metamask-extension/pull/33638))
- build: bump `@metamask/notification-services-controller@10.0.0` ([#33648](https://github.com/MetaMask/metamask-extension/pull/33648))
- feat: Add multichain account tree component ([#33647](https://github.com/MetaMask/metamask-extension/pull/33647))
- fix: Fix cronjob controller migration for state without `events` ([#33652](https://github.com/MetaMask/metamask-extension/pull/33652))
- chore: cp-12.21.0 bump solana 1.33.1 ([#33649](https://github.com/MetaMask/metamask-extension/pull/33649))
- fix: flaky test Vault Decrypt uploading the log file in the vault-decryptor webapp ([#33646](https://github.com/MetaMask/metamask-extension/pull/33646))
- feat: 1.12 new srp import UI ([#33297](https://github.com/MetaMask/metamask-extension/pull/33297))
- feat: MMS-2553 unified UI for swaps and bridges ([#33487](https://github.com/MetaMask/metamask-extension/pull/33487))
- feat: 1.11 New SRP review and confirm UI ([#33289](https://github.com/MetaMask/metamask-extension/pull/33289))
- fix: Update legacy button to match DS button styles ([#33109](https://github.com/MetaMask/metamask-extension/pull/33109))
- fix(snaps): Adjust `SnapUIAccountSelector` height ([#33514](https://github.com/MetaMask/metamask-extension/pull/33514))
- style: fix `global.platform` type ([#33632](https://github.com/MetaMask/metamask-extension/pull/33632))
- docs: update link to MetaMask CLA ([#30940](https://github.com/MetaMask/metamask-extension/pull/30940))
- refactor: set return type of `getState` to `MetaMaskReduxState` ([#33642](https://github.com/MetaMask/metamask-extension/pull/33642))
- test: embed favicon in "E2E Test Page" to reduce calls and request noise in tests ([#33637](https://github.com/MetaMask/metamask-extension/pull/33637))
- test: fix type in `driver` test helper ([#33636](https://github.com/MetaMask/metamask-extension/pull/33636))
- fix: remove warning from console due to duplicate key in security tab ([#33635](https://github.com/MetaMask/metamask-extension/pull/33635))
- feat: base account details ([#33277](https://github.com/MetaMask/metamask-extension/pull/33277))
- test: remove some entries from the mock allow list (part 6) ([#33600](https://github.com/MetaMask/metamask-extension/pull/33600))
- fix: flaky test `Swap should swap ETH to WETH` ([#33628](https://github.com/MetaMask/metamask-extension/pull/33628))
- test: Migrate bitcoin e2e tests to Typescript and Page object modal  ([#33595](https://github.com/MetaMask/metamask-extension/pull/33595))
- ci: update release artifacts creation ([#33601](https://github.com/MetaMask/metamask-extension/pull/33601))
- fix: use uncached fetch requests for bridge quotes, statuses and prices ([#33574](https://github.com/MetaMask/metamask-extension/pull/33574))
- fix: skip topAssets request when chainId is Solana ([#33570](https://github.com/MetaMask/metamask-extension/pull/33570))
- chore: Update codeowners for onboarding ([#33617](https://github.com/MetaMask/metamask-extension/pull/33617))
- fix: include gas limit and gas fees in simulation requests ([#33602](https://github.com/MetaMask/metamask-extension/pull/33602))
- feat: Add selector for Multichain Accounts ([#33606](https://github.com/MetaMask/metamask-extension/pull/33606))
- feat: enable base network by default ([#33448](https://github.com/MetaMask/metamask-extension/pull/33448))
- chore: use the new `@metamask/foundryup` package ([#33463](https://github.com/MetaMask/metamask-extension/pull/33463))
- fix: address clipboard rendering issue ([#33588](https://github.com/MetaMask/metamask-extension/pull/33588))
- chore: Bump Snaps packages ([#33559](https://github.com/MetaMask/metamask-extension/pull/33559))
- fix: fix "Terms of Use"'s `Approve` button enablement on screens with sub-pixel scaling/scrolling ([#33605](https://github.com/MetaMask/metamask-extension/pull/33605))
- feat: improve multi-srp account syncing flow ([#33603](https://github.com/MetaMask/metamask-extension/pull/33603))
- test: re-enable previously flaky Solana Wallet Standard E2E ([#33568](https://github.com/MetaMask/metamask-extension/pull/33568))
- fix: pass safeChains prop from parent components to TokenCell cp-12.20.0 ([#33579](https://github.com/MetaMask/metamask-extension/pull/33579))
- feat: Add provisional Ocap Kernel integration ([#33545](https://github.com/MetaMask/metamask-extension/pull/33545))
- chore: Update code owners for accounts components  ([#33598](https://github.com/MetaMask/metamask-extension/pull/33598))
- feat: Integrate enabled network map (functionality) ([#33478](https://github.com/MetaMask/metamask-extension/pull/33478))
- fix: reduce chains.json fetches by moving hook to AssetList cp-12.20.0 ([#33577](https://github.com/MetaMask/metamask-extension/pull/33577))
- feat: trust signals verifying contract ([#33573](https://github.com/MetaMask/metamask-extension/pull/33573))
- fix: flaky test `Vault Corruption` on loading restore page ([#33591](https://github.com/MetaMask/metamask-extension/pull/33591))
- fix: cp-12.20.0 Fix scuttling error for `getSelection` ([#33576](https://github.com/MetaMask/metamask-extension/pull/33576))
- test: add monad and megaeth regression tests ([#33222](https://github.com/MetaMask/metamask-extension/pull/33222))
- feat: 1.10 New pin extension UI ([#33288](https://github.com/MetaMask/metamask-extension/pull/33288))
- test: remove some entries from the mock allow list (part 5) ([#33583](https://github.com/MetaMask/metamask-extension/pull/33583))
- test: Migrate eth-sign e2e test to Typescript and Page object modal ([#33549](https://github.com/MetaMask/metamask-extension/pull/33549))
- test: Migrate responsive-ui e2e tests to Typescript and Page object modal  ([#33561](https://github.com/MetaMask/metamask-extension/pull/33561))
- feat: add multi-SRP EVM Account Syncing ([#32951](https://github.com/MetaMask/metamask-extension/pull/32951))
- chore: cp-12.20.0 bump solana-wallet-standard to 0.5.0 & multichain-api-client to 0.6.2 ([#33572](https://github.com/MetaMask/metamask-extension/pull/33572))
- ci: use `yarn-custom-url` ([#33562](https://github.com/MetaMask/metamask-extension/pull/33562))
- refactor(react-router): asset-list-control-bar.tsx ([#33384](https://github.com/MetaMask/metamask-extension/pull/33384))
- feat: Add update to Account List Item SRP pill logic ([#33544](https://github.com/MetaMask/metamask-extension/pull/33544))
- feat: Add `--features` option to legacy build system CLI ([#33485](https://github.com/MetaMask/metamask-extension/pull/33485))
- chore: use `wallet_createSession` from `@metamask/multichain-api-middleware` ([#33511](https://github.com/MetaMask/metamask-extension/pull/33511))
- feat: 1.9 Updated creation successful page UI ([#33287](https://github.com/MetaMask/metamask-extension/pull/33287))
- refactor: Remove extraneous code fence ([#33546](https://github.com/MetaMask/metamask-extension/pull/33546))
- feat: 1.8 Onboarding metametrics locales and UI change ([#33286](https://github.com/MetaMask/metamask-extension/pull/33286))
- feat: pass trackEvent to DeFiPositionsController ([#33471](https://github.com/MetaMask/metamask-extension/pull/33471))
- test: remove some entries from the mock allow list (part 4) ([#33521](https://github.com/MetaMask/metamask-extension/pull/33521))
- fix: allow all bitcoin account types ([#33516](https://github.com/MetaMask/metamask-extension/pull/33516))
- feat: added solana swaps e2e and fix solana flakiness ([#33098](https://github.com/MetaMask/metamask-extension/pull/33098))
- test: Migrate network e2e tests to Typescript and Page object modal (part 4) ([#33534](https://github.com/MetaMask/metamask-extension/pull/33534))
- chore: bump test dapp multichain package and respective util updates ([#33541](https://github.com/MetaMask/metamask-extension/pull/33541))
- feat: 1.7 update secure your wallet page UI ([#33285](https://github.com/MetaMask/metamask-extension/pull/33285))
- feat: detect updates and prompt restart ([#33381](https://github.com/MetaMask/metamask-extension/pull/33381))
- feat: add `AccountTreeController` ([#33499](https://github.com/MetaMask/metamask-extension/pull/33499))
- feat: trust signals middleware ([#33321](https://github.com/MetaMask/metamask-extension/pull/33321))
- feat: 1.6 srp flow srp detail modal ([#33281](https://github.com/MetaMask/metamask-extension/pull/33281))
- feat: added basic functionality banner ([#33095](https://github.com/MetaMask/metamask-extension/pull/33095))
- feat: 1.5 New create password design ([#33263](https://github.com/MetaMask/metamask-extension/pull/33263))
- ci: fix Crowdin translations workflow ([#33519](https://github.com/MetaMask/metamask-extension/pull/33519))
- refactor: make it possible to reload the extension only after all pending database writes have completed ([#33486](https://github.com/MetaMask/metamask-extension/pull/33486))
- refactor: reorganize code related to restoring vault corruption ([#33216](https://github.com/MetaMask/metamask-extension/pull/33216))
- chore: Add sophon logo ([#33506](https://github.com/MetaMask/metamask-extension/pull/33506))
- test: remove some entries from the mock allow list (part 3) ([#33358](https://github.com/MetaMask/metamask-extension/pull/33358))
- test: Added test scenario for unlock wallet ([#33352](https://github.com/MetaMask/metamask-extension/pull/33352))
- test: add `withLedgerAccount` fixture ([#33489](https://github.com/MetaMask/metamask-extension/pull/33489))
- chore: Remove additional dead Snaps code ([#30131](https://github.com/MetaMask/metamask-extension/pull/30131))
...
- feat: 1.4 New welcome page header design and password form component ([#33262](https://github.com/MetaMask/metamask-extension/pull/33262))
- feat: 1.3 New srp flow welcome page ([#33261](https://github.com/MetaMask/metamask-extension/pull/33261))
- chore: bridge state controller not found ([#33482](https://github.com/MetaMask/metamask-extension/pull/33482))
- docs: Fix some webpack CLI option descriptions ([#33503](https://github.com/MetaMask/metamask-extension/pull/33503))
...
- chore: delete dead code for advanced-gas-inputs ([#33458](https://github.com/MetaMask/metamask-extension/pull/33458))
...
- chore: swap to ecr-pub e2e image ([#33477](https://github.com/MetaMask/metamask-extension/pull/33477))
...
- feat: add tracing to multi srp features ([#31354](https://github.com/MetaMask/metamask-extension/pull/31354))
...
- test: remove some entries from the mock allow list (part 2) ([#33302](https://github.com/MetaMask/metamask-extension/pull/33302))
- feat: bitcoin integration improvements ([#33402](https://github.com/MetaMask/metamask-extension/pull/33402))
- fix: flaky test `Test Snap Management tests install disable enable and removal of a snap` ([#33492](https://github.com/MetaMask/metamask-extension/pull/33492))
...
- test: Migrate network e2e tests to Typescript and Page object modal (part 3) ([#33474](https://github.com/MetaMask/metamask-extension/pull/33474))
- fix: flaky test `Vault Corruption` on wait to disappear scroll button ([#33493](https://github.com/MetaMask/metamask-extension/pull/33493))
- chore: update genesys network logo ([#33468](https://github.com/MetaMask/metamask-extension/pull/33468))
- test: add send EIP1559 and send legacy in the mocked bridge for Ledger accounts ([#33228](https://github.com/MetaMask/metamask-extension/pull/33228))
- feat: New SRP flow Terms of use ([#33260](https://github.com/MetaMask/metamask-extension/pull/33260))
- chore: Update build system comment about transpiled dependencies ([#33464](https://github.com/MetaMask/metamask-extension/pull/33464))
- chore: explicitly pass network client id for nft flow ([#31917](https://github.com/MetaMask/metamask-extension/pull/31917))
- chore: refactor main action buttons ([#32963](https://github.com/MetaMask/metamask-extension/pull/32963))
- refactor: use promises for handling `onInstalled`; replace `deferredPromise` with `Promise.withResolvers` ([#31586](https://github.com/MetaMask/metamask-extension/pull/31586))
- feat: updated Account selector in header ([#32404](https://github.com/MetaMask/metamask-extension/pull/32404))
- chore: Master sync V12.18.2 & V12.18.3 ([#33449](https://github.com/MetaMask/metamask-extension/pull/33449))
- Merge origin/main into master-sync
- test: fix stx opt-in opt-out fixture ([#33264](https://github.com/MetaMask/metamask-extension/pull/33264))
- test: Fix flaky signatures e2e ([#33389](https://github.com/MetaMask/metamask-extension/pull/33389))
...
- ci: Fix Crowdin workflow ([#33320](https://github.com/MetaMask/metamask-extension/pull/33320))
- test: fix flaky test `Carousel component e2e tests should display correct slides with expected content` ([#33362](https://github.com/MetaMask/metamask-extension/pull/33362))
- fix: update op logo ([#33399](https://github.com/MetaMask/metamask-extension/pull/33399))
- fix: flaky test `Request-queue UI changes should show network specific to domain` ([#33284](https://github.com/MetaMask/metamask-extension/pull/33284))
...
- ci: fix stale bot action ([#33394](https://github.com/MetaMask/metamask-extension/pull/33394))
- test: adds onboarding metrics validation to e2e ([#33058](https://github.com/MetaMask/metamask-extension/pull/33058))
- feat: SRP and onboarding flow assets ([#33257](https://github.com/MetaMask/metamask-extension/pull/33257))
...
- fix: log migration error ([#33315](https://github.com/MetaMask/metamask-extension/pull/33315))
...
- New Crowdin translations by Github Action ([#31727](https://github.com/MetaMask/metamask-extension/pull/31727))
...
- feat: E2E tests for Discover button for Linea dApp ([#32968](https://github.com/MetaMask/metamask-extension/pull/32968))
...
- chore: silence Circle ci config failure ([#33291](https://github.com/MetaMask/metamask-extension/pull/33291))
- chore: bump phishing-warning to 5.0.0 ([#33252](https://github.com/MetaMask/metamask-extension/pull/33252))
- test: remove some entries from the mock allow list (part 1) ([#33267](https://github.com/MetaMask/metamask-extension/pull/33267))
...
- chore: retry zstd installation ([#33278](https://github.com/MetaMask/metamask-extension/pull/33278))
...
- feat: migrate builds to gha ([#32980](https://github.com/MetaMask/metamask-extension/pull/32980))
- chore: add remote feature flag for multichain accounts ([#33112](https://github.com/MetaMask/metamask-extension/pull/33112))
- feat: Add UI UX updates to account list item ([#33158](https://github.com/MetaMask/metamask-extension/pull/33158))
- chore: remove unused `CONNECTION_READY` event ([#33163](https://github.com/MetaMask/metamask-extension/pull/33163))
- chore: fix typo in cookie streams file: "phishing" -> "cookie" ([#33147](https://github.com/MetaMask/metamask-extension/pull/33147))
...
- fix: open import srp in popup instead of a new window cp-12.20.0 ([#33219](https://github.com/MetaMask/metamask-extension/pull/33219))
- fix: cp-12.20.0 update critical message about not backing up SRP ([#33225](https://github.com/MetaMask/metamask-extension/pull/33225))
- refactor: move translation related functions to `shared` ([#33217](https://github.com/MetaMask/metamask-extension/pull/33217))
- chore: Remove MMI build ([#33205](https://github.com/MetaMask/metamask-extension/pull/33205))
- fix: cp-12.18.2 bump solana to v1.31.1 ([#33210](https://github.com/MetaMask/metamask-extension/pull/33210))
- chore: remove NoOp lockdown props ([#33164](https://github.com/MetaMask/metamask-extension/pull/33164))
...
- perf(snaps): Improve `useSnapAssetDisplay` performance ([#33138](https://github.com/MetaMask/metamask-extension/pull/33138))
...
- chore: upgrade-assets-controllers-v65 ([#32467](https://github.com/MetaMask/metamask-extension/pull/32467))
...
- fix: Update PR max lines limit to ignore test snapshots ([#33173](https://github.com/MetaMask/metamask-extension/pull/33173))
- test: refactor `waitUntil` for more precise timing ([#33126](https://github.com/MetaMask/metamask-extension/pull/33126))
...
- feat: Update codeowner announcement ([#31378](https://github.com/MetaMask/metamask-extension/pull/31378))
- chore: preemptively update CODEOWNERs for multichain-accounts ([#33113](https://github.com/MetaMask/metamask-extension/pull/33113))
...
- chore: bump BridgeController and BridgeStatus controller ([#33061](https://github.com/MetaMask/metamask-extension/pull/33061))
- chore: Remove MMI build flags ([#33084](https://github.com/MetaMask/metamask-extension/pull/33084))
- fix: EIP-7702 method metrics ([#33143](https://github.com/MetaMask/metamask-extension/pull/33143))
- chore: Master sync V12.18.1 ([#33141](https://github.com/MetaMask/metamask-extension/pull/33141))
- Merge origin/main into master-sync
...
[Unreleased]: https://github.com/MetaMask/metamask-extension/compare/v12.22.0...HEAD
[12.22.0]: https://github.com/MetaMask/metamask-extension/compare/v12.21.0...v12.22.0
