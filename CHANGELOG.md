...
- chore: remove unified swaps legacy and portfolio fallbacks (#34290)
- chore: update fee label when gas is include in swap rate (#34146)
- chore: add token address to error (#34180)
- chore: bump snaps packages (#34173)
- chore: add tailwind intellisense to suggest plugins in vscode settings (#34155)
- chore: smart transactions refactoring (#34049)
- chore: remove standard codeql workflow (#33870)
- refactor(identity): lighter backup-and-sync e2e test suite (#34206)
- refactor: update ui's background communications to use a single notification listener instead of two (#33211)
...
- fix: bump @metamask/solana-wallet-standard to 0.5.1 (#34281)
- fix: prevent swap between native assets cp-12.23.0 (#34257)
- fix: add changes to multichain accounts ui (#34190)
- fix: show avatar account on all screens except header (#34273)
- fix: fix contact case (#34234)
- fix: update button colors and header styling (#34209)
- fix: log warning instead of capture exception in migration 165 (#34269)
- fix: bump @metamask/profile-sync-controller to ^21.0.0 (#34032)
- fix: set confirm srp quiz word to readonly cp-12.23.0 (#34225)
- fix: resume metametrics if not set yet when close/open app during onboarding cp-12.23.0 (#34177)
- fix: use primary and secondary variants cp-12.23.0 (#34230)
...
- fix: fix migration to be cherry-pick into version 12.23.0 (#34228)
