...
- chore: Sync `master` with `main`, `v12.14.1` -> `v12.14.2` ([#31364](https://github.com/MetaMask/metamask-extension/pull/31364))
- Merge origin/main into master-sync
- test: Add e2e coverage for snaps expanded view notifications ([#31127](https://github.com/MetaMask/metamask-extension/pull/31127))
- ci: move benchmarks and bundle-size to GHA ([#30480](https://github.com/MetaMask/metamask-extension/pull/30480))
- chore: Bump Snaps dependencies ([#31270](https://github.com/MetaMask/metamask-extension/pull/31270))
- style: Update NFT network badge styling ([#30888](https://github.com/MetaMask/metamask-extension/pull/30888))
- style: Update styling of placeholder text and image for empty NFT tab ([#30892](https://github.com/MetaMask/metamask-extension/pull/30892))
- feat(multi-srp): Add metrics events for SRP interactions ([#31248](https://github.com/MetaMask/metamask-extension/pull/31248))
- fix(import-srp): clear error when flipping between 12 and 24 words ([#31273](https://github.com/MetaMask/metamask-extension/pull/31273))
- feat(multi-srp): add hd_entropy_index to segment events ([#30382](https://github.com/MetaMask/metamask-extension/pull/30382))
- style: Update text color in Unlock Page ([#30890](https://github.com/MetaMask/metamask-extension/pull/30890))
- test: set anvil as default ([#30709](https://github.com/MetaMask/metamask-extension/pull/30709))
- chore: bump `axios` to `^1.8.2` ([#30904](https://github.com/MetaMask/metamask-extension/pull/30904))
- test: Bridge e2e automated tests ([#29769](https://github.com/MetaMask/metamask-extension/pull/29769))
- chore: add bitcoin and watch only to settings search ([#31257](https://github.com/MetaMask/metamask-extension/pull/31257))
- ci: e2e firefox ([#30928](https://github.com/MetaMask/metamask-extension/pull/30928))
- chore: adds solana FF check ([#31286](https://github.com/MetaMask/metamask-extension/pull/31286))
- chore: remove circle ci scripts associated with release PR creation ([#31170](https://github.com/MetaMask/metamask-extension/pull/31170))
- chore: disable buttons for non-evm account ([#31193](https://github.com/MetaMask/metamask-extension/pull/31193))
- chore: Updating package: @metamask/transaction-controller ([#30961](https://github.com/MetaMask/metamask-extension/pull/30961))
- fix(30064): patch by adding addAccounts to @keystonehq-metamask-airgapped-keyring and return only added accounts ([#31130](https://github.com/MetaMask/metamask-extension/pull/31130))
- build: remove snaps-keyring + mm controller circular dep ([#31241](https://github.com/MetaMask/metamask-extension/pull/31241))
- refactor: introduce `useAsyncCallback` and simplify `useAsyncResult` ([#30538](https://github.com/MetaMask/metamask-extension/pull/30538))
- test: add catch all mock and temporary allowlist ([#26647](https://github.com/MetaMask/metamask-extension/pull/26647))
- test: add Swap with state missing mock ([#31226](https://github.com/MetaMask/metamask-extension/pull/31226))
- chore: update solna version ([#31198](https://github.com/MetaMask/metamask-extension/pull/31198))
- build: update Node and Yarn ([#30767](https://github.com/MetaMask/metamask-extension/pull/30767))
- ci: migrate chrome e2e from circleci to gha (soft launch) ([#30720](https://github.com/MetaMask/metamask-extension/pull/30720))
- test: swap WETH to ETH with state ([#30896](https://github.com/MetaMask/metamask-extension/pull/30896))
- feat(28786): Create an error message to prevent users from connecting multiple Ledger devices ([#31010](https://github.com/MetaMask/metamask-extension/pull/31010))
- fix(#14716): fix send invalid hex data ([#14716](https://github.com/MetaMask/metamask-extension/pull/14716))
- chore: Swap blockstream for mempool.space as Bitcoin block explorer ([#31134](https://github.com/MetaMask/metamask-extension/pull/31134))
- style: Update styling of banner ([#30887](https://github.com/MetaMask/metamask-extension/pull/30887))
- chore: Sync `master` with `main`, `v12.14.0` -> `v12.14.1` ([#31163](https://github.com/MetaMask/metamask-extension/pull/31163))
- Merge origin/main into master-sync
- Merge remote-tracking branch 'origin/main' into master-sync
- chore: Fix bundle size job ([#30817](https://github.com/MetaMask/metamask-extension/pull/30817))
- chore: Disable CSP test ([#31122](https://github.com/MetaMask/metamask-extension/pull/31122))
- chore: updates multichain tx controller package ([#31103](https://github.com/MetaMask/metamask-extension/pull/31103))
- chore: Sync `main` with `master`, `v12.13.1` -> `v12.14.0` ([#31096](https://github.com/MetaMask/metamask-extension/pull/31096))
- chore: Revert "chore: sync `main` with `master`, v12.13.1 -> v12.14.0" ([#31095](https://github.com/MetaMask/metamask-extension/pull/31095))
- chore: sync `main` with `master`, v12.13.1 -> v12.14.0 ([#31013](https://github.com/MetaMask/metamask-extension/pull/31013))
- test: e2e and integrations tests for import wallet metrics ([#30363](https://github.com/MetaMask/metamask-extension/pull/30363))
- test: Swap playwright script fix ([#30978](https://github.com/MetaMask/metamask-extension/pull/30978))
- chore: updates dependencies ([#31036](https://github.com/MetaMask/metamask-extension/pull/31036))
- chore: add `yarnrc.yml` to `extension-platform` codeowners ([#31035](https://github.com/MetaMask/metamask-extension/pull/31035))
- test: Migrating snaps test to POM ([#30312](https://github.com/MetaMask/metamask-extension/pull/30312))
- Merge origin/main into master-sync
- chore: bump test-dapp to v9.1.0 ([#30987](https://github.com/MetaMask/metamask-extension/pull/30987))
- chore: bump @metamask/profile-sync-controller to version ^10.0.0 ([#31003](https://github.com/MetaMask/metamask-extension/pull/31003))
- chore: Bump Snaps packages ([#30966](https://github.com/MetaMask/metamask-extension/pull/30966))
- test: removing unnecessary ganacheOptions in specs ([#30993](https://github.com/MetaMask/metamask-extension/pull/30993))
...
- feat: Added Sweepstake banner ([#31246](https://github.com/MetaMask/metamask-extension/pull/31246))
- feat: select gas fee token ([#31259](https://github.com/MetaMask/metamask-extension/pull/31259))
- feat: add gas fee token modal ([#31218](https://github.com/MetaMask/metamask-extension/pull/31218))
- feat: added missing mocks for solana devnet ([#31331](https://github.com/MetaMask/metamask-extension/pull/31331))
- feat: add discover button to portfolio discover network page ([#30777](https://github.com/MetaMask/metamask-extension/pull/30777))
- feat: clean up identity hooks ([#31290](https://github.com/MetaMask/metamask-extension/pull/31290))
- feat: upgrade to brand evolution colors ([#31256](https://github.com/MetaMask/metamask-extension/pull/31256))
- feat: solana explorer to solscan ([#31276](https://github.com/MetaMask/metamask-extension/pull/31276))
- feat: Remove petnames settings toggle ([#31207](https://github.com/MetaMask/metamask-extension/pull/31207))
- feat: enable account syncing for MV2 ([#31141](https://github.com/MetaMask/metamask-extension/pull/31141))
- feat: Confirmation code selector changes ([#31195](https://github.com/MetaMask/metamask-extension/pull/31195))
- feat: bump notification services controllers ([#31143](https://github.com/MetaMask/metamask-extension/pull/31143))
- feat: Add CreateSnapAccount component ([#30611](https://github.com/MetaMask/metamask-extension/pull/30611))
- feat: bump assets-controllers to v55.0.1 and add PV to NFT tab ([#30903](https://github.com/MetaMask/metamask-extension/pull/30903))
- feat: account tag enhancement & uppercase for OneKey labels ([#29999](https://github.com/MetaMask/metamask-extension/pull/29999))
- feat: Show rending confirmation alert on permission page when switching network ([#30725](https://github.com/MetaMask/metamask-extension/pull/30725))
- feat: add reveal srp ([#30641](https://github.com/MetaMask/metamask-extension/pull/30641))
- feat: Resimulate transactions for every 3 seconds on focused MM window ([#29878](https://github.com/MetaMask/metamask-extension/pull/29878))
- feat: allows pasting external addresses for crosschain bridges ([#30995](https://github.com/MetaMask/metamask-extension/pull/30995))
- feat: Add Linea to Smart Transaction supported chains ([#30999](https://github.com/MetaMask/metamask-extension/pull/30999))
- feat: new tx list filter ([#28180](https://github.com/MetaMask/metamask-extension/pull/28180))
- feat: update import SRP UI ([#31098](https://github.com/MetaMask/metamask-extension/pull/31098))
- feat: enable account syncing for MV2 ([#31102](https://github.com/MetaMask/metamask-extension/pull/31102))
- feat: Fix plan 835 Hid request dialog keep on prompting up during pagination. ([#30384](https://github.com/MetaMask/metamask-extension/pull/30384))
- feat: add atomic batch metrics ([#31031](https://github.com/MetaMask/metamask-extension/pull/31031))
- feat: Update blockaid friction modal copy ([#30809](https://github.com/MetaMask/metamask-extension/pull/30809))
- feat: reject pending confirmations for origin when permissions are revoked for it ([#31074](https://github.com/MetaMask/metamask-extension/pull/31074))
- feat: SIWE default to expanded on open ([#31001](https://github.com/MetaMask/metamask-extension/pull/31001))
- feat: update solana version ([#31075](https://github.com/MetaMask/metamask-extension/pull/31075))
- feat: add EIP-7702 revoke flow ([#30969](https://github.com/MetaMask/metamask-extension/pull/30969))
- feat: support updated EIP-5792 specification ([#30967](https://github.com/MetaMask/metamask-extension/pull/30967))
...
- fix: Anvil running on Windows ([#31345](https://github.com/MetaMask/metamask-extension/pull/31345))
- fix: lodash escape on test title ([#31344](https://github.com/MetaMask/metamask-extension/pull/31344))
- fix: remove use of hideTokenTransactions from asset page ([#31352](https://github.com/MetaMask/metamask-extension/pull/31352))
- fix: broken test in firefox `Bridge tests Execute various bridge transactions` ([#31348](https://github.com/MetaMask/metamask-extension/pull/31348))
- fix: show swap header on reopen ([#31309](https://github.com/MetaMask/metamask-extension/pull/31309))
- fix: srp back reminder for multichain ([#31139](https://github.com/MetaMask/metamask-extension/pull/31139))
- fix: (MMS-2142) label fix, adds external account ens support ([#31294](https://github.com/MetaMask/metamask-extension/pull/31294))
- fix: validate EIP-5792 requests using PPOM ([#31231](https://github.com/MetaMask/metamask-extension/pull/31231))
- fix: (MMS-2140) scrollbar and label issue ([#31213](https://github.com/MetaMask/metamask-extension/pull/31213))
- fix: bump `@metamask/keyring-controller` to `^21.0.1` ([#31274](https://github.com/MetaMask/metamask-extension/pull/31274))
- fix: Fall back to regular transaction submit for legacy transactions ([#31280](https://github.com/MetaMask/metamask-extension/pull/31280))
- fix: trigger incoming transaction polling only if user has transaction polling enabled for some network ([#31288](https://github.com/MetaMask/metamask-extension/pull/31288))
- fix: `gasLimit` normalization related e2e test changes ([#30931](https://github.com/MetaMask/metamask-extension/pull/30931))
- fix: Use same address shortening logic when resolving domains ([#31282](https://github.com/MetaMask/metamask-extension/pull/31282))
- fix: fix e2e test ([#31272](https://github.com/MetaMask/metamask-extension/pull/31272))
- fix: show correct notification accounts ([#31251](https://github.com/MetaMask/metamask-extension/pull/31251))
- fix: import srp input validation ([#31268](https://github.com/MetaMask/metamask-extension/pull/31268))
- fix: error handling in import srp and import private key ([#31249](https://github.com/MetaMask/metamask-extension/pull/31249))
- fix: type-4 gas estimation ([#31250](https://github.com/MetaMask/metamask-extension/pull/31250))
- fix: 31004 upgrade @metamask/eth-ledger-bridge-keyring library to fix the sign transaction issue. ([#31109](https://github.com/MetaMask/metamask-extension/pull/31109))
- fix: remove string from Solana text ([#31191](https://github.com/MetaMask/metamask-extension/pull/31191))
- fix: mms-2135 is isBridgning with the correct network ([#31211](https://github.com/MetaMask/metamask-extension/pull/31211))
- fix: Convert network configuration chain IDs in state to hex strings ([#31021](https://github.com/MetaMask/metamask-extension/pull/31021))
- fix: Update higher-order-components callbacks per react-perf's warnings ([#31022](https://github.com/MetaMask/metamask-extension/pull/31022))
- fix: #4296 - Prevent button from toggling the password when clicked off ([#31124](https://github.com/MetaMask/metamask-extension/pull/31124))
- fix: #30215 - Fix tab color accessibility ([#31212](https://github.com/MetaMask/metamask-extension/pull/31212))
- fix: map keyring transaction statuses ([#31205](https://github.com/MetaMask/metamask-extension/pull/31205))
- fix: truncate long NFT ids ([#31197](https://github.com/MetaMask/metamask-extension/pull/31197))
- fix: Vertically align key-value pair for Network fee ([#31194](https://github.com/MetaMask/metamask-extension/pull/31194))
- fix: Add Shape logo ([#30336](https://github.com/MetaMask/metamask-extension/pull/30336))
- fix: remove obsolete `{AppState,Nft,Preferences}Controller` state properties ([#31160](https://github.com/MetaMask/metamask-extension/pull/31160))
- fix: display network switch notification for bridge screen ([#31037](https://github.com/MetaMask/metamask-extension/pull/31037))
- fix: cp-12.15.0 sort criteria by name, not symbol ([#31171](https://github.com/MetaMask/metamask-extension/pull/31171))
- fix: display NFT name in send flow ([#31131](https://github.com/MetaMask/metamask-extension/pull/31131))
- fix: Confirm Revoke Permit Decoding Simulation & Activity List item ([#30916](https://github.com/MetaMask/metamask-extension/pull/30916))
- fix: revert "feat: enable account syncing for MV2 (#31102)" ([#31102](https://github.com/MetaMask/metamask-extension/pull/31102))
- fix: NFT full page stretched image; remove badgeWrapperClassname prop ([#31082](https://github.com/MetaMask/metamask-extension/pull/31082))
- fix: Disable CSP override feature that is breaking sites ([#31107](https://github.com/MetaMask/metamask-extension/pull/31107))
- fix: fix sentry logs noisy ([#31039](https://github.com/MetaMask/metamask-extension/pull/31039))
- fix: add normalization in signature request ([#29698](https://github.com/MetaMask/metamask-extension/pull/29698))
- fix: Prevent incomplete transaction cleanup to track bridge metrics ([#31038](https://github.com/MetaMask/metamask-extension/pull/31038))
- fix: auth & user storage when switching srp with forgot password flow ([#31011](https://github.com/MetaMask/metamask-extension/pull/31011))
- fix: add missing mock for portfolio site in e2e testing ([#31034](https://github.com/MetaMask/metamask-extension/pull/31034))
- fix: Prevent rerenders of the AccountListItem ([#30873](https://github.com/MetaMask/metamask-extension/pull/30873))
- fix: Ensure SRP backup reminder only displays when on HDKey account ([#29857](https://github.com/MetaMask/metamask-extension/pull/29857))
- fix: Use useCallback for domain input in Send flow ([#30880](https://github.com/MetaMask/metamask-extension/pull/30880))
- fix: remove EVM network when non-EVM network is selected ([#30757](https://github.com/MetaMask/metamask-extension/pull/30757))
- fix: Update the connections menu for dapp connections ([#30434](https://github.com/MetaMask/metamask-extension/pull/30434))
