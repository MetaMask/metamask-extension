...
- - Implement cohort-based gating system for Shield entry modal display (#37651)
    (https://github.com/MetaMask/metamask-extension/pull/37651)
- Modal display now follows cohort assignment logic based on entry
  points (wallet_home, post_tx)
  - Users are assigned to cohorts via backend API when eligible
...
- fix: updated confirmations logic for sidepanel (#37778)
