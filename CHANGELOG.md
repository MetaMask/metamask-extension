...
- bump semvar version to 12.16.0
...
- chore: Sync main with master, v12.10.1 -> v12.13.1 ([#31002](https://github.com/MetaMask/metamask-extension/pull/31002))
- Merge origin/main into master-sync
- chore: ref latest workflows for create-rls ([#30979](https://github.com/MetaMask/metamask-extension/pull/30979))
- ci: move locales-only to GHA ([#30898](https://github.com/MetaMask/metamask-extension/pull/30898))
- refactor: resolve circular imports between permissions.js and selectors.js by moving permissions.js into selectors.js ([#30791](https://github.com/MetaMask/metamask-extension/pull/30791))
- chore: wait at least 10 mins before showing bridge tx delay banner ([#30952](https://github.com/MetaMask/metamask-extension/pull/30952))
- test: fix ci failure Swap/STX specs due to missing mock ([#30932](https://github.com/MetaMask/metamask-extension/pull/30932))
- chore: ignore babel audit failure temporarily ([#30946](https://github.com/MetaMask/metamask-extension/pull/30946))
- test: skip smart transactions tests to unblock CI ([#30939](https://github.com/MetaMask/metamask-extension/pull/30939))
- test: remove uneeded ganache opts ([#30897](https://github.com/MetaMask/metamask-extension/pull/30897))
- chore: Optimize performance of Assets hooks ([#30872](https://github.com/MetaMask/metamask-extension/pull/30872))
- test: Use test-dapp for transaction insights E2E ([#30909](https://github.com/MetaMask/metamask-extension/pull/30909))
- chore: more translations to token alerts ([#30877](https://github.com/MetaMask/metamask-extension/pull/30877))
...
- test: remove `generateGanacheOptions` ([#30854](https://github.com/MetaMask/metamask-extension/pull/30854))
- chore: Update `CODEOWNERS` file for template renderer ([#30855](https://github.com/MetaMask/metamask-extension/pull/30855))
- chore: show solana swaps in activity list ([#30811](https://github.com/MetaMask/metamask-extension/pull/30811))
- test: add send DAI spec using Anvil state ([#30804](https://github.com/MetaMask/metamask-extension/pull/30804))
- chore: bump ethereumjs ([#30716](https://github.com/MetaMask/metamask-extension/pull/30716))
- chore: bump `@metamask/{keyring, profile-sync}-controller` ([#30637](https://github.com/MetaMask/metamask-extension/pull/30637))
- test: remove `defaultGanacheOptions` ([#30728](https://github.com/MetaMask/metamask-extension/pull/30728))
- chore: fix trezor audit ([#30850](https://github.com/MetaMask/metamask-extension/pull/30850))
- test: fix `Send flow with some field validation` ([#30808](https://github.com/MetaMask/metamask-extension/pull/30808))
- chore: New Crowdin translations by Github Action ([#26964](https://github.com/MetaMask/metamask-extension/pull/26964))
- style: make Git blame ignore specified large refactor and lint commits ([#30661](https://github.com/MetaMask/metamask-extension/pull/30661))
- fix(snaps e2e): Fix Snaps E2E on Firefox ([#30775](https://github.com/MetaMask/metamask-extension/pull/30775))
- test: fix "deletes a custom RPC" test ([#30560](https://github.com/MetaMask/metamask-extension/pull/30560))
- chore: Bump Snaps packages ([#30677](https://github.com/MetaMask/metamask-extension/pull/30677))
- chore: update @remote-feature-flag-controller with new beta distribution ([#30649](https://github.com/MetaMask/metamask-extension/pull/30649))
- fix(30348): profile sync can now be searched in settings ([#30687](https://github.com/MetaMask/metamask-extension/pull/30687))
- chore: whats new modal for Solana ([#30682](https://github.com/MetaMask/metamask-extension/pull/30682))
- chore: solana snap version update ([#30731](https://github.com/MetaMask/metamask-extension/pull/30731))
- test: remove `ganacheServer` from the `testSuite` and specs ([#30536](https://github.com/MetaMask/metamask-extension/pull/30536))
- fix(30509): remove 'fake-metrics-id' in e2e to avoid controller error ([#30515](https://github.com/MetaMask/metamask-extension/pull/30515))
- fix(30662): balance when non evms accounts ([#30671](https://github.com/MetaMask/metamask-extension/pull/30671))
- ci: a new prep-deps workflow with caching ([#29979](https://github.com/MetaMask/metamask-extension/pull/29979))
- ci: further enable circular dep linting ([#30148](https://github.com/MetaMask/metamask-extension/pull/30148))
- refactor: use caip25 permission merger / differ ([#30042](https://github.com/MetaMask/metamask-extension/pull/30042))
- fix(e2e): test-artifacts/undefined folder ([#30591](https://github.com/MetaMask/metamask-extension/pull/30591))
- fix(sentry sampling): reduce by 25% our sentry trace sample rate to avoid exceeding our quota ([#30610](https://github.com/MetaMask/metamask-extension/pull/30610))
- chore: fix yarn audit (`@trezor/connect-web`) ([#30640](https://github.com/MetaMask/metamask-extension/pull/30640))
...
- feat: add accounts to a specific srp ([#30604](https://github.com/MetaMask/metamask-extension/pull/30604))
- feat: mms-1876 swap pre populated ([#30929](https://github.com/MetaMask/metamask-extension/pull/30929))
- feat: Add Base to Smart Transaction supported chains ([#30678](https://github.com/MetaMask/metamask-extension/pull/30678))
- feat: When switching network alert the user and get approval if there are pending requests from origin. ([#30674](https://github.com/MetaMask/metamask-extension/pull/30674))
- feat: token approvals from nested transactions in simulation details ([#30511](https://github.com/MetaMask/metamask-extension/pull/30511))
- feat: nested transaction data ([#30447](https://github.com/MetaMask/metamask-extension/pull/30447))
- feat: account upgrade confirmation ([#30347](https://github.com/MetaMask/metamask-extension/pull/30347))
- feat: support atomic batch transactions ([#30271](https://github.com/MetaMask/metamask-extension/pull/30271))
- feat: Add Multichain API to Flask ([#27782](https://github.com/MetaMask/metamask-extension/pull/27782))
- feat: get-release-timelines ([#30778](https://github.com/MetaMask/metamask-extension/pull/30778))
- feat: update solana version ([#30857](https://github.com/MetaMask/metamask-extension/pull/30857))
- feat: migrate profile sync controllers to the controller init pattern ([#30805](https://github.com/MetaMask/metamask-extension/pull/30805))
- feat: Implement editing spending cap in the simulation component ([#30745](https://github.com/MetaMask/metamask-extension/pull/30745))
- feat: import srp ([#30598](https://github.com/MetaMask/metamask-extension/pull/30598))
- feat: mms-1933 token alerts ([#30557](https://github.com/MetaMask/metamask-extension/pull/30557))
- feat: add profile_id as a metametrics user trait ([#30552](https://github.com/MetaMask/metamask-extension/pull/30552))
- feat: Integrate alert system into template based confirmations ([#30577](https://github.com/MetaMask/metamask-extension/pull/30577))
- feat: Adding info alert when new confirmation is from different origin or network ([#30550](https://github.com/MetaMask/metamask-extension/pull/30550))
- feat: removed useless click ([#30615](https://github.com/MetaMask/metamask-extension/pull/30615))
- feat: add solana to beta ([#30613](https://github.com/MetaMask/metamask-extension/pull/30613))
...
- fix: Use useMemo with Receive Modal ([#30881](https://github.com/MetaMask/metamask-extension/pull/30881))
- fix: Ensure env vars are correctly set for beta builds in build-beta.yml ([#30977](https://github.com/MetaMask/metamask-extension/pull/30977))
- fix: Provide required useEffect dependencies in TokenCell and AggregatedPercentageOverview ([#30876](https://github.com/MetaMask/metamask-extension/pull/30876))
- fix: Add `describeChromeOnly` helper and use to exclude multichain API e2e tests from firefox e2e test runs ([#30937](https://github.com/MetaMask/metamask-extension/pull/30937))
- fix: fix code fencing for beta build ([#30935](https://github.com/MetaMask/metamask-extension/pull/30935))
- fix: multichain transactions display ([#30926](https://github.com/MetaMask/metamask-extension/pull/30926))
- fix: cp-12.14.0 bridge status validation causes transactions to be pending indefinitely ([#30918](https://github.com/MetaMask/metamask-extension/pull/30918))
- fix: cp-12.14.0 Fix ticker on transaction confirmations when other networks selected ([#30905](https://github.com/MetaMask/metamask-extension/pull/30905))
- fix: cp-12.14.0 (MMS-2061) prompt user to create solana acct in bridge flow if selected tochain and no account ([#30919](https://github.com/MetaMask/metamask-extension/pull/30919))
- fix: cp-12.14.0 set automatic slippage for swap transactions ([#30878](https://github.com/MetaMask/metamask-extension/pull/30878))
- fix: cp-12.14.0 duplicate dest assets visible in bridge page ([#30846](https://github.com/MetaMask/metamask-extension/pull/30846))
- fix: First time interaction warning should be shown in dApp request as warning ([#30800](https://github.com/MetaMask/metamask-extension/pull/30800))
- fix: Prevent SrpViewSrpText from firing more than once ([#30658](https://github.com/MetaMask/metamask-extension/pull/30658))
- fix: Prevent BadgeStatus' tooltip from rerendering ([#30874](https://github.com/MetaMask/metamask-extension/pull/30874))
- fix: formatChainIdToHex fails to parse evm caip chainIds ([#30848](https://github.com/MetaMask/metamask-extension/pull/30848))
- fix: Perf: Prevent MultichainMetaFoxLogo from multiple renders ([#30286](https://github.com/MetaMask/metamask-extension/pull/30286))
- fix: fix hideZeroBalance setting for non evm asset list ([#30816](https://github.com/MetaMask/metamask-extension/pull/30816))
- fix: Perf: Prevent MultipleNotifications rerenders ([#30288](https://github.com/MetaMask/metamask-extension/pull/30288))
- fix: mms-2025 text ellipsis ([#30845](https://github.com/MetaMask/metamask-extension/pull/30845))
- fix: Bridge and Send pages crash when there's no solana account ([#30793](https://github.com/MetaMask/metamask-extension/pull/30793))
- fix: Display alerts on add network request if there are pending confirmations ([#30634](https://github.com/MetaMask/metamask-extension/pull/30634))
- fix: mms-2045 paste non 0x address ([#30712](https://github.com/MetaMask/metamask-extension/pull/30712))
- fix: remove assets detection metrics ([#30730](https://github.com/MetaMask/metamask-extension/pull/30730))
- fix: Fix redux warning in `useOriginThrottling.ts` ([#30724](https://github.com/MetaMask/metamask-extension/pull/30724))
- fix: use networkClientId if included in transaction ([#30758](https://github.com/MetaMask/metamask-extension/pull/30758))
- fix: fetch quotes when dest asset is native ([#30749](https://github.com/MetaMask/metamask-extension/pull/30749))
- fix: code-fence multichain network selector ([#30722](https://github.com/MetaMask/metamask-extension/pull/30722))
- fix: fix sentry error related to auto import ([#30743](https://github.com/MetaMask/metamask-extension/pull/30743))
- fix: fixes bridging label showing for solana swap ([#30756](https://github.com/MetaMask/metamask-extension/pull/30756))
- fix: show aggregated balance in account list item ([#30581](https://github.com/MetaMask/metamask-extension/pull/30581))
- fix: flaky test `Metrics Sends a contract interaction type 2 transaction (EIP1559) with the right properties in the metric events` ([#30769](https://github.com/MetaMask/metamask-extension/pull/30769))
- fix: mms-2049 solana slipagge ([#30760](https://github.com/MetaMask/metamask-extension/pull/30760))
- fix: fixes swap transactions showing up as bridge ([#30656](https://github.com/MetaMask/metamask-extension/pull/30656))
- fix: snap acount creation view position ([#30721](https://github.com/MetaMask/metamask-extension/pull/30721))
- fix: chain id conversion in metrics event ([#30614](https://github.com/MetaMask/metamask-extension/pull/30614))
- fix: cp-12.14.0 replace 3D beta mascot with 2D version ([#30686](https://github.com/MetaMask/metamask-extension/pull/30686))
- fix: add error boundary on NFT grid items ([#30486](https://github.com/MetaMask/metamask-extension/pull/30486))
...
- fix: mms-2001 first step bridge ([#30644](https://github.com/MetaMask/metamask-extension/pull/30644))
- fix: cp-12.14.0 color inheritance ([#30651](https://github.com/MetaMask/metamask-extension/pull/30651))
- fix: cp-12.14.0 Fix FF send max e2e specs to increase specific timeout ([#30631](https://github.com/MetaMask/metamask-extension/pull/30631))
- fix: destWalletAddress selection for multichain bridging ([#30618](https://github.com/MetaMask/metamask-extension/pull/30618))
- fix: Update decimal precision for account list item and token list ([#30594](https://github.com/MetaMask/metamask-extension/pull/30594))
- fix: disable click handler on non-evm tokens to not throw warning in … ([#30616](https://github.com/MetaMask/metamask-extension/pull/30616))
...
[12.16.0]: https://github.com/MetaMask/metamask-extension/compare/v12.14.2...v12.16.0
