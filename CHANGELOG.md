...
- Added conditional disabling of nonce editing when smart transactions are enabled ([#29891](https://github.com/MetaMask/metamask-extension/pull/29891))
- Upgraded Ledger keyring to resolve EIP-712 signing issues ([#29820](https://github.com/MetaMask/metamask-extension/pull/29820))
...
- Fixed NFT list wrapping within the send modal ([#30036](https://github.com/MetaMask/metamask-extension/pull/30036))
- Fixed explicit data addition to gas estimation parameters ([#29946](https://github.com/MetaMask/metamask-extension/pull/29946))
- Fixed handling of null STX status containing pre-enabled state ([#29968](https://github.com/MetaMask/metamask-extension/pull/29968))
- Fixed incorrect native token display in insufficient funds error messages ([#29828](https://github.com/MetaMask/metamask-extension/pull/29828))
- Fixed transaction flow component issues for ERC-1155 tokens ([#29775](https://github.com/MetaMask/metamask-extension/pull/29775))
- Updated STX banner alert to include chain support check ([#29911](https://github.com/MetaMask/metamask-extension/pull/29911))
- Reapplied fix for premature display of "You Received" in bridge transactions ([#29411](https://github.com/MetaMask/metamask-extension/pull/29411))
- Updated undici dependency to address security audit (5.28.4 → 5.28.5) ([#29914](https://github.com/MetaMask/metamask-extension/pull/29914))
- Fixed ERC-1155 token send flow in transaction component ([#29775](https://github.com/MetaMask/metamask-extension/pull/29775))
