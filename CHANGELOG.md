...
- Introduced an updated asset page with historical prices, market insights, and interactive charts ([#22508](https://github.com/MetaMask/metamask-extension/pull/22508))
...
- Introduced a simulation preview for token balance changes ([#23503](https://github.com/MetaMask/metamask-extension/pull/23503))
...
- Implemented a 'Reject All' option in the confirmation header ([#22942](https://github.com/MetaMask/metamask-extension/pull/22942))
- Added an info icon to the header, revealing sender address and balance details ([#23366](https://github.com/MetaMask/metamask-extension/pull/23366))
- Integrated Blockaid alert banner into the redesigned signature request pages ([#23693](https://github.com/MetaMask/metamask-extension/pull/23693))
...
- Implemented functionality for cancel and submit buttons on the personal sign page ([#22809](https://github.com/MetaMask/metamask-extension/pull/22809))
...
- Updated Permission Cell to display linked accounts ([#23454](https://github.com/MetaMask/metamask-extension/pull/23454))
...
- Added 'Switch to this account' and 'Disconnect' buttons in the Connected accounts menu ([#23258](https://github.com/MetaMask/metamask-extension/pull/23258))
- Implemented a streamlined flow for connecting accounts when no dApp is connected ([#23422](https://github.com/MetaMask/metamask-extension/pull/23422))
- Enhanced account management with a new 'Connect More Accounts' modal ([#23193](https://github.com/MetaMask/metamask-extension/pull/23193))
...
### Changed
- Reverted to the previous asset page ([#23701](https://github.com/MetaMask/metamask-extension/pull/23701))
- Updated the Asset picker amount feature ([#23192](https://github.com/MetaMask/metamask-extension/pull/23192))
- Enhanced transaction data handling for more reliable validation ([#23220](https://github.com/MetaMask/metamask-extension/pull/23220))
- Refined the display style for unidentified petnames, ensuring clarity between unrecognised and potentially malicious contracts ([#23458](https://github.com/MetaMask/metamask-extension/pull/23458))
...
- Integrated MMI-related logic into the redesigned personal sign page ([#23047](https://github.com/MetaMask/metamask-extension/pull/23047))
- Removed the 'powered by Blockaid' attribution from the interface ([#23484](https://github.com/MetaMask/metamask-extension/pull/23484))
- Updated the look of Type Sign V3 and V4 confirmations ([#23448](https://github.com/MetaMask/metamask-extension/pull/23448))
- Temporarily removed the network picker from the new send flow ([#23349](https://github.com/MetaMask/metamask-extension/pull/23349))
