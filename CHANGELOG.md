...
- bump semvar version to 12.10.119
- bump semvar version to 12.10.118
- bump semvar version to 12.10.116
- bump semvar version to 12.10.115
- bump semvar version to 12.10.113
- bump semvar version to 12.10.112
- bump semvar version to 12.10.111
- bump semvar version to 12.10.110
- bump semvar version to 12.10.109
- bump semvar version to 12.10.108
- bump semvar version to 12.10.107
- bump semvar version to 12.10.106
- bump semvar version to 12.10.105
- bump semvar version to 12.10.104
- bump semvar version to 12.10.101
- bump semvar version to 12.10.17
- bump semvar version to 12.10.16
- bump semvar version to 12.10.15 && build version to
- bump semvar version to 12.10.14 && build version to
...
- chore: de-deuplicates the erc20 revoke allowance tests ([#29658](https://github.com/MetaMask/metamask-extension/pull/29658))
- chore: Master sync following v12.9.3, v12.10.0 and v12.10.1 ([#29614](https://github.com/MetaMask/metamask-extension/pull/29614))
- chore: Bump Snaps packages ([#29693](https://github.com/MetaMask/metamask-extension/pull/29693))
- Merge origin/main into master-sync
- docs: fix developer docs link in README ([#29734](https://github.com/MetaMask/metamask-extension/pull/29734))
- test: Fix Playwright Swap e2e failures ([#29729](https://github.com/MetaMask/metamask-extension/pull/29729))
- feat(3744): Implement feature Flag Values with Scope Based on threshold ([#29081](https://github.com/MetaMask/metamask-extension/pull/29081))
- test: MMQA-188: remove mmi e2e tests from ci ([#29233](https://github.com/MetaMask/metamask-extension/pull/29233))
- chore: remove `@metamask/eth-query` package ([#29649](https://github.com/MetaMask/metamask-extension/pull/29649))
- chore: Remove unused `nonce-tracker` patch ([#29714](https://github.com/MetaMask/metamask-extension/pull/29714))
- test: Fixed Swap Playwright tests ([#29710](https://github.com/MetaMask/metamask-extension/pull/29710))
- test: Fix flask user-operations e2e test setup ([#29675](https://github.com/MetaMask/metamask-extension/pull/29675))
- test: add fixture permission controller test dapp two accounts ([#29671](https://github.com/MetaMask/metamask-extension/pull/29671))
- chore: remove `@metamask/ethjs` package ([#29620](https://github.com/MetaMask/metamask-extension/pull/29620))
- refactor: NFT Grid View ([#29445](https://github.com/MetaMask/metamask-extension/pull/29445))
- chore: xchain tx details use short names ([#29413](https://github.com/MetaMask/metamask-extension/pull/29413))
- chore: clarifying comments for some github actions ([#29642](https://github.com/MetaMask/metamask-extension/pull/29642))
- build: remove unused `info-fox.svg` ([#29294](https://github.com/MetaMask/metamask-extension/pull/29294))
- refactor: remove unused end param in ethereum-chain-util helpers ([#29619](https://github.com/MetaMask/metamask-extension/pull/29619))
- chore: Remove obsolete keys ([#29372](https://github.com/MetaMask/metamask-extension/pull/29372))
- chore: bump `@metamask/profile-sync-controller` to `v3.2.0` ([#29598](https://github.com/MetaMask/metamask-extension/pull/29598))
- test: Remove obsolete permitted chains feature flag tests ([#29618](https://github.com/MetaMask/metamask-extension/pull/29618))
- ci: Migrate metamaskbot PR comment ([#29373](https://github.com/MetaMask/metamask-extension/pull/29373))
- chore: Remove toggle to turn on/off Per Dapp Selected Network Feature ([#29301](https://github.com/MetaMask/metamask-extension/pull/29301))
- fix(snaps): Scrollbar being partially hidden behind footer ([#29435](https://github.com/MetaMask/metamask-extension/pull/29435))
- test: [POM] Migrate connections e2e tests to TS and Page Object Model ([#29384](https://github.com/MetaMask/metamask-extension/pull/29384))
- chore: fix flaky e2e for nft token send ([#29476](https://github.com/MetaMask/metamask-extension/pull/29476))
- chore(deps): bump `@metamask/eth-trezor-keyring` to `^6.0.0` ([#27689](https://github.com/MetaMask/metamask-extension/pull/27689))
- test: fix flaky snap signature test ([#29480](https://github.com/MetaMask/metamask-extension/pull/29480))
- fix(snaps): Ensure that adjacent form elements take up to 50% width ([#29436](https://github.com/MetaMask/metamask-extension/pull/29436))
- chore: add the new policy.json review process documentation and config ([#29383](https://github.com/MetaMask/metamask-extension/pull/29383))
- test: [POM] Migrate token tests ([#29375](https://github.com/MetaMask/metamask-extension/pull/29375))
- test: Swap tests addition ([#29442](https://github.com/MetaMask/metamask-extension/pull/29442))
- chore: remove second inner scroll bar from tx details ([#29412](https://github.com/MetaMask/metamask-extension/pull/29412))
- ci: Fix `metamaskbot` comment test build links ([#29403](https://github.com/MetaMask/metamask-extension/pull/29403))
- chore: Fix flaky snap signature insights tests ([#29437](https://github.com/MetaMask/metamask-extension/pull/29437))
- chore: Remove broken coverage report link ([#29410](https://github.com/MetaMask/metamask-extension/pull/29410))
- chore: replace local `isSnapId` definition with `isSnapId` from `@metamask/snaps-utils` ([#29422](https://github.com/MetaMask/metamask-extension/pull/29422))
- test: fix flaky native send and transaction decoding test ([#29362](https://github.com/MetaMask/metamask-extension/pull/29362))
- chore: Remove broken MV3 perf stats ([#29408](https://github.com/MetaMask/metamask-extension/pull/29408))
- ci: Migrate LavaMoat validation to GitHub Actions ([#29369](https://github.com/MetaMask/metamask-extension/pull/29369))
- ci: Migrate lint CI steps ([#29371](https://github.com/MetaMask/metamask-extension/pull/29371))
- ci: Migrate dependency linting ([#29370](https://github.com/MetaMask/metamask-extension/pull/29370))
- chore: Update to the latest transaction controller ([#29395](https://github.com/MetaMask/metamask-extension/pull/29395))
- feat(14507): improve error message for failed txn in activity details view ([#29338](https://github.com/MetaMask/metamask-extension/pull/29338))
- fix(28081): design tweak for network badge ([#29324](https://github.com/MetaMask/metamask-extension/pull/29324))
- chore: Bump Snaps packages ([#29275](https://github.com/MetaMask/metamask-extension/pull/29275))
- fix(29226): fix error for undefined unitInput for sending NFT ([#29386](https://github.com/MetaMask/metamask-extension/pull/29386))
- test: remove duplicate signature tests ([#29377](https://github.com/MetaMask/metamask-extension/pull/29377))
- test: [POM] Migrate watch account tests ([#29314](https://github.com/MetaMask/metamask-extension/pull/29314))
- test: [POM] Dapp subscribe network switch spec migration ([#29346](https://github.com/MetaMask/metamask-extension/pull/29346))
- chore: remove duplicated tests for metrics for redesigned signatures ([#29359](https://github.com/MetaMask/metamask-extension/pull/29359))
- chore: Remove unused loadingTokens localized string ([#29329](https://github.com/MetaMask/metamask-extension/pull/29329))
- chore: low return warning alert for bridging ([#29171](https://github.com/MetaMask/metamask-extension/pull/29171))
- refactor: shared bridge types ([#29254](https://github.com/MetaMask/metamask-extension/pull/29254))
- chore: bump `@metamask/smart-transactions-controller` to `16.0.0` ([#29344](https://github.com/MetaMask/metamask-extension/pull/29344))
- ci: Improve accuracy of `wait-for-circleci-workflow-status` ([#29310](https://github.com/MetaMask/metamask-extension/pull/29310))
- chore: bump `@metamask/user-operation-controller` to `^21.0.0` ([#29089](https://github.com/MetaMask/metamask-extension/pull/29089))
- chore: updating menu item to use text component ([#29304](https://github.com/MetaMask/metamask-extension/pull/29304))
- chore: Master sync following v12.9.2 ([#29328](https://github.com/MetaMask/metamask-extension/pull/29328))
- Merge origin/main into master-sync
- test: [POM] Migrate add-multiple-tokens test ([#29288](https://github.com/MetaMask/metamask-extension/pull/29288))
- refactor: remove duplication of selectors in `selectors/confirm-transaction.js` ([#27641](https://github.com/MetaMask/metamask-extension/pull/27641))
- chore: fix security settings layout ([#29258](https://github.com/MetaMask/metamask-extension/pull/29258))
- test: [POM] Migrate portfolio e2e tests and permission requests tests to TS and Page Object Model ([#29274](https://github.com/MetaMask/metamask-extension/pull/29274))
- chore: remove `NewNetworkInfo` ([#29293](https://github.com/MetaMask/metamask-extension/pull/29293))
- chore: Update lavamoat to a version with more diff-friendly policy ordering ([#29311](https://github.com/MetaMask/metamask-extension/pull/29311))
- refactor: use new `@metamask/keyring-api` layout (split packages) ([#28861](https://github.com/MetaMask/metamask-extension/pull/28861))
- fix(26772): improve helptext for sending NFTs ([#29296](https://github.com/MetaMask/metamask-extension/pull/29296))
- test: [POM] Create base classes and methods for bitcoin e2e tests ([#29235](https://github.com/MetaMask/metamask-extension/pull/29235))
- refactor: move `getCurrentCurrency` from `ui/selectors/selectors.js` to `ui/ducks/metamask/metamask.js` ([#27648](https://github.com/MetaMask/metamask-extension/pull/27648))
- chore: quote timeout treatment for bridging ([#29172](https://github.com/MetaMask/metamask-extension/pull/29172))
- fix(27140): fix styles for Slippage Tolerance Button Group in Transaction Settings Modal ([#29246](https://github.com/MetaMask/metamask-extension/pull/29246))
...
- feat: Remove 'Improved transactions requests' toggle ([#29695](https://github.com/MetaMask/metamask-extension/pull/29695))
- feat: check balance switching networks e2e tests ([#29345](https://github.com/MetaMask/metamask-extension/pull/29345))
- feat: Add new completion_time_onchain property to Transaction Finalized events ([#29474](https://github.com/MetaMask/metamask-extension/pull/29474))
- feat: Use a dynamic interval value for smart transaction status polling ([#29703](https://github.com/MetaMask/metamask-extension/pull/29703))
- feat: Capture block number within Transaction Finalized Anon events ([#29638](https://github.com/MetaMask/metamask-extension/pull/29638))
- feat: run the "Main" workflow on release branches ([#29704](https://github.com/MetaMask/metamask-extension/pull/29704))
- feat: lint-workflows ([#29643](https://github.com/MetaMask/metamask-extension/pull/29643))
- feat: add auto sign-in for existing users ([#29654](https://github.com/MetaMask/metamask-extension/pull/29654))
- feat: add sentry error logging to account syncing erroneous situations ([#29692](https://github.com/MetaMask/metamask-extension/pull/29692))
- feat: persist bridge state through ToS click ([#29366](https://github.com/MetaMask/metamask-extension/pull/29366))
- feat: improve xchain swaps slippage settings with decimals and warnings ([#29617](https://github.com/MetaMask/metamask-extension/pull/29617))
- feat: runway ([#29632](https://github.com/MetaMask/metamask-extension/pull/29632))
- feat: Nonce is always editable in advanced details view ([#29627](https://github.com/MetaMask/metamask-extension/pull/29627))
- feat: Display clickable cursor on hover on petname component ([#29477](https://github.com/MetaMask/metamask-extension/pull/29477))
- feat: Enable Ledger clear signing feature ([#28909](https://github.com/MetaMask/metamask-extension/pull/28909))
- feat: Adding more metrics parameters for signature decoding ([#29197](https://github.com/MetaMask/metamask-extension/pull/29197))
- feat: enable STX by default with migration and notification ([#28854](https://github.com/MetaMask/metamask-extension/pull/28854))
- feat: add some authentication state to sentry logs ([#29432](https://github.com/MetaMask/metamask-extension/pull/29432))
- feat: Display Unlimited for really large spending caps on Permit ([#29102](https://github.com/MetaMask/metamask-extension/pull/29102))
- feat: bump solana snap ([#29350](https://github.com/MetaMask/metamask-extension/pull/29350))
- feat: add metametrics events to carousel ([#29141](https://github.com/MetaMask/metamask-extension/pull/29141))
- feat: added create solana account test ([#28866](https://github.com/MetaMask/metamask-extension/pull/28866))
- feat: event when token list is refreshed ([#29300](https://github.com/MetaMask/metamask-extension/pull/29300))
- feat: center backup toast ([#29200](https://github.com/MetaMask/metamask-extension/pull/29200))
- feat: add eth native icon for zora network ([#29257](https://github.com/MetaMask/metamask-extension/pull/29257))
...
- fix: add soneium logo ([#29713](https://github.com/MetaMask/metamask-extension/pull/29713))
- fix: update eth-ledger-keyring-bridge lib to fix web pack issue. ([#29722](https://github.com/MetaMask/metamask-extension/pull/29722))
- fix: add prefix to account sync error message ([#29718](https://github.com/MetaMask/metamask-extension/pull/29718))
- fix: account syncing was not working after upgrading from a previous version ([#29701](https://github.com/MetaMask/metamask-extension/pull/29701))
- fix: focused search field forces scroll ([#29676](https://github.com/MetaMask/metamask-extension/pull/29676))
- fix: Fix `SignatureController` hub `cancelWithReason` event handler ([#29673](https://github.com/MetaMask/metamask-extension/pull/29673))
- fix: condition for signing in a user after onboarding ([#29659](https://github.com/MetaMask/metamask-extension/pull/29659))
- fix: Correct Snaps Home scroll behavior ([#29660](https://github.com/MetaMask/metamask-extension/pull/29660))
- fix: oldestPendingApproval and transactionsMetadata PropTypes in the … ([#29689](https://github.com/MetaMask/metamask-extension/pull/29689))
- fix: upgrade @metamask/eth-ledger-bridge-keyring library to latest ([#29687](https://github.com/MetaMask/metamask-extension/pull/29687))
- fix: center pixel art in `no-nfts.svg` and remove use of embedded png ([#29290](https://github.com/MetaMask/metamask-extension/pull/29290))
- fix: use correct color for bitcoin logo and remove the svg's embedded PNG ([#29292](https://github.com/MetaMask/metamask-extension/pull/29292))
- fix: duplicate content in multiple pending connect confirmations ([#29653](https://github.com/MetaMask/metamask-extension/pull/29653))
- fix: Move foreground state properties from `metamask` slice to `appState` slice ([#28703](https://github.com/MetaMask/metamask-extension/pull/28703))
- fix: Fix LavaMoat build failures and restore RegExp OOM mitigation ([#29637](https://github.com/MetaMask/metamask-extension/pull/29637))
- fix: crashing after bridge tx in Firefox ([#29631](https://github.com/MetaMask/metamask-extension/pull/29631))
- fix: change alert modal copy ([#29475](https://github.com/MetaMask/metamask-extension/pull/29475))
- fix: metamaskbot comment nits ([#29636](https://github.com/MetaMask/metamask-extension/pull/29636))
- fix: Remove unwanted empty `div` from signature confirmations ([#29622](https://github.com/MetaMask/metamask-extension/pull/29622))
- fix: Fix bundle size tracking ([#29486](https://github.com/MetaMask/metamask-extension/pull/29486))
- fix: Catch errors from the assets controller ([#29439](https://github.com/MetaMask/metamask-extension/pull/29439))
- fix: show localized snap name in snap tag ([#29049](https://github.com/MetaMask/metamask-extension/pull/29049))
- fix: Bump smart-transactions-controller to ^16.0.1 ([#29478](https://github.com/MetaMask/metamask-extension/pull/29478))
- fix: add kaia network logo ([#29494](https://github.com/MetaMask/metamask-extension/pull/29494))
- fix: add lnk network logo ([#29493](https://github.com/MetaMask/metamask-extension/pull/29493))
- fix: Bump Snap UI selector `min-height` ([#29496](https://github.com/MetaMask/metamask-extension/pull/29496))
- fix: Fixes in NFT listing label and values ([#29046](https://github.com/MetaMask/metamask-extension/pull/29046))
- fix: import all detected tokens automatically ([#29357](https://github.com/MetaMask/metamask-extension/pull/29357))
- fix: hide you received until bridge tx done ([#29411](https://github.com/MetaMask/metamask-extension/pull/29411))
- fix: 'Incomplete Asset Displayed' called excessively via useTrackERC20WithoutDecimalInformation + clean: token details logic ([#29320](https://github.com/MetaMask/metamask-extension/pull/29320))
- fix: xchain linea bugs ([#29409](https://github.com/MetaMask/metamask-extension/pull/29409))
- fix: Add missing allowed action to the `SmartTransactionsController` messenger ([#29473](https://github.com/MetaMask/metamask-extension/pull/29473))
- fix: Use correct prop for Snap UI Avatar size ([#29466](https://github.com/MetaMask/metamask-extension/pull/29466))
- fix: Correct theme value for Snap UI footer buttons ([#29434](https://github.com/MetaMask/metamask-extension/pull/29434))
- fix: Use `break-word` for Snaps UI text wrapping ([#29387](https://github.com/MetaMask/metamask-extension/pull/29387))
- fix: hide first interaction alert if token transfer recipient is internal account ([#29389](https://github.com/MetaMask/metamask-extension/pull/29389))
- fix: Add main frame URL property to req object whenever req is triggered from an iframe ([#29337](https://github.com/MetaMask/metamask-extension/pull/29337))
- fix: Use margin instead of padding for the Snaps UI Container ([#29385](https://github.com/MetaMask/metamask-extension/pull/29385))
- fix: navigation between watch asset approvals ([#29279](https://github.com/MetaMask/metamask-extension/pull/29279))
- fix: Adding validation for primary type of types sign signatures ([#29379](https://github.com/MetaMask/metamask-extension/pull/29379))
- fix: remove Text in the Activity Empty State ([#29318](https://github.com/MetaMask/metamask-extension/pull/29318))
- fix: `gasFeeEstimates` property undefined ([#29312](https://github.com/MetaMask/metamask-extension/pull/29312))
- fix: fixed truncation issue for long help text ([#29269](https://github.com/MetaMask/metamask-extension/pull/29269))
- fix: UI is not displaying gas limit set by dapp ([#29352](https://github.com/MetaMask/metamask-extension/pull/29352))
- fix: Use `toUnicode` function to normalize ens domains in the UI ([#29231](https://github.com/MetaMask/metamask-extension/pull/29231))
- fix: Network URL toPunycodeUrl preserve no path slash ([#29325](https://github.com/MetaMask/metamask-extension/pull/29325))
- fix: Sanitize `signTypedDatav3v4` params before calling security API ([#29343](https://github.com/MetaMask/metamask-extension/pull/29343))
- fix: Prevent unwanted `updateEditableParams` calls on send flow ([#29048](https://github.com/MetaMask/metamask-extension/pull/29048))
- fix: Add origin pill to wallet_addEthereumChain confirmation ([#29317](https://github.com/MetaMask/metamask-extension/pull/29317))
- fix: Wrong icon for ETH on L2s being displayed on transfer confirmations ([#29353](https://github.com/MetaMask/metamask-extension/pull/29353))
- fix: updated margin for import token banner ([#29283](https://github.com/MetaMask/metamask-extension/pull/29283))
- fix: Ellipsis displayed for petname even though the full name is visible ([#29282](https://github.com/MetaMask/metamask-extension/pull/29282))
- fix: personal sign message - decode message to UTF-8 string only if it is valid UTF-8 ([#29232](https://github.com/MetaMask/metamask-extension/pull/29232))
- fix: Spending cap flicker as decimals are determined ([#29206](https://github.com/MetaMask/metamask-extension/pull/29206))
- fix: handle notification api calls settings ([#29327](https://github.com/MetaMask/metamask-extension/pull/29327))
- fix: MMASSETS-475 - Add network name to asset details page ([#29211](https://github.com/MetaMask/metamask-extension/pull/29211))
- fix: block tracker stops polling when switching away from the network ([#29045](https://github.com/MetaMask/metamask-extension/pull/29045))
- fix: Token details should not display zero balance for tokens without marketData ([#29299](https://github.com/MetaMask/metamask-extension/pull/29299))
- fix: close network/accounts toasts when opening the Edit page ([#29239](https://github.com/MetaMask/metamask-extension/pull/29239))
- fix: Remove details option if permission has no description ([#29313](https://github.com/MetaMask/metamask-extension/pull/29313))
- fix: Remove use of boolean value for metrics properties ([#29315](https://github.com/MetaMask/metamask-extension/pull/29315))
- fix: Fix icon alignment in signature pages message section ([#29284](https://github.com/MetaMask/metamask-extension/pull/29284))
- fix: 'Metamask' casing on token details page ([#29250](https://github.com/MetaMask/metamask-extension/pull/29250))
- fix: updated message string in onboarding screen ([#29286](https://github.com/MetaMask/metamask-extension/pull/29286))
- fix: sentry e2e test for bridge tokens loading status ([#29285](https://github.com/MetaMask/metamask-extension/pull/29285))
- fix: remove network picker from non evm accounts ([#29247](https://github.com/MetaMask/metamask-extension/pull/29247))
- fix: add focus state to swaps input for improved accessibility ([#29252](https://github.com/MetaMask/metamask-extension/pull/29252))
- fix: Fix low gas display label in speed-up modal ([#29277](https://github.com/MetaMask/metamask-extension/pull/29277))
...
[Unreleased]: https://github.com/MetaMask/metamask-extension/compare/v12.10.119...HEAD
[12.10.119]: https://github.com/MetaMask/metamask-extension/compare/v12.10.1...v12.10.119
