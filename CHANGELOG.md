...
- Remove ETH badge from NetworkAccountBalanceHeader when on non-ETH net… ([#16102](https://github.com/MetaMask/metamask-extension/pull/16102))
- Updating controller dependency ([#16033](https://github.com/MetaMask/metamask-extension/pull/16033))
...
- Ensure that portfolio tooltip does not show if new custom network popup is shown ([#16090](https://github.com/MetaMask/metamask-extension/pull/16090))
...
- Fix: show whats new to users who created, not imported, a new wallet,… ([#16042](https://github.com/MetaMask/metamask-extension/pull/16042))
- Hardware wallet copy updates, referral and tutorial buttons ([#14738](https://github.com/MetaMask/metamask-extension/pull/14738))
...
- Sync `master` with `develop` ([#16054](https://github.com/MetaMask/metamask-extension/pull/16054))
- Merge fixes
- Merge remote-tracking branch 'origin/develop' into master-sync
- Revert "Fix permissions in MV3 manifest (#15980)" ([#15980](https://github.com/MetaMask/metamask-extension/pull/15980))
- Fix `@hapi/hoek` audit failure ([#16034](https://github.com/MetaMask/metamask-extension/pull/16034))
- Add remaining tests for createInfuraClient ([#15717](https://github.com/MetaMask/metamask-extension/pull/15717))
- Deprecate snake case from feature flags ([#15994](https://github.com/MetaMask/metamask-extension/pull/15994))
- add icons auto size ([#16027](https://github.com/MetaMask/metamask-extension/pull/16027))
...
[10.22.0]: https://github.com/MetaMask/metamask-extension/compare/v10.20.0...v10.22.0
