...
- fix: Fix invalid state causing migration 88 to fail ([#26397](https://github.com/MetaMask/metamask-extension/pull/26397))
- fix: Delete obsolete properties from phishingController and networkControl… ([#26396](https://github.com/MetaMask/metamask-extension/pull/26396))
...
- fix: Add migration 120.4 to delete obsolete currency controller state ([#26383](https://github.com/MetaMask/metamask-extension/pull/26383))
...
- fix: Fix `currentNetwork` selector when current network config is missing ([#26327](https://github.com/MetaMask/metamask-extension/pull/26327))
- fix(2946): disable the 'restore backup' in advanced settings ([#26325](https://github.com/MetaMask/metamask-extension/pull/26325))
- fix: Remove invalid providerConfig id ([#26310](https://github.com/MetaMask/metamask-extension/pull/26310))
...
- fix: undefined market data selector ([#26264](https://github.com/MetaMask/metamask-extension/pull/26264))
- fix: get permit and order signatures token decimals ([#26292](https://github.com/MetaMask/metamask-extension/pull/26292))
- fix: Remove obsolete PhishingController state ([#26308](https://github.com/MetaMask/metamask-extension/pull/26308))
- fix: Remove obsolete NetworkController state ([#26302](https://github.com/MetaMask/metamask-extension/pull/26302))
...
- refactor: Refactor migration 120.2 to prepare for additions ([#26298](https://github.com/MetaMask/metamask-extension/pull/26298))
...
- fix: add guard for draft tx in send validation ([#26295](https://github.com/MetaMask/metamask-extension/pull/26295))
- fix: Truncate extremely long transaction histories ([#26291](https://github.com/MetaMask/metamask-extension/pull/26291))
...
- fix: Remove dangling `snapErrors` state property ([#26282](https://github.com/MetaMask/metamask-extension/pull/26282))
...
- fix: Account for persistence flag when setting initial state in `ComposableObservableStore` ([#26280](https://github.com/MetaMask/metamask-extension/pull/26280))
...
- fix: :bug: use a counter to show if there are pending transactions ([#26116](https://github.com/MetaMask/metamask-extension/pull/26116))
- fix(multichain): fix showFiat option for test assets ([#26224](https://github.com/MetaMask/metamask-extension/pull/26224))
...
- fix: add migration to remove any dangling instances of `perDomainNetwork` on `SelectedNetworkController` state ([#26265](https://github.com/MetaMask/metamask-extension/pull/26265))
- fix: handle send transaction API errors ([#26253](https://github.com/MetaMask/metamask-extension/pull/26253))
...
- fix: add extra condition to prevent erroneous calls to fetch insight ([#26248](https://github.com/MetaMask/metamask-extension/pull/26248))
...
- fix: change in number format to fix loss of precision for very big values ([#25968](https://github.com/MetaMask/metamask-extension/pull/25968))
...
- refactor: Create reusable ConfirmInfoRowTextTokenUnits component ([#26105](https://github.com/MetaMask/metamask-extension/pull/26105))
...
- fix: add ellipsis for permit fiat values ([#26001](https://github.com/MetaMask/metamask-extension/pull/26001))
...
- fix: selected network when there are two with the same chain id.  ([#25805](https://github.com/MetaMask/metamask-extension/pull/25805))
...
- fix: Error: new BigNumber() more than 15 digits feat: apply ellipsis ([#25741](https://github.com/MetaMask/metamask-extension/pull/25741))
...
- fix: blockaid report url in redesigned pages ([#25702](https://github.com/MetaMask/metamask-extension/pull/25702))
...
- fix: confirmation when transaction (STX) is pending cross-network ([#25629](https://github.com/MetaMask/metamask-extension/pull/25629))
...
- fix: UX: Multichain: Fix dead network problem when switching tabs ([#25425](https://github.com/MetaMask/metamask-extension/pull/25425))
- chore: restore bot workflow to update attributions ([#25211](https://github.com/MetaMask/metamask-extension/pull/25211))
- fix: asset picker bug ([#25601](https://github.com/MetaMask/metamask-extension/pull/25601))
...
- feat: update Permit Signature Redesign "Spending cap" copy ([#25618](https://github.com/MetaMask/metamask-extension/pull/25618))
...
- fix: account missing in connection page ([#25500](https://github.com/MetaMask/metamask-extension/pull/25500))
...
- fix: tweak spacing in send asset picker ([#25576](https://github.com/MetaMask/metamask-extension/pull/25576))
...
- feat: adding / deleting additional RPC URLs ([#25452](https://github.com/MetaMask/metamask-extension/pull/25452))
- test: UX: Multichain: Add test for mutiple dapp confirmation order ([#25536](https://github.com/MetaMask/metamask-extension/pull/25536))
- ci: add SonarCloud scan job ([#25421](https://github.com/MetaMask/metamask-extension/pull/25421))
- test:  Fix flaky test: "Custom network customNetwork should add mainnet network" ([#24895](https://github.com/MetaMask/metamask-extension/pull/24895))
- fix: parse tx logs on contractInteraction to refresh NFT state ([#25380](https://github.com/MetaMask/metamask-extension/pull/25380))
- feat: account overview for bip122:* account types ([#25200](https://github.com/MetaMask/metamask-extension/pull/25200))
- chore: update `chokidar` to `v3.6.0` ([#25571](https://github.com/MetaMask/metamask-extension/pull/25571))
- fix: flaky test `Swap-Send ETH to non-contract address with data that matches swap data signature submits a transaction successfully` ([#25545](https://github.com/MetaMask/metamask-extension/pull/25545))
- refactor: Confirm Alert Modal - no logic changes ([#25371](https://github.com/MetaMask/metamask-extension/pull/25371))
- feat: Add domain binding SIWE redesign alert row ([#25281](https://github.com/MetaMask/metamask-extension/pull/25281))
- feat(ramps): introduces dynamic support for rampable networks ([#24041](https://github.com/MetaMask/metamask-extension/pull/24041))
- fix: `Cannot destructure property 'balance' of 'K[Z]' as it is undefined` fromAddress error when no transaction is loaded in ConfirmTransactionBase ([#25506](https://github.com/MetaMask/metamask-extension/pull/25506))
- fix: fix network delete trash displayed on mouse over ([#25547](https://github.com/MetaMask/metamask-extension/pull/25547))
- feat: `externally_connectable` CAIP delivery and enveloping ([#25075](https://github.com/MetaMask/metamask-extension/pull/25075))
- fix: fix percentage changes when balance is zero ([#25550](https://github.com/MetaMask/metamask-extension/pull/25550))
- feat: upgrade assets controllers to version 33 ([#25484](https://github.com/MetaMask/metamask-extension/pull/25484))
- chore: remove blockaid code fencing ([#25549](https://github.com/MetaMask/metamask-extension/pull/25549))
- chore: Bump Snaps packages ([#25505](https://github.com/MetaMask/metamask-extension/pull/25505))
- feat: display loader on re-designed confirmation page while blockaid validation is in progress ([#25477](https://github.com/MetaMask/metamask-extension/pull/25477))
- fix: enhance accuracy in determining recipient address for contract interactions ([#25445](https://github.com/MetaMask/metamask-extension/pull/25445))
- fix: flaky test ` onboarding @no-mmi doesn't make any network requests to infura before onboarding is completed/test-failure-screenshot-1.png` timeout ([#25525](https://github.com/MetaMask/metamask-extension/pull/25525))
- fix: pin nodejs version to 20.14 ([#25534](https://github.com/MetaMask/metamask-extension/pull/25534))
- fix: Show outdated browser warning immediately ([#25366](https://github.com/MetaMask/metamask-extension/pull/25366))
- fix: Issue 20485 ([#25518](https://github.com/MetaMask/metamask-extension/pull/25518))
- docs: Manual scenario for 'Show test networks' toggle ([#23091](https://github.com/MetaMask/metamask-extension/pull/23091))
- chore: Create a story for UnitInput component ([#25225](https://github.com/MetaMask/metamask-extension/pull/25225))
- fix: multichain account list item ([#25437](https://github.com/MetaMask/metamask-extension/pull/25437))
- chore: Remove Snaps code fencing ([#25523](https://github.com/MetaMask/metamask-extension/pull/25523))
- feat: send correct signature or transaction type in account details opened event ([#25246](https://github.com/MetaMask/metamask-extension/pull/25246))
- fix: prioritize smart transaction status confirmation ([#25478](https://github.com/MetaMask/metamask-extension/pull/25478))
- fix: Update help center URLs ([#24286](https://github.com/MetaMask/metamask-extension/pull/24286))
- chore(deps): bump accounts controller to 17.0.0 ([#25291](https://github.com/MetaMask/metamask-extension/pull/25291))
- chore(deps): Bump notification-controller to ^5.0.1 ([#24430](https://github.com/MetaMask/metamask-extension/pull/24430))
- feat: bump `@metamask/queued-request controller` to `^2.0.0` to fix confirmation popup focus in request queue ([#25497](https://github.com/MetaMask/metamask-extension/pull/25497))
- perf: use global token list in hook ([#25501](https://github.com/MetaMask/metamask-extension/pull/25501))
- fix: do not use STX for swap+send approval ([#25510](https://github.com/MetaMask/metamask-extension/pull/25510))
- test: add e2e for scenario where `wallet_switchEthereumChain` call is canceled with other confirmations queued behind it ([#25341](https://github.com/MetaMask/metamask-extension/pull/25341))
- chore: Remove dead code/config related to Mocha unit tests ([#25492](https://github.com/MetaMask/metamask-extension/pull/25492))
- fix: formatting of deadline in permit signature page ([#25321](https://github.com/MetaMask/metamask-extension/pull/25321))
- fix: hide testnet amounts if user opt out in the settings ([#25167](https://github.com/MetaMask/metamask-extension/pull/25167))
- fix: UX: Remove legacy onboarding text ([#25404](https://github.com/MetaMask/metamask-extension/pull/25404))
- feat: add a new event to track ([#25486](https://github.com/MetaMask/metamask-extension/pull/25486))
- chore(deps): bump keyring-controller and signature-controller ([#25033](https://github.com/MetaMask/metamask-extension/pull/25033))
- chore: Create a story for TokenInput component ([#25237](https://github.com/MetaMask/metamask-extension/pull/25237))
- feat: add api spec test infrastructure ([#24132](https://github.com/MetaMask/metamask-extension/pull/24132))
- feat: add new `useMultichainSelector` ([#25423](https://github.com/MetaMask/metamask-extension/pull/25423))
- chore: move keyring snap permissions file ([#25491](https://github.com/MetaMask/metamask-extension/pull/25491))
- refactor: Replace Typography with Text component in recovery-phrase-chips.js ([#25176](https://github.com/MetaMask/metamask-extension/pull/25176))
- test: e2e request queue manually switch network ([#25271](https://github.com/MetaMask/metamask-extension/pull/25271))
- fix: #25189 - Display network badge for send flow asset ([#25470](https://github.com/MetaMask/metamask-extension/pull/25470))
- fix(ci): Restrict test-e2e-firefox-flask & test-e2e-firefox-confirmation-redesign jobs to develop, master, and release branches ([#25469](https://github.com/MetaMask/metamask-extension/pull/25469))
- test: Simplify Jest config and expand coverage ([#25013](https://github.com/MetaMask/metamask-extension/pull/25013))
- fix: flaky test screenshot for `Increase Token Allowance increases token spending cap to allow other accounts to transfer tokens ` ([#25324](https://github.com/MetaMask/metamask-extension/pull/25324))
- fix: fix large amount display ([#25464](https://github.com/MetaMask/metamask-extension/pull/25464))
- chore: replace typography with text component in actionable-message and icon stories ([#25228](https://github.com/MetaMask/metamask-extension/pull/25228))
- ci: Adding node-linux-medium executor ([#25476](https://github.com/MetaMask/metamask-extension/pull/25476))
- chore: Bump Firefox outdated browser version ([#25365](https://github.com/MetaMask/metamask-extension/pull/25365))
- feat: Convert Metamask controller actions tests from mocha to jest ([#25336](https://github.com/MetaMask/metamask-extension/pull/25336))
- chore: Fix boolean setting for `ENABLE_CONFIRMATION_REDESIGN` on `config.yml` ([#25485](https://github.com/MetaMask/metamask-extension/pull/25485))
- fix: ellipsify long NFT IDs ([#25479](https://github.com/MetaMask/metamask-extension/pull/25479))
- fix: disable unsupported swap+send networks ([#25474](https://github.com/MetaMask/metamask-extension/pull/25474))
- fix: disable multiple send transactions ([#25468](https://github.com/MetaMask/metamask-extension/pull/25468))
- fix: flaky test `Settings Redirects to ENS domains when user inputs ENS into address bar` ([#24898](https://github.com/MetaMask/metamask-extension/pull/24898))
- fix: issue where queued request counts were not included in logic to reroute from home screen and close notification ([#25454](https://github.com/MetaMask/metamask-extension/pull/25454))
- feat(multichain): add BalancesController ([#25257](https://github.com/MetaMask/metamask-extension/pull/25257))
- feat: add alerts for redesigned contract interaction confirmation ([#25174](https://github.com/MetaMask/metamask-extension/pull/25174))
- fix: filter eth request to non-EVM accounts  ([#25003](https://github.com/MetaMask/metamask-extension/pull/25003))
- fix: flaky test `vault-decryption` due to autodetect NFT and tokens overlaying modals ([#25466](https://github.com/MetaMask/metamask-extension/pull/25466))
- feat: edit custom network flow ([#25272](https://github.com/MetaMask/metamask-extension/pull/25272))
- fix: Preventing a routechange to the Metametrics Onboarding page on wallet creation ([#25344](https://github.com/MetaMask/metamask-extension/pull/25344))
- feat: Artifact screenshots per open tab ([#25453](https://github.com/MetaMask/metamask-extension/pull/25453))
- fix: locked app header styling and connection link ([#25326](https://github.com/MetaMask/metamask-extension/pull/25326))
- feat: show paymaster address in redesigned contract interaction ([#25396](https://github.com/MetaMask/metamask-extension/pull/25396))
- test: Store artifacts for `test-e2e-chrome-vault-decryption` tests ([#24030](https://github.com/MetaMask/metamask-extension/pull/24030))
- fix: Permit signature re-design papercuts ([#25383](https://github.com/MetaMask/metamask-extension/pull/25383))
- feat: refactor e2e wallet rendered helper function ([#25352](https://github.com/MetaMask/metamask-extension/pull/25352))
- fix: capturing primaryType of typed signature messages in metrics ([#25384](https://github.com/MetaMask/metamask-extension/pull/25384))
- fix: flaky test `vault-decrypt` by removing driver navigate to open a new window ([#25443](https://github.com/MetaMask/metamask-extension/pull/25443))
- feat: Convert Detect multiple instances tests from mocha to jest ([#25331](https://github.com/MetaMask/metamask-extension/pull/25331))
- feat: percentage increase feature ([#24223](https://github.com/MetaMask/metamask-extension/pull/24223))
- chore: migrate swaps controller to typescript ([#25063](https://github.com/MetaMask/metamask-extension/pull/25063))
- feat(23946): Add advanced details component ([#24833](https://github.com/MetaMask/metamask-extension/pull/24833))
- fix: Don't ignore Yarn patch files ([#25398](https://github.com/MetaMask/metamask-extension/pull/25398))
- chore: remove repetitive words ([#23421](https://github.com/MetaMask/metamask-extension/pull/23421))
- feat: Bump `queued-request-controller` to `^1.0.0` ([#25310](https://github.com/MetaMask/metamask-extension/pull/25310))
- feat: split ConfirmPage storybook pages by transaction type ([#25283](https://github.com/MetaMask/metamask-extension/pull/25283))
- fix: fix usd amount in swap notifications ([#25444](https://github.com/MetaMask/metamask-extension/pull/25444))
- fix: handle long nft ids in simulation amount pill ([#25252](https://github.com/MetaMask/metamask-extension/pull/25252))
- fix: fix linea ticker ([#25436](https://github.com/MetaMask/metamask-extension/pull/25436))
- chore: update mmi circleCi config PW step ([#25440](https://github.com/MetaMask/metamask-extension/pull/25440))
- feat: update blockaid to version 1.4.8 ([#25439](https://github.com/MetaMask/metamask-extension/pull/25439))
- feat: add rates controller ([#25314](https://github.com/MetaMask/metamask-extension/pull/25314))
- chore: update channel for contact MMI team and CircleCI step ([#25247](https://github.com/MetaMask/metamask-extension/pull/25247))
- test: [Snaps E2E] Create test for snaps interactive ui functions ([#24884](https://github.com/MetaMask/metamask-extension/pull/24884))
- fix: fix a delay on the account toggles ([#25428](https://github.com/MetaMask/metamask-extension/pull/25428))
- fix: Update Beta build configuration ([#25430](https://github.com/MetaMask/metamask-extension/pull/25430))
- feat: fetch nfts on components ([#24547](https://github.com/MetaMask/metamask-extension/pull/24547))
- feat(mmi): start implementing mmi ofa feature ([#24749](https://github.com/MetaMask/metamask-extension/pull/24749))
- fix: Disable Smart Transactions for the new Send&Swap feature ([#25422](https://github.com/MetaMask/metamask-extension/pull/25422))
- feat: Convert Swaps test from mocha to jest ([#25297](https://github.com/MetaMask/metamask-extension/pull/25297))
- fix: copy changes in re-designed SIWE signature pages ([#25381](https://github.com/MetaMask/metamask-extension/pull/25381))
- chore: Bump Snaps packages ([#25292](https://github.com/MetaMask/metamask-extension/pull/25292))
- test: use tsx for E2E tests instead of ts-node ([#25399](https://github.com/MetaMask/metamask-extension/pull/25399))
- fix: hide mark all as read button with no uread notifications ([#25348](https://github.com/MetaMask/metamask-extension/pull/25348))
- feat: add custom network modal form ([#25213](https://github.com/MetaMask/metamask-extension/pull/25213))
- test: fix flaky tests that fail due to sentry's `sendClientReports` setting ([#25235](https://github.com/MetaMask/metamask-extension/pull/25235))
- feat: Network buttons during advanced onboarding ([#25276](https://github.com/MetaMask/metamask-extension/pull/25276))
- feat: multi RPC editor ([#25219](https://github.com/MetaMask/metamask-extension/pull/25219))
- fix: Fix unit and e2e tests that were expected the date based privacy policy components to not be shown ([#25390](https://github.com/MetaMask/metamask-extension/pull/25390))
- fix: Improve stability of initial state sync in Snaps UI ([#25375](https://github.com/MetaMask/metamask-extension/pull/25375))
- fix(25335): fix flaky test "Unlock wallet should send first three Page metric events upon fullscreen page load" ([#25351](https://github.com/MetaMask/metamask-extension/pull/25351))
- feat: Update the counter over the fox to handle notifications ([#25093](https://github.com/MetaMask/metamask-extension/pull/25093))
- fix: logic for using notifications tabs ([#25350](https://github.com/MetaMask/metamask-extension/pull/25350))
- chore: Refactor offscreen creation logic ([#25302](https://github.com/MetaMask/metamask-extension/pull/25302))
- fix: failing push notifications ([#25340](https://github.com/MetaMask/metamask-extension/pull/25340))
- fix: display the correct symbol of a native currency ([#25364](https://github.com/MetaMask/metamask-extension/pull/25364))
- fix: typo in proposed nickname settings  ([#23562](https://github.com/MetaMask/metamask-extension/pull/23562))
- fix: upgrade dependency ws ([#25372](https://github.com/MetaMask/metamask-extension/pull/25372))
- fix: swap+send bugs in Version v12.0.0 release ([#25307](https://github.com/MetaMask/metamask-extension/pull/25307))
- fix: re-add patch to nonce-tracker that was incorrectly removed ([#25342](https://github.com/MetaMask/metamask-extension/pull/25342))
- fix: Confirmation bridge verify backend ([#25047](https://github.com/MetaMask/metamask-extension/pull/25047))
- feat: Convert MetaMetricsController tests from mocha to jest ([#25210](https://github.com/MetaMask/metamask-extension/pull/25210))
- fix: flaky test `vault decrypt` due to SRP hold time ([#25328](https://github.com/MetaMask/metamask-extension/pull/25328))
- feat: Add team label to pr ([#25208](https://github.com/MetaMask/metamask-extension/pull/25208))
- fix: use a min-width value in the notifications-tag-counter ([#25322](https://github.com/MetaMask/metamask-extension/pull/25322))
- fix: filter only EVM address when calling syncWithAddresses ([#25313](https://github.com/MetaMask/metamask-extension/pull/25313))
- fix: flaky test `Navigate transactions should reject and remove all unapproved transactions` ([#25312](https://github.com/MetaMask/metamask-extension/pull/25312))
- fix: Fix switch network popup ([#25299](https://github.com/MetaMask/metamask-extension/pull/25299))
- fix: flaky test `should not prevent network requests to basic functionality endpoints when the basica functionality toggle is on` ([#25316](https://github.com/MetaMask/metamask-extension/pull/25316))
- fix: notification detail network fee broke application ([#25315](https://github.com/MetaMask/metamask-extension/pull/25315))
- refactor: use new multichain selectors in accounts related components ([#25290](https://github.com/MetaMask/metamask-extension/pull/25290))
- feat: filter eth requests for non-EVM accounts ([#25038](https://github.com/MetaMask/metamask-extension/pull/25038))
- refactor: Part of #17670 - Replace Typography with Text component in ui/components/ui/chip/chip.js ([#25017](https://github.com/MetaMask/metamask-extension/pull/25017))
- refactor: Migrate Typography to Text component in definition-list.js and contract-token-values.js ([#25050](https://github.com/MetaMask/metamask-extension/pull/25050))
- fix: flaky test `Custom network JSON-RPC API should show warning when adding chainId ` ([#25294](https://github.com/MetaMask/metamask-extension/pull/25294))
- fix: flaky test `Full-size View Setting @no-mmi opens the extension in popup view when opened from a dapp after enabling it in Advanced Settings` ([#25295](https://github.com/MetaMask/metamask-extension/pull/25295))
- chore: revert recent gas api endpoint changes ([#25230](https://github.com/MetaMask/metamask-extension/pull/25230))
- refactor: Replace Typography with Text component in skip-srp-backup-popover.js ([#25149](https://github.com/MetaMask/metamask-extension/pull/25149))
- refactor: Part of #17670- Replace Typography with Text component in confirm-recovery-phrase.js ([#25019](https://github.com/MetaMask/metamask-extension/pull/25019))
- feat: Use sandboxed pages for Snaps execution in MV3 ([#25171](https://github.com/MetaMask/metamask-extension/pull/25171))
- fix: fix token detection modal stuck on firefox ([#25279](https://github.com/MetaMask/metamask-extension/pull/25279))
- feat: add search feature ([#25170](https://github.com/MetaMask/metamask-extension/pull/25170))
- chore: bump keyring-api and eth-snap-keyring ([#25287](https://github.com/MetaMask/metamask-extension/pull/25287))
- feat: SIWE sign message section ([#24997](https://github.com/MetaMask/metamask-extension/pull/24997))
- fix: flaky test `Send NFT should not be able to send ERC1155 NFT with invalid amount` ([#25289](https://github.com/MetaMask/metamask-extension/pull/25289))
- fix: flaky test `ENS domain resolves to a correct address` ([#25248](https://github.com/MetaMask/metamask-extension/pull/25248))
- fix: notification dates edge case ([#25148](https://github.com/MetaMask/metamask-extension/pull/25148))
- fix: Simulations on signature pages should be displayed only if preference is enabled ([#25186](https://github.com/MetaMask/metamask-extension/pull/25186))
- fix: fix typo in pre-build-mv2 and changed value of ENABLE_CONFIRMATION_REDESIGN ([#25258](https://github.com/MetaMask/metamask-extension/pull/25258))
- fix: bump `SelectedNetworkController` to fix issue where selected network domain is incorrectly set ([#25106](https://github.com/MetaMask/metamask-extension/pull/25106))
- fix: swap+send e2e tests ([#25275](https://github.com/MetaMask/metamask-extension/pull/25275))
- fix: issue where user rejected request errors are not correctly handled in either wallet_switchEthereumChain nor wallet_addEthereumChain calls ([#25269](https://github.com/MetaMask/metamask-extension/pull/25269))
- chore(deps): Bump base-controller to ^5.0.1 ([#24209](https://github.com/MetaMask/metamask-extension/pull/24209))
- fix: hide privacy policy toast during onboarding, and for onboarded users ([#25217](https://github.com/MetaMask/metamask-extension/pull/25217))
- fix: Retry requests from provider after connection is ready, on all builds ([#24142](https://github.com/MetaMask/metamask-extension/pull/24142))
- fix: add metrics ui_customizations: permit for permit signature types ([#25105](https://github.com/MetaMask/metamask-extension/pull/25105))
- chore: updating failing snapshot in develop ([#25261](https://github.com/MetaMask/metamask-extension/pull/25261))
- test: add missing mocks for aggregator metadata, block list and include blocked tokens in all tests ([#25206](https://github.com/MetaMask/metamask-extension/pull/25206))
- fix: flaky test `Change assets changes to native currency when switching accounts during a NFT send` ([#25220](https://github.com/MetaMask/metamask-extension/pull/25220))
- chore: add Non-EVM feature flag ([#25241](https://github.com/MetaMask/metamask-extension/pull/25241))
- feat: Integrate SIP-12 update ([#23697](https://github.com/MetaMask/metamask-extension/pull/23697))
- feat: adds "data collection for marketing" toggles ([#24605](https://github.com/MetaMask/metamask-extension/pull/24605))
- refactor: app header ([#25143](https://github.com/MetaMask/metamask-extension/pull/25143))
- feat: permit signature copy changes ([#24975](https://github.com/MetaMask/metamask-extension/pull/24975))
- feat: permit signature simulation info ([#24862](https://github.com/MetaMask/metamask-extension/pull/24862))
- feat: Support various redesign signatures in ConfirmPage Storybook ([#25054](https://github.com/MetaMask/metamask-extension/pull/25054))
- fix: UX: NetworkList: Consolidate NetworkListItem usages ([#25195](https://github.com/MetaMask/metamask-extension/pull/25195))
- fix: add deprecated tag back to callBackgroundMethod ([#25216](https://github.com/MetaMask/metamask-extension/pull/25216))
- feat: add popular network list modal ([#25160](https://github.com/MetaMask/metamask-extension/pull/25160))
- chore: upgrading to design tokens v4 ([#24953](https://github.com/MetaMask/metamask-extension/pull/24953))
- fix: Swap-Send flaky test fix ([#25041](https://github.com/MetaMask/metamask-extension/pull/25041))
- feat(multichain): add new selectors ([#25205](https://github.com/MetaMask/metamask-extension/pull/25205))
- fix: updates MMI e2e confirm transaction flow ([#25053](https://github.com/MetaMask/metamask-extension/pull/25053))
- feat: adding pluggable section to confirmation page ([#25061](https://github.com/MetaMask/metamask-extension/pull/25061))
- fix: Disable MV3 for MV2 Flask production build ([#25209](https://github.com/MetaMask/metamask-extension/pull/25209))
- fix: addressing feedbacks in typed sign alerts ([#25163](https://github.com/MetaMask/metamask-extension/pull/25163))
- feat: update @blockaid/ppom_release to version 1.4.7 ([#25173](https://github.com/MetaMask/metamask-extension/pull/25173))
- chore(deps): bump accounts-controller to version 16.0.0 ([#25201](https://github.com/MetaMask/metamask-extension/pull/25201))
- test: improve logInWithBalanceValidation function in e2e test ([#25139](https://github.com/MetaMask/metamask-extension/pull/25139))
- chore: Add ability to have front-end, local feature flags ([#25179](https://github.com/MetaMask/metamask-extension/pull/25179))
- fix(deps): bump `grpc-js` from 1.9.14 to 1.9.15 ([#25199](https://github.com/MetaMask/metamask-extension/pull/25199))
- fix: flaky test `lockdown the UI and background environments are locked down` ([#25164](https://github.com/MetaMask/metamask-extension/pull/25164))
- chore: removing deprecated secondary colors from codebase ([#24971](https://github.com/MetaMask/metamask-extension/pull/24971))
- chore: refactoring opacity tokens and removing and adding some colors ([#25158](https://github.com/MetaMask/metamask-extension/pull/25158))
- fix: hardware wallet e2e test mv3 support ([#25039](https://github.com/MetaMask/metamask-extension/pull/25039))
- feat: new asset details page ([#24522](https://github.com/MetaMask/metamask-extension/pull/24522))
- fix(notifications): Ensure notifications feature is disabled/hidden when no basic functionality ([#25070](https://github.com/MetaMask/metamask-extension/pull/25070))
- chore: remove update-attributions.yml ([#25180](https://github.com/MetaMask/metamask-extension/pull/25180))
- refactor: remove desktop support ([#25147](https://github.com/MetaMask/metamask-extension/pull/25147))
- docs: Updated the steps to trigger error and settings ([#25076](https://github.com/MetaMask/metamask-extension/pull/25076))
- fix: Update PPOM controller to fix handling of HTTP status codes ([#25136](https://github.com/MetaMask/metamask-extension/pull/25136))
- chore: adding storybook stories ([#25083](https://github.com/MetaMask/metamask-extension/pull/25083))
- fix: flaky test `chrome-vault-decryption` ([#25145](https://github.com/MetaMask/metamask-extension/pull/25145))
- fix: resolve all known swap+send bugs ([#25100](https://github.com/MetaMask/metamask-extension/pull/25100))
- chore: removing deprecated button color css variables ([#25125](https://github.com/MetaMask/metamask-extension/pull/25125))
- chore: removing warning alternative color from codebase ([#25010](https://github.com/MetaMask/metamask-extension/pull/25010))
- chore: refactoring institutional qr code modal ([#25011](https://github.com/MetaMask/metamask-extension/pull/25011))
- chore: add swap+send analytics ([#25078](https://github.com/MetaMask/metamask-extension/pull/25078))
- fix: re-enable swap-send-eth e2e test ([#24882](https://github.com/MetaMask/metamask-extension/pull/24882))
- fix: Remove MULTICHAIN flag and CI job ([#25104](https://github.com/MetaMask/metamask-extension/pull/25104))
- fix: yarn download-builds stopped working ([#24931](https://github.com/MetaMask/metamask-extension/pull/24931))
- chore: removing deprecated info colors from codebase ([#25124](https://github.com/MetaMask/metamask-extension/pull/25124))
- chore: update swaps blockedList api url ([#24837](https://github.com/MetaMask/metamask-extension/pull/24837))
- fix: Remove unwanted MULTICHAIN feature usages in tests ([#24831](https://github.com/MetaMask/metamask-extension/pull/24831))
- fix: Remove old What's New messages ([#25048](https://github.com/MetaMask/metamask-extension/pull/25048))
- chore: Bump `@metamask/permission-controller` to `9.1.0` ([#24834](https://github.com/MetaMask/metamask-extension/pull/24834))
- chore: remove deprecated success colors ([#25122](https://github.com/MetaMask/metamask-extension/pull/25122))
- fix: Update filtering of STX for the Activity list ([#24540](https://github.com/MetaMask/metamask-extension/pull/24540))
- refactor: coin-overview ([#25096](https://github.com/MetaMask/metamask-extension/pull/25096))
- fix: Notifications platform links ([#24708](https://github.com/MetaMask/metamask-extension/pull/24708))
- Merge branch 'develop' into fix-auto-lock-timer
- fix: Avoid to send the snap notification id to the notifications server ([#25099](https://github.com/MetaMask/metamask-extension/pull/25099))
- Update ui/store/actions.ts
- Add comment explaining the temporary fix of a type conversion
- fix: flaky test `Sentry errors after initialization, after opting into metrics @no-mmi should capture UI application state` ([#25137](https://github.com/MetaMask/metamask-extension/pull/25137))
- fix: deprecating more networks ([#24994](https://github.com/MetaMask/metamask-extension/pull/24994))
- feat(mmi): improve custody icons when dark/light mode ([#25088](https://github.com/MetaMask/metamask-extension/pull/25088))
- fix: bug report template - remove reference to recordit ([#25108](https://github.com/MetaMask/metamask-extension/pull/25108))
- chore: only runs when RUN_MMI_OPTIONAL is true ([#25103](https://github.com/MetaMask/metamask-extension/pull/25103))
- Add unit test
- Fix auto lock timer call
...
[12.4.0]: https://github.com/MetaMask/metamask-extension/compare/v11.16.15...v12.4.0
