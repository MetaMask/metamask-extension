...
- Dark Mode: Remove feature flag ([#14207](https://github.com/MetaMask/metamask-extension/pull/14207))
...
- Add snaps search ([#14100](https://github.com/MetaMask/metamask-extension/pull/14100))
...
- speedup transaction: save on advance gas modal should not close speed… ([#14101](https://github.com/MetaMask/metamask-extension/pull/14101))
...
- fix: typo in messages.json ([#14067](https://github.com/MetaMask/metamask-extension/pull/14067))
...
- Fix token icon when going from token detail to swaps ([#14062](https://github.com/MetaMask/metamask-extension/pull/14062))
...
- ToggleButton: Use label so users can click text ([#13876](https://github.com/MetaMask/metamask-extension/pull/13876))
- Fix issue where we show contract address as recipient when calling safe transfer method on erc721 or erc1155 contracts ([#13535](https://github.com/MetaMask/metamask-extension/pull/13535))
...
- Add native browser notification support for Snaps ([#13613](https://github.com/MetaMask/metamask-extension/pull/13613))
