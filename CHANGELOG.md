...
## [12.14.0]
### Added
- Added Unichain logo ([#30361](https://github.com/MetaMask/metamask-extension/pull/30361))
- Integrated multichain assets rates controller to extension UI ([#30291](https://github.com/MetaMask/metamask-extension/pull/30291))
- Integrated SPL tokens and rates from multichainAssetsRates ([#30389](https://github.com/MetaMask/metamask-extension/pull/30389))
- Enabled switching between EVM and non-EVM networks within Bridge experience ([#30595](https://github.com/MetaMask/metamask-extension/pull/30595))
- Calculated Solana quote fees ([#30574](https://github.com/MetaMask/metamask-extension/pull/30574))
- Tracked Solana bridge transactions ([#30619](https://github.com/MetaMask/metamask-extension/pull/30619))
- Added fetching for Solana quotes, account picker, and quote card ([#30452](https://github.com/MetaMask/metamask-extension/pull/30452))
- Fixed Solana snap validation ([#30596](https://github.com/MetaMask/metamask-extension/pull/30596))
- Converted non-EVM amounts to fiat ([#30568](https://github.com/MetaMask/metamask-extension/pull/30568))
- Fetched non-EVM token list and refreshed quote rates ([#30567](https://github.com/MetaMask/metamask-extension/pull/30567))
- Implemented submission of multichain transactions ([#30416](https://github.com/MetaMask/metamask-extension/pull/30416))
- Added modal to include metric ID before redirecting to the support page ([#30415](https://github.com/MetaMask/metamask-extension/pull/30415))
- Added UI preparation changes for multichain connection flow ([#30164](https://github.com/MetaMask/metamask-extension/pull/30164))

### Changed
- Improved account sync with primary SRP filtering, bulk account creation, and removed synced accounts limit ([#30529](https://github.com/MetaMask/metamask-extension/pull/30529))
- Bumped Snaps dependencies ([#30396](https://github.com/MetaMask/metamask-extension/pull/30396))
- Set swap input parameters ([#30284](https://github.com/MetaMask/metamask-extension/pull/30284))
- Adjusted swap input selection defaults ([#30600](https://github.com/MetaMask/metamask-extension/pull/30600))
- Refactored asset picker to support non-EVM tokens ([#30313](https://github.com/MetaMask/metamask-extension/pull/30313))
- Handled `displayAccountNameSuggestion` flag in Snap Keyring ([#30531](https://github.com/MetaMask/metamask-extension/pull/30531))
- Removed supported chains check ([#29773](https://github.com/MetaMask/metamask-extension/pull/29773))
- Revised list of supported currencies ([#30324](https://github.com/MetaMask/metamask-extension/pull/30324))
- Hid non-zero hex data alert for contract deployment confirmations ([#30474](https://github.com/MetaMask/metamask-extension/pull/30474))
- Allowed `snap_experimentalProviderRequest` as an unrestricted method ([#30525](https://github.com/MetaMask/metamask-extension/pull/30525))
- Updated slides descriptions ([#30270](https://github.com/MetaMask/metamask-extension/pull/30270))
- Tweaked threshold settings on Coin Overview for Flask build ([#30585](https://github.com/MetaMask/metamask-extension/pull/30585))
- Cleared transaction data after submission or cancellation ([#30546](https://github.com/MetaMask/metamask-extension/pull/30546))
- Ensured swap-send decimals are rounded correctly in Firefox ([#30593](https://github.com/MetaMask/metamask-extension/pull/30593))
- Refreshed activity page upon specific events ([#30571](https://github.com/MetaMask/metamask-extension/pull/30571))
- Excluded smart transaction status page from rate limiting ([#30537](https://github.com/MetaMask/metamask-extension/pull/30537))
- Improved performance by preventing unnecessary AddressCopyButton re-renders ([#30289](https://github.com/MetaMask/metamask-extension/pull/30289))

### Fixed
- Fixed swap source token balance on multichain networks ([#30622](https://github.com/MetaMask/metamask-extension/pull/30622))
- Fixed network switch issue on dApps ([#30211](https://github.com/MetaMask/metamask-extension/pull/30211))
- Fixed spinner display in NFT tab ([#30427](https://github.com/MetaMask/metamask-extension/pull/30427))
- Fixed chain ID inconsistency between NFT and global settings ([#30517](https://github.com/MetaMask/metamask-extension/pull/30517))
- Fixed "Send Max" behavior when gas value changes ([#30523](https://github.com/MetaMask/metamask-extension/pull/30523))
- Fixed fetching of quotes when source amount's decimals exceed token's decimals ([#29990](https://github.com/MetaMask/metamask-extension/pull/29990))
- Fixed critical error message visibility in dark mode ([#30570](https://github.com/MetaMask/metamask-extension/pull/30570))
- Fixed text visibility issues on the error page in dark mode ([#30408](https://github.com/MetaMask/metamask-extension/pull/30408))
- Fixed page reload issue during SRP creation ([#30178](https://github.com/MetaMask/metamask-extension/pull/30178))
