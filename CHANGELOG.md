...
- chore: cp-12.14.0 add a migration script to include the MegaETH network in the installed extension ([#30895](https://github.com/MetaMask/metamask-extension/pull/30895))
...
- chore: Update MegaETH logo ([#30883](https://github.com/MetaMask/metamask-extension/pull/30883))
...
- feat: Add MegaETH Testnet as a default test network ([#30871](https://github.com/MetaMask/metamask-extension/pull/30871))
...
- fix: swap src token balance on multichain network ([#30622](https://github.com/MetaMask/metamask-extension/pull/30622))
- feat: track sol bridge txs ([#30619](https://github.com/MetaMask/metamask-extension/pull/30619))
- chore: swap input selection defaults ([#30600](https://github.com/MetaMask/metamask-extension/pull/30600))
- feat: calculate solana quote fees ([#30574](https://github.com/MetaMask/metamask-extension/pull/30574))
...
- feat(multi-srp): add number_of_hd_entropies metrics user trait ([#30392](https://github.com/MetaMask/metamask-extension/pull/30392))
- chore: switch between evm<>non-evm networks within Bridge experience ([#30595](https://github.com/MetaMask/metamask-extension/pull/30595))
- chore: clean up old solana values ([#30609](https://github.com/MetaMask/metamask-extension/pull/30609))
- chore: bump `@metamask/accounts-controller` to `^24.1.0` ([#30587](https://github.com/MetaMask/metamask-extension/pull/30587))
- fix: Tweak threshold on coin-overview flask build ([#30585](https://github.com/MetaMask/metamask-extension/pull/30585))
- chore: updates solana snap version ([#30606](https://github.com/MetaMask/metamask-extension/pull/30606))
- feat: add entropySource to non-evm accounts ([#30549](https://github.com/MetaMask/metamask-extension/pull/30549))
- fix: Solana snap validation ([#30596](https://github.com/MetaMask/metamask-extension/pull/30596))
- style: apply Prettier to md, mdx, and yml files ([#30440](https://github.com/MetaMask/metamask-extension/pull/30440))
- fix: cp-12.13.0 replace 3D flask mascot with 2D version ([#30592](https://github.com/MetaMask/metamask-extension/pull/30592))
- fix: swap-send decimals should be rounded in firefox ([#30593](https://github.com/MetaMask/metamask-extension/pull/30593))
- feat: fetch non-evm token list and quote refresh rates ([#30567](https://github.com/MetaMask/metamask-extension/pull/30567))
- fix(30583): broken gha check template and labels ([#30584](https://github.com/MetaMask/metamask-extension/pull/30584))
- feat: firefox-bundle-script ([#30476](https://github.com/MetaMask/metamask-extension/pull/30476))
- chore: cp-12.13.0 remove SRP video ([#30586](https://github.com/MetaMask/metamask-extension/pull/30586))
- feat: convert non-evm amounts to fiat ([#30568](https://github.com/MetaMask/metamask-extension/pull/30568))
- feat: fetch sol quotes + account picker and quote card ([#30452](https://github.com/MetaMask/metamask-extension/pull/30452))
- chore: keyring api bump ([#30576](https://github.com/MetaMask/metamask-extension/pull/30576))
- feat: add metrics to carousel banner ([#30405](https://github.com/MetaMask/metamask-extension/pull/30405))
- fix: exclude smart transaction status page from rate limiting ([#30537](https://github.com/MetaMask/metamask-extension/pull/30537))
- fix: Fix send max on gas value changes ([#30523](https://github.com/MetaMask/metamask-extension/pull/30523))
- feat: Aggregated multichain balance (Flask) ([#30516](https://github.com/MetaMask/metamask-extension/pull/30516))
- fix(30371): refresh activity page ([#30571](https://github.com/MetaMask/metamask-extension/pull/30571))
- fix: critical error message visibility bug in dark mode ([#30570](https://github.com/MetaMask/metamask-extension/pull/30570))
- refactor: support non-evm tokens in asset-picker ([#30313](https://github.com/MetaMask/metamask-extension/pull/30313))
- fix: upgrade assets controllers to v51.0.2 ([#30563](https://github.com/MetaMask/metamask-extension/pull/30563))
- feat: bump notifications services controller to v1.0.0 ([#30532](https://github.com/MetaMask/metamask-extension/pull/30532))
- refactor: refactor network picker ([#30433](https://github.com/MetaMask/metamask-extension/pull/30433))
- chore: Expose extension ID to E2E tests ([#30539](https://github.com/MetaMask/metamask-extension/pull/30539))
- feat(ci): Auto add needs-triage label on bug open ([#30512](https://github.com/MetaMask/metamask-extension/pull/30512))
- fix: clear transaction data after submission or cancellation ([#30546](https://github.com/MetaMask/metamask-extension/pull/30546))
- fix: Add `snap_experimentalProviderRequest` to unrestricted methods ([#30525](https://github.com/MetaMask/metamask-extension/pull/30525))
- feat: replace experimental add solana account with remote flag ([#30487](https://github.com/MetaMask/metamask-extension/pull/30487))
- feat(snap-keyring): handle `displayAccountNameSuggestion` flag ([#30531](https://github.com/MetaMask/metamask-extension/pull/30531))
- fix: Nft chainId and current global chainId arent always the same ([#30517](https://github.com/MetaMask/metamask-extension/pull/30517))
- feat(multichain-connect-ui): Add UI preparation changes for multichain connection flow ([#30164](https://github.com/MetaMask/metamask-extension/pull/30164))
- refactor: Use browser.runtime.onInstalled instead of a check for empty storage,… ([#29826](https://github.com/MetaMask/metamask-extension/pull/29826))
- feat: account sync - primary SRP filtering, bulk accounts creation and synced accounts limit removal #30317 ([#30529](https://github.com/MetaMask/metamask-extension/pull/30529))
- feat: beta support link ([#30482](https://github.com/MetaMask/metamask-extension/pull/30482))
- feat: Integrate SPL tokens and rates from multichainAssetsRates ([#30389](https://github.com/MetaMask/metamask-extension/pull/30389))
- refactor: bridge support for CAIP chainIds and non-hex addresses ([#30305](https://github.com/MetaMask/metamask-extension/pull/30305))
- fix: Hide non-zero hex data alert for contract deployment confirmations ([#30474](https://github.com/MetaMask/metamask-extension/pull/30474))
- feat(3765): Add modal to include metric id before redirecting to support page ([#30415](https://github.com/MetaMask/metamask-extension/pull/30415))
- chore: adds the multichain and solana fence to the needed places ([#30485](https://github.com/MetaMask/metamask-extension/pull/30485))
- feat(multichain): add block explorer format URLs ([#30085](https://github.com/MetaMask/metamask-extension/pull/30085))
- chore: assets controller package update ([#30526](https://github.com/MetaMask/metamask-extension/pull/30526))
- chore: multichain tx package update ([#30499](https://github.com/MetaMask/metamask-extension/pull/30499))
- feat: add multi-srp support to the background script ([#29942](https://github.com/MetaMask/metamask-extension/pull/29942))
- fix: Handle nullish value in `alphanumeric sort` ([#30500](https://github.com/MetaMask/metamask-extension/pull/30500))
- chore(bitcoin): add bitcoin build feature + disable it temporarily ([#30477](https://github.com/MetaMask/metamask-extension/pull/30477))
- feat: make Snap account creation flow async ([#30406](https://github.com/MetaMask/metamask-extension/pull/30406))
- fix: flaky tests `Confirmation Redesign Token Send ERC1155 Wallet initiated...` ([#30481](https://github.com/MetaMask/metamask-extension/pull/30481))
- fix: Fix attribution generation ([#30498](https://github.com/MetaMask/metamask-extension/pull/30498))
- fix: Add transaction simulation supported networks global mock ([#30507](https://github.com/MetaMask/metamask-extension/pull/30507))
- test: adds Anvil classes + Viem and migrates first specs from Ganache to Anvil ([#27246](https://github.com/MetaMask/metamask-extension/pull/27246))
- feat(27255): allow local modification for remote feature flags ([#29696](https://github.com/MetaMask/metamask-extension/pull/29696))
- refactor: remove circular dependency from `confirm-alert-model.tsx` ([#30453](https://github.com/MetaMask/metamask-extension/pull/30453))
- refactor: remove circular dependencies from `ui/components/*` ([#30457](https://github.com/MetaMask/metamask-extension/pull/30457))
- fix(25182): reloading page during SRP creation breaks flow ([#30178](https://github.com/MetaMask/metamask-extension/pull/30178))
- refactor: remove circular dependencies from `account-picker.tsx` ([#30455](https://github.com/MetaMask/metamask-extension/pull/30455))
- refactor: remove circular dependency from `notifications.tsx` and `notifications-list.tsx` ([#30450](https://github.com/MetaMask/metamask-extension/pull/30450))
- refactor: remove circular dependency in `name-details.tsx` ([#30414](https://github.com/MetaMask/metamask-extension/pull/30414))
- refactor: Expose E2E Chrome driver extension ID ([#30444](https://github.com/MetaMask/metamask-extension/pull/30444))
- fix: flaky test `Full-size View Setting opens the extension in popup view when opened from a dapp after enabling it in Advanced Settings` ([#30466](https://github.com/MetaMask/metamask-extension/pull/30466))
- chore: bump @metamask/utils to 11.1.0 ([#30467](https://github.com/MetaMask/metamask-extension/pull/30467))
- feat: re-enable account syncing ([#30464](https://github.com/MetaMask/metamask-extension/pull/30464))
- chore: Remove unnecessary resolutions ([#30446](https://github.com/MetaMask/metamask-extension/pull/30446))
- refactor: remove circular dependencies in `ui/pages/snap-account-redirect/*` ([#30279](https://github.com/MetaMask/metamask-extension/pull/30279))
- fix: cp-12.13.0 Disable origin throttling middleware if cause is "rejectAllApprovals" ([#30388](https://github.com/MetaMask/metamask-extension/pull/30388))
- fix: flaky test `Speed Up and Cancel Transaction Tests Cancel transaction Successfully cancels a pending transaction` ([#30435](https://github.com/MetaMask/metamask-extension/pull/30435))
- refactor: remove circular dependency between `actions.ts` and `swaps.util.ts` ([#30306](https://github.com/MetaMask/metamask-extension/pull/30306))
- fix: cp-12.13.0 fixes drag and drop in network list menu modal ([#30437](https://github.com/MetaMask/metamask-extension/pull/30437))
- fix: text visibility issues in error page in dark mode ([#30408](https://github.com/MetaMask/metamask-extension/pull/30408))
- chore: set swap input parameters ([#30284](https://github.com/MetaMask/metamask-extension/pull/30284))
- feat: MMS-1868 new quote card and story ([#30303](https://github.com/MetaMask/metamask-extension/pull/30303))
- fix: fix spinner display in NFT tab ([#30427](https://github.com/MetaMask/metamask-extension/pull/30427))
- chore: Bump Snaps dependencies ([#30396](https://github.com/MetaMask/metamask-extension/pull/30396))
- fix: flaky tests `Test Snap bip-44 can pop up bip-44 snap and get private key result` and others using `clickElementSafe` ([#30430](https://github.com/MetaMask/metamask-extension/pull/30430))
- chore: bump `@metamask/keyring-controller` to `^19.1.0` ([#30367](https://github.com/MetaMask/metamask-extension/pull/30367))
- feat: add `@metamask/multichain-network-controller` ([#30426](https://github.com/MetaMask/metamask-extension/pull/30426))
- feat(action): Improve bug report creation ([#30176](https://github.com/MetaMask/metamask-extension/pull/30176))
- docs: add code comments to better describe date formatting util ([#29242](https://github.com/MetaMask/metamask-extension/pull/29242))
- refactor: remove circular dependency in `token-buttons.tsx` ([#30299](https://github.com/MetaMask/metamask-extension/pull/30299))
- feat: GitHub-hosted runners for benchmarks ([#29955](https://github.com/MetaMask/metamask-extension/pull/29955))
- feat: Bump `@metamask/providers` to `^20.0.0` ([#29936](https://github.com/MetaMask/metamask-extension/pull/29936))
- fix: cp-12.13.0 fix modal scroll bar flash ([#30355](https://github.com/MetaMask/metamask-extension/pull/30355))
- feat: update slides descriptions ([#30270](https://github.com/MetaMask/metamask-extension/pull/30270))
- build: remove some unncessary autofix warnings ([#30342](https://github.com/MetaMask/metamask-extension/pull/30342))
- refactor(snap-keyring): refactor Snap keyring implementation ([#30244](https://github.com/MetaMask/metamask-extension/pull/30244))
- feat: bump notification services controller ([#30339](https://github.com/MetaMask/metamask-extension/pull/30339))
- fix: Perf: Prevent AddressCopyButton rerenders ([#30289](https://github.com/MetaMask/metamask-extension/pull/30289))
- fix: remove supported chains check ([#29773](https://github.com/MetaMask/metamask-extension/pull/29773))
- chore: adds call to the multichain transactions controller ([#30369](https://github.com/MetaMask/metamask-extension/pull/30369))
- fix: Revert "fix: Avoid nonce flicker when transaction is submitted" ([#30370](https://github.com/MetaMask/metamask-extension/pull/30370))
- fix: revisit list of currencies ([#30324](https://github.com/MetaMask/metamask-extension/pull/30324))
- fix: cp-12.13.0 dependency version ([#30375](https://github.com/MetaMask/metamask-extension/pull/30375))
- feat: integrate multichain assets rates controller to extension UI ([#30291](https://github.com/MetaMask/metamask-extension/pull/30291))
- feat: add unichain logo ([#30361](https://github.com/MetaMask/metamask-extension/pull/30361))
- fix(30190): fix flaky tests for user traits ([#30346](https://github.com/MetaMask/metamask-extension/pull/30346))
- chore: fix edge case for uploading git diff artifacts needed for POM github action and skip validation for RC ([#30295](https://github.com/MetaMask/metamask-extension/pull/30295))
- fix(snaps): Add missing controller names to `ControllersToInitialize` ([#30301](https://github.com/MetaMask/metamask-extension/pull/30301))
- feat: MMS-1872 destination account picker for sol-evm (standalone component and story) ([#30282](https://github.com/MetaMask/metamask-extension/pull/30282))
- fix: fetch quotes when src amount's decimals are greater than token's decimals ([#29990](https://github.com/MetaMask/metamask-extension/pull/29990))
- fix: Add BNB Smart Chain to Smart Transactions description in settings ([#29833](https://github.com/MetaMask/metamask-extension/pull/29833))
- chore(deps): update `express` ([#29708](https://github.com/MetaMask/metamask-extension/pull/29708))
- fix: bump assets-controllers to v49 ([#30250](https://github.com/MetaMask/metamask-extension/pull/30250))
- chore: bump `@metamask/api-specs` to `^0.10.15` ([#30273](https://github.com/MetaMask/metamask-extension/pull/30273))
- fix: flaky test `Settings Should show crypto value when price checker setting is off` antipattern ([#30318](https://github.com/MetaMask/metamask-extension/pull/30318))
- fix: fix network switch on dapp ([#30211](https://github.com/MetaMask/metamask-extension/pull/30211))
...
[12.15.0]: https://github.com/MetaMask/metamask-extension/compare/v12.14.0...v12.15.0
