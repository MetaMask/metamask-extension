...
- Implemented the Swap+Send feature, allowing users to seamlessly swap assets immediately before sending ([#23703](https://github.com/MetaMask/metamask-extension/pull/23703))
...
- Added a feature to let dApps switch Ethereum chains with user's initial permission ([#24415](https://github.com/MetaMask/metamask-extension/pull/24415))
...
- Updated the Swap+Send feature with enhancements and bug fixes, including updated API URLs, re-enabled e2e tests, added analytics, and resolved known issues ([#25152](https://github.com/MetaMask/metamask-extension/pull/25152))
- Enhanced user privacy by disabling notifications and profile syncing when basic functionality is off ([#25070](https://github.com/MetaMask/metamask-extension/pull/25070))
- Added a loader to the redesigned confirmation page to indicate when Blockaid validation is underway ([#25568](https://github.com/MetaMask/metamask-extension/pull/25568))
...
- Fixed an issue where new lines were not displayed correctly in signature request content ([#24500](https://github.com/MetaMask/metamask-extension/pull/24500))
...
- Enhanced security alert handling and streamlined validation processes ([#24924](https://github.com/MetaMask/metamask-extension/pull/24924))
...
- Resolved an issue where the confirmation page failed to load with the redesign feature enabled ([#24519](https://github.com/MetaMask/metamask-extension/pull/24519))
- Improved signature request usability by adjusting scroll behavior ([#24489](https://github.com/MetaMask/metamask-extension/pull/24489))
- Enhanced the connection and display of networks for a smoother user experience ([#24348](https://github.com/MetaMask/metamask-extension/pull/24348))
...
- Corrected the calculation of ETH/USD amounts in notifications ([#25024](https://github.com/MetaMask/metamask-extension/pull/25024))
- Resolved an issue with incorrect amount calculations in 'ready to be withdrawn' notifications ([#25027](https://github.com/MetaMask/metamask-extension/pull/25027))
- Fixed a bug to ensure users continue to receive wallet push notifications upon application restart ([#24752](https://github.com/MetaMask/metamask-extension/pull/24752))
- Improved the notification counter in the header to accurately reflect unread Snap notifications, even when wallet notifications are disabled ([#24733](https://github.com/MetaMask/metamask-extension/pull/24733))
- Resolved an issue ensuring only selected accounts receive notifications after a service worker restart, preventing unintended re-subscription ([#24758](https://github.com/MetaMask/metamask-extension/pull/24758))
- Implemented a fix to mark notifications as read immediately upon viewing ([#24765](https://github.com/MetaMask/metamask-extension/pull/24765))
...
- Refined the alerts on typed sign data pages based on user feedback ([#25218](https://github.com/MetaMask/metamask-extension/pull/25218))
- Implemented logic to correctly handle platform-specific links within notifications ([#24708](https://github.com/MetaMask/metamask-extension/pull/24708))
- Resolved an issue where incorrect type assertions led to a crash when attempting to split an undefined value in notification detail network fees ([#25315](https://github.com/MetaMask/metamask-extension/pull/25315))
...
- Streamlined NetworkList creation with a helper function for consistent chain switching and improved usability across all networks ([#25195](https://github.com/MetaMask/metamask-extension/pull/25195))
...
- Refined notifications UI to only show tabs when relevant and correctly categorize feature announcements ([#25382](https://github.com/MetaMask/metamask-extension/pull/25382))
- Fixed Swap+Send feature bugs related to token inconsistencies, incorrect Activity list amounts, and rounding errors in Firefox ([#25307](https://github.com/MetaMask/metamask-extension/pull/25307))
- Temporarily disabled Smart Transactions for the new Send&Swap feature until support is introduced in a future update ([#25422](https://github.com/MetaMask/metamask-extension/pull/25422))
- Corrected an issue to ensure native currency symbols are accurately displayed in send and receive notifications ([#25364](https://github.com/MetaMask/metamask-extension/pull/25364))
- Resolved an issue where the token detection modal would not dismiss on Firefox ([#25279](https://github.com/MetaMask/metamask-extension/pull/25279))
- Improved the network switch process from dApps by preventing the network switch modal from briefly appearing ([#25327](https://github.com/MetaMask/metamask-extension/pull/25327))
- Adjusted the notifications-tag-counter to have a minimum width ([#25363](https://github.com/MetaMask/metamask-extension/pull/25363))
- Implemented a fix to hide the 'Mark all as read' button for notifications when there are no unread notifications ([#25348](https://github.com/MetaMask/metamask-extension/pull/25348))
- Resolved a delay issue with account toggles on the notifications settings page ([#25428](https://github.com/MetaMask/metamask-extension/pull/25428))
- Corrected the display of USD amounts in swap notifications to ensure accurate fiat conversion values ([#25444](https://github.com/MetaMask/metamask-extension/pull/25444))
- Enhanced handling of queued requests by including them in the logic for home screen rerouting and notification closure ([#25454](https://github.com/MetaMask/metamask-extension/pull/25454))
- Disabled concurrent transaction submissions in the swap+send flow to prevent issues with Smart Transactions processing ([#25468](https://github.com/MetaMask/metamask-extension/pull/25468))
- Temporarily disabled Swap+Send on networks not yet supported by the newest contracts ([#25474](https://github.com/MetaMask/metamask-extension/pull/25474))
- Adjusted UI to truncate long NFT IDs with ellipses ([#25479](https://github.com/MetaMask/metamask-extension/pull/25479))
- Excluded STX flow from Swap+Send approvals ([#25510](https://github.com/MetaMask/metamask-extension/pull/25510))
- Fixed a bug to handle cases of undefined transaction data ([#25506](https://github.com/MetaMask/metamask-extension/pull/25506))
- Enhanced the transaction confirmation flow by prioritizing smart transaction status confirmations ([#25478](https://github.com/MetaMask/metamask-extension/pull/25478))
- Enhanced the signature confirmation process to automatically switch to the appropriate network ([#25562](https://github.com/MetaMask/metamask-extension/pull/25562))
