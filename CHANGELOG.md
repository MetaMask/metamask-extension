...
- Update Flask support links and home footer ([#13226](https://github.com/MetaMask/metamask-extension/pull/13226))
...
- Fix missing `targetSubjectMetadata.name` propType error ([#13218](https://github.com/MetaMask/metamask-extension/pull/13218))
...
- Include style lints in `lint:fix` script ([#13217](https://github.com/MetaMask/metamask-extension/pull/13217))
- Fix `account-menu` styles lint failure ([#13215](https://github.com/MetaMask/metamask-extension/pull/13215))
- Lock button active state fix ([#13100](https://github.com/MetaMask/metamask-extension/pull/13100))
- Updating storybook webpack config and changing font paths ([#13028](https://github.com/MetaMask/metamask-extension/pull/13028))
- Remove unnecessary `mounted` state from Home component ([#13202](https://github.com/MetaMask/metamask-extension/pull/13202))
- Adding margin auto support to Box ([#12801](https://github.com/MetaMask/metamask-extension/pull/12801))
- Add missing permissions middleware hook ([#13205](https://github.com/MetaMask/metamask-extension/pull/13205))
- EditGasPopover story: convert knobs and actions to controls / args #13056 ([#13125](https://github.com/MetaMask/metamask-extension/pull/13125))
- Fix typo in ComposableObservableStore.js ([#13151](https://github.com/MetaMask/metamask-extension/pull/13151))
- Ignore 4Byte 502 errors during e2e tests ([#13204](https://github.com/MetaMask/metamask-extension/pull/13204))
- Feat/check update collectible ownership ([#13110](https://github.com/MetaMask/metamask-extension/pull/13110))
- add crowdin-bot to the CLA allowlist ([#13193](https://github.com/MetaMask/metamask-extension/pull/13193))
- Update the Firefox prerelease version format ([#13158](https://github.com/MetaMask/metamask-extension/pull/13158))
- Allow templates without alerts ([#13150](https://github.com/MetaMask/metamask-extension/pull/13150))
- Fix how `version_name` manifest field is used ([#13155](https://github.com/MetaMask/metamask-extension/pull/13155))
- Allow Flask prerelease versions ([#13156](https://github.com/MetaMask/metamask-extension/pull/13156))
- Update the Sentry setup log with the build type ([#13157](https://github.com/MetaMask/metamask-extension/pull/13157))
- maintain nft image aspect ratios and center images in collection view ([#13136](https://github.com/MetaMask/metamask-extension/pull/13136))
- Remove duplicate selector `getPermissionSubjectsMetadata` ([#13144](https://github.com/MetaMask/metamask-extension/pull/13144))
- Add Chrome store policy compliant names/descriptions ([#13142](https://github.com/MetaMask/metamask-extension/pull/13142))
- Sync `master` with `develop` ([#13141](https://github.com/MetaMask/metamask-extension/pull/13141))
...
- EIP-1559 V2: Adding default settings to advanced gas modal ([#12911](https://github.com/MetaMask/metamask-extension/pull/12911))
- EIP-1559 V2: Advanced gas fee modal - base fee and priority fee trends ([#13025](https://github.com/MetaMask/metamask-extension/pull/13025))
- Wire up priority fee range in new gas modal ([#13044](https://github.com/MetaMask/metamask-extension/pull/13044))
- EIP-1559 V2: Advanced gas fee modal - getting 12 hour ranges of base fee and priority fee ([#12996](https://github.com/MetaMask/metamask-extension/pull/12996))
- Sync `develop` with `master` ([#13115](https://github.com/MetaMask/metamask-extension/pull/13115))
- Merge remote-tracking branch 'origin/develop' into master-sync
- Switch Flask horizontal logos ([#13113](https://github.com/MetaMask/metamask-extension/pull/13113))
- Update `@babel/runtime` patch to fix lockdown error ([#13109](https://github.com/MetaMask/metamask-extension/pull/13109))
...
- Master <> Develop Sync (post-v10.8.0) ([#13088](https://github.com/MetaMask/metamask-extension/pull/13088))
- Feat/collectibles the return ([#12970](https://github.com/MetaMask/metamask-extension/pull/12970))
...
- Bump just-safe-set from 2.1.0 to 2.2.3 ([#13049](https://github.com/MetaMask/metamask-extension/pull/13049))
- Fix typo in German translation ([#13040](https://github.com/MetaMask/metamask-extension/pull/13040))
- Using EIP-1559 V2 for swaps ([#12966](https://github.com/MetaMask/metamask-extension/pull/12966))
...
- Add stories for Home notification component ([#13035](https://github.com/MetaMask/metamask-extension/pull/13035))
- Update Redux DevTools README instructions ([#13038](https://github.com/MetaMask/metamask-extension/pull/13038))
- Jestify app/scripts/controller/network/**/*.test.js ([#12985](https://github.com/MetaMask/metamask-extension/pull/12985))
- Fix order of account list ([#12999](https://github.com/MetaMask/metamask-extension/pull/12999))
- Changes in gas loading animation in EIP-1559 V2 ([#13016](https://github.com/MetaMask/metamask-extension/pull/13016))
...
- Update ESLint config to v8 ([#12886](https://github.com/MetaMask/metamask-extension/pull/12886))
- Update `electron` from 11.4.12 to 11.5.0 ([#13037](https://github.com/MetaMask/metamask-extension/pull/13037))
- Add `@metamask/rpc-methods` package ([#13027](https://github.com/MetaMask/metamask-extension/pull/13027))
...
- Update LavaMoat policies ([#12992](https://github.com/MetaMask/metamask-extension/pull/12992))
- Fixing EIP-1559 V2 advance gas fee inputs validations ([#13013](https://github.com/MetaMask/metamask-extension/pull/13013))
- Remove `nodeify` ([#13003](https://github.com/MetaMask/metamask-extension/pull/13003))
...
- Fix error-message component to match new Storybook format ([#12815](https://github.com/MetaMask/metamask-extension/pull/12815))
- Fix dropdown component for new Storybook format ([#12816](https://github.com/MetaMask/metamask-extension/pull/12816))
- Fix signature-request for new Storybook format ([#12755](https://github.com/MetaMask/metamask-extension/pull/12755))
- Fix form-field for new Storybook format ([#12756](https://github.com/MetaMask/metamask-extension/pull/12756))
...
- Sync develop with master ([#13010](https://github.com/MetaMask/metamask-extension/pull/13010))
- Merge remote-tracking branch 'origin/develop' into master-sync
- Tx decoding accreditation ([#12918](https://github.com/MetaMask/metamask-extension/pull/12918))
- Adding featureflags to .metamaskrc.dist file ([#12962](https://github.com/MetaMask/metamask-extension/pull/12962))
- Update tx-insights url ([#12997](https://github.com/MetaMask/metamask-extension/pull/12997))
- Updating storybook documentation guidelines ([#12957](https://github.com/MetaMask/metamask-extension/pull/12957))
- Fix confirmed transaction time  ([#12633](https://github.com/MetaMask/metamask-extension/pull/12633))
- Fix Actionable message for new Storybook format ([#12874](https://github.com/MetaMask/metamask-extension/pull/12874))
- Fix icon component for new Storybook format ([#12887](https://github.com/MetaMask/metamask-extension/pull/12887))
- Fix identicon component for new Storybook format ([#12888](https://github.com/MetaMask/metamask-extension/pull/12888))
- text-field ([#12889](https://github.com/MetaMask/metamask-extension/pull/12889))
- Fix account-list-item component for new Storybook format ([#12893](https://github.com/MetaMask/metamask-extension/pull/12893))
- Fix dropdown-input-pair component to for new Storybook format ([#12895](https://github.com/MetaMask/metamask-extension/pull/12895))
- Fix popover component to for new Storybook format ([#12896](https://github.com/MetaMask/metamask-extension/pull/12896))
...
- Fix transaction-detail-item for new Storybook format ([#12820](https://github.com/MetaMask/metamask-extension/pull/12820))
- Fix transaction-detail for new Storybook format ([#12819](https://github.com/MetaMask/metamask-extension/pull/12819))
...
- 1559 v2 tooltips ([#12750](https://github.com/MetaMask/metamask-extension/pull/12750))
- Disable React dev tools in `testDev` builds ([#12955](https://github.com/MetaMask/metamask-extension/pull/12955))
- Remove invalid `disableRipple` prop ([#12948](https://github.com/MetaMask/metamask-extension/pull/12948))
- Lavamoat Devx - update lavamoat-browserify for policy reload on change ([#12940](https://github.com/MetaMask/metamask-extension/pull/12940))
- update selenium-webdriver to v4.1.0 ([#12922](https://github.com/MetaMask/metamask-extension/pull/12922))
- Fix `isMainnet` propType error ([#12951](https://github.com/MetaMask/metamask-extension/pull/12951))
- Fix signature request propTypes ([#12952](https://github.com/MetaMask/metamask-extension/pull/12952))
- Added SiteOrigin and PermissionList components ([#12832](https://github.com/MetaMask/metamask-extension/pull/12832))
- Updating Storybook base styles ([#12862](https://github.com/MetaMask/metamask-extension/pull/12862))
- Latest update conversion date  - issue  #10741 ([#12422](https://github.com/MetaMask/metamask-extension/pull/12422))
- Revert "Feat/collectibles display (#12873)" ([#12873](https://github.com/MetaMask/metamask-extension/pull/12873))
- Adding snaps authorship pill ([#12740](https://github.com/MetaMask/metamask-extension/pull/12740))
- put new collectibles related preferences behind feature flag ([#12936](https://github.com/MetaMask/metamask-extension/pull/12936))
- Adding SnapSettingsCard ui component ([#12655](https://github.com/MetaMask/metamask-extension/pull/12655))
- Organizing storybook to echo app folder structure ([#12796](https://github.com/MetaMask/metamask-extension/pull/12796))
