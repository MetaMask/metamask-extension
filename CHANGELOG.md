...
- Replaces `refreshTransaction` and `refreshAssets` with `refreshAccounts` which does both by checking on account signatures per address. ([#33079](https://github.com/MetaMask/metamask-extension/pull/33079))
