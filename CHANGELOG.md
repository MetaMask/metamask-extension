...
- Added a feature-flagged placeholder route for the cross-chain swaps experience ([#25811](https://github.com/MetaMask/metamask-extension/pull/25811))
...
- Introduced new functionality to support various permit operations ([#26107](https://github.com/MetaMask/metamask-extension/pull/26107))
...
- Added abstraction for Snaps permissions, including new UI and scrolling behavior ([#25175](https://github.com/MetaMask/metamask-extension/pull/25175))
- Added redesigned UI and new UX for the Snap home page and Snap dialog, including an updated Snap Authorship header ([#25670](https://github.com/MetaMask/metamask-extension/pull/25670))
...
- Added support for an additional portfolio URL ([#26163](https://github.com/MetaMask/metamask-extension/pull/26163))
...
- Added a check to ensure the notifications enabling process is not interrupted when closing the modal ([#27056](https://github.com/MetaMask/metamask-extension/pull/27056))
...
- Improved the hex copy button design in the transaction advanced details ([#26384](https://github.com/MetaMask/metamask-extension/pull/26384))
...
- Fixed an issue to clean up old network settings and prevent potential errors ([#26265](https://github.com/MetaMask/metamask-extension/pull/26265))
...
- Fixed an issue to prevent crashes when network configurations are missing ([#26327](https://github.com/MetaMask/metamask-extension/pull/26327))
- Truncated extremely long transaction histories to improve performance and prevent crashes ([#26291](https://github.com/MetaMask/metamask-extension/pull/26291))
...
- [FLASK] Fixed the issue of selecting the correct network when multiple networks have the same chain ID ([#25805](https://github.com/MetaMask/metamask-extension/pull/25805))
- [FLASK] Fixed the "Show conversion in testnets" option for Bitcoin and Ethereum test assets ([#26224](https://github.com/MetaMask/metamask-extension/pull/26224))
