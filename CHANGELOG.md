...
- chore: cp-12.22.0 update solana 1.34.0 (#33982)
...
- fix: 33510 solve `Error: Ledger: Unknown error while signing transaction` (#33581)
...
- fix: cp-12.22.0 Prevent cronjob state from getting out of sync (#33923)
- fix: cp-12.22.0 bump @metamask/multichain-api-client to 0.6.4 to handle multichain api not responding on page load (#33904)
...
- fix: cp-12.20.1 Add missing hooks to `wallet_addEthereumChain` (#33821)
- fix: cp-12.22.0 resubscribe notifications v2 on app startup. (#33805)
- fix: z-index of app header (#33133)
- fix: cp-12.22.0 back srp reveal accessibility and refresh issue (#33807)
...
- fix: cp-12.22.0 Initialize NetworkController completely so it can report errors to Sentry (#33607)
