...
- bump semvar version to 12.18.0
- test: add integration test for inauthentic token swap alert ([#31482](https://github.com/MetaMask/metamask-extension/pull/31482))
- chore: Bump `@metamask/snaps-controllers` to `^11.2.2` ([#32196](https://github.com/MetaMask/metamask-extension/pull/32196))
- test: Add E2E test for Snaps Settings page ([#32151](https://github.com/MetaMask/metamask-extension/pull/32151))
- chore: Remove support link on the home page ([#32157](https://github.com/MetaMask/metamask-extension/pull/32157))
- ci: print raw benchmark data to the console ([#32217](https://github.com/MetaMask/metamask-extension/pull/32217))
- ci: add testfiles to report ([#32156](https://github.com/MetaMask/metamask-extension/pull/32156))
- style: Fix unlock page text and border styles ([#31811](https://github.com/MetaMask/metamask-extension/pull/31811))
- style: Update Send network avatar styling and search spacing ([#31955](https://github.com/MetaMask/metamask-extension/pull/31955))
- chore: bump Solana wallet snap version to 1.24.0 ([#32198](https://github.com/MetaMask/metamask-extension/pull/32198))
- ci: rename browserify test suites ([#32127](https://github.com/MetaMask/metamask-extension/pull/32127))
- chore: Ignore SES and babel vulnerability in `yarn audit` ([#32184](https://github.com/MetaMask/metamask-extension/pull/32184))
- feat(asset): non-evm market details ([#32149](https://github.com/MetaMask/metamask-extension/pull/32149))
- style: Update Sepolia background color ([#31680](https://github.com/MetaMask/metamask-extension/pull/31680))
- style: Add font-smoothing and optimize legibility ([#31922](https://github.com/MetaMask/metamask-extension/pull/31922))
- fix(snaps): Temporarily replace `withKeyring` in `MultichainRouter` hook ([#32120](https://github.com/MetaMask/metamask-extension/pull/32120))
- chore: rename migration 154 to 152.1 ([#32109](https://github.com/MetaMask/metamask-extension/pull/32109))
- chore: upgrade assets controllers to v58.0.0 ([#32019](https://github.com/MetaMask/metamask-extension/pull/32019))
- chore: improving disabled functionality to tabs component ([#32081](https://github.com/MetaMask/metamask-extension/pull/32081))
- ci: add a soft gate for our page load benchmarks ([#31912](https://github.com/MetaMask/metamask-extension/pull/31912))
- test: Added bridge user action benchmark ([#31952](https://github.com/MetaMask/metamask-extension/pull/31952))
- chore: clean up tech debt for `MegaETH Testnet` integration ([#31867](https://github.com/MetaMask/metamask-extension/pull/31867))
- chore: bump `@metamask/{polling,gas-fee}-controller` to `v13`,`v23` ([#32035](https://github.com/MetaMask/metamask-extension/pull/32035))
- chore(snaps): Bump Snaps packages ([#32042](https://github.com/MetaMask/metamask-extension/pull/32042))
- chore: update privacy policy url for firefox on metametrics screen cp-12.12.2 ([#32062](https://github.com/MetaMask/metamask-extension/pull/32062))
- test: Add E2E coverage for interactive UI with disabled states and migrating to POM ([#31629](https://github.com/MetaMask/metamask-extension/pull/31629))
- chore(23528): add TODO for linting `@typescript-eslint/prefer-nullish-coalescing` ([#32041](https://github.com/MetaMask/metamask-extension/pull/32041))
- ci: GH action to remind developers to add release notes in CHANGELOG ([#31706](https://github.com/MetaMask/metamask-extension/pull/31706))
- chore: bump accounts-controller package ([#31704](https://github.com/MetaMask/metamask-extension/pull/31704))
- chore: bump solana wallet snap to v1.22.0 ([#32043](https://github.com/MetaMask/metamask-extension/pull/32043))
- chore(23528): add TODO for linting `typescript-eslint/no-explicit-any` ([#32008](https://github.com/MetaMask/metamask-extension/pull/32008))
- test: Migrate metrics e2e tests to Typescript and Page object modal (part 1) ([#31667](https://github.com/MetaMask/metamask-extension/pull/31667))
- chore: update notification popup width from 360px to 400px ([#31960](https://github.com/MetaMask/metamask-extension/pull/31960))
- build: beta build should run on all PRs ([#31876](https://github.com/MetaMask/metamask-extension/pull/31876))
- chore: bump profile-sync-controller to `^12.0.0` and notification-services-controller to `^6.0.0` ([#31988](https://github.com/MetaMask/metamask-extension/pull/31988))
- chore: updates the solana snap version ([#31976](https://github.com/MetaMask/metamask-extension/pull/31976))
- chore(deps): bump message-signing-snap to 1.1.1 ([#31943](https://github.com/MetaMask/metamask-extension/pull/31943))
- chore: upgrade assets controllers to v56 ([#31762](https://github.com/MetaMask/metamask-extension/pull/31762))
- chore: sends two metric events related with solana initiative ([#31714](https://github.com/MetaMask/metamask-extension/pull/31714))
- style: Update carousel styling and images ([#31687](https://github.com/MetaMask/metamask-extension/pull/31687))
- chore: filter by preinstalled snaps ([#31839](https://github.com/MetaMask/metamask-extension/pull/31839))
- fix(whats-new-modal): display different message for users with a Solana account already created ([#31318](https://github.com/MetaMask/metamask-extension/pull/31318))
- chore: adds the necessary metric param ([#31836](https://github.com/MetaMask/metamask-extension/pull/31836))
- test: add gasless smart transaction E2E tests ([#31855](https://github.com/MetaMask/metamask-extension/pull/31855))
- test: eip7702 reject flows ([#31639](https://github.com/MetaMask/metamask-extension/pull/31639))
- fix(snaps): Prevent address input crash on invalid CAIP account ID ([#31934](https://github.com/MetaMask/metamask-extension/pull/31934))
- test: Added more positive test cases to Bridge test automation ([#31817](https://github.com/MetaMask/metamask-extension/pull/31817))
- chore: apply lint to e2e spec ts files ([#31834](https://github.com/MetaMask/metamask-extension/pull/31834))
- chore: mms-1799 native address ([#31554](https://github.com/MetaMask/metamask-extension/pull/31554))
- chore: bump institutional snap version ([#31838](https://github.com/MetaMask/metamask-extension/pull/31838))
- chore: Bump network-controller to v23 ([#31711](https://github.com/MetaMask/metamask-extension/pull/31711))
- test: Migrate accounts e2e tests to Typescript and Page object modal ([#31564](https://github.com/MetaMask/metamask-extension/pull/31564))
- chore: Remove multi SRP code fences ([#31832](https://github.com/MetaMask/metamask-extension/pull/31832))
- chore: change the ordering for test networks ([#31827](https://github.com/MetaMask/metamask-extension/pull/31827))
- chore: cp-12.16.0 Add default platform for suggested key ([#31812](https://github.com/MetaMask/metamask-extension/pull/31812))
- fix(swap/bridge): move to activity tab before transaction ([#31505](https://github.com/MetaMask/metamask-extension/pull/31505))
- test: fix flaky speed up and cancel transaction tests ([#31561](https://github.com/MetaMask/metamask-extension/pull/31561))
- chore: update solana snap to 1.18.1 ([#31819](https://github.com/MetaMask/metamask-extension/pull/31819))
- test: add spec `signs message with verifyingContract field missing` ([#31630](https://github.com/MetaMask/metamask-extension/pull/31630))
- chore: sol-267 remove pill for snap accounts ([#31716](https://github.com/MetaMask/metamask-extension/pull/31716))
- chore: Bump Snaps packages ([#31693](https://github.com/MetaMask/metamask-extension/pull/31693))
- chore: Updating Text component "body" font sizes ([#31494](https://github.com/MetaMask/metamask-extension/pull/31494))
- feat(institutional-snap-controller): Institutional Snap transaction handling ([#30180](https://github.com/MetaMask/metamask-extension/pull/30180))
- chore: add icon image for Plume network ([#31712](https://github.com/MetaMask/metamask-extension/pull/31712))
- ci: turn on skip-allow-scripts to save time ([#31330](https://github.com/MetaMask/metamask-extension/pull/31330))
- chore: add logs and a few mock missed ([#31698](https://github.com/MetaMask/metamask-extension/pull/31698))
- feat(institutional-snap): manage institutional snaps preference and account menu option ([#31655](https://github.com/MetaMask/metamask-extension/pull/31655))
- chore: Bump profile-sync-controller ([#31771](https://github.com/MetaMask/metamask-extension/pull/31771))
- feat(solana): update add account from opt in solana ([#31387](https://github.com/MetaMask/metamask-extension/pull/31387))
- style: Update alignment and hover effect for token cell ([#31615](https://github.com/MetaMask/metamask-extension/pull/31615))
- feat(remote-mode): add feature slide ([#31463](https://github.com/MetaMask/metamask-extension/pull/31463))
- chore: master sync (after v12.15.2) ([#31720](https://github.com/MetaMask/metamask-extension/pull/31720))
- Merge origin/main into master-sync
- fix(snaps): Fix type issue with assets metadata ([#31696](https://github.com/MetaMask/metamask-extension/pull/31696))
- chore: remove MMI hooks and upgrade transaction controller ([#31597](https://github.com/MetaMask/metamask-extension/pull/31597))
- test: ensure `foundryup` works when bin path contains a space character ([#31577](https://github.com/MetaMask/metamask-extension/pull/31577))
- chore: Add e2e for network add / switch scenario when there are pending confirmations ([#30956](https://github.com/MetaMask/metamask-extension/pull/30956))
- style: Update color for no balance and generic avatars ([#30891](https://github.com/MetaMask/metamask-extension/pull/30891))
- style: Remove shadow from toast ([#31618](https://github.com/MetaMask/metamask-extension/pull/31618))
- style: Update font weights for balance, price and other headers ([#31624](https://github.com/MetaMask/metamask-extension/pull/31624))
- feat(institutional-snap): pre-install institutional snap ([#31531](https://github.com/MetaMask/metamask-extension/pull/31531))
- test: fix failing ppom e2e ([#31645](https://github.com/MetaMask/metamask-extension/pull/31645))
- New Crowdin translations by Github Action ([#30815](https://github.com/MetaMask/metamask-extension/pull/30815))
- test: Migrate dapp interaction e2e tests to Typescript and Page object modal ([#31473](https://github.com/MetaMask/metamask-extension/pull/31473))
- test: eip7702 setup and upgrade+batch simple spec ([#31234](https://github.com/MetaMask/metamask-extension/pull/31234))
- chore: Update Soneium logo ([#31573](https://github.com/MetaMask/metamask-extension/pull/31573))
- chore: Sync `main` with `master`, `v12.15.0` -> `v12.15.1` ([#31581](https://github.com/MetaMask/metamask-extension/pull/31581))
- Merge origin/main into master-sync
- chore: Add XRPL EVM Testnet network ([#31533](https://github.com/MetaMask/metamask-extension/pull/31533))
- test: removing some entries from live request allowlist by adding missing mocks ([#31504](https://github.com/MetaMask/metamask-extension/pull/31504))
- chore: remove preference to enable incoming transaction polling for networks ([#31269](https://github.com/MetaMask/metamask-extension/pull/31269))
- chore: mms-1799 unverified token ([#31462](https://github.com/MetaMask/metamask-extension/pull/31462))
- chore: adding mm poly font files and making it available via css ([#31535](https://github.com/MetaMask/metamask-extension/pull/31535))
- chore: Remove PortfolioView feature flags ([#31501](https://github.com/MetaMask/metamask-extension/pull/31501))
- fix(snaps): Update balance display in `AssetSelector` ([#31428](https://github.com/MetaMask/metamask-extension/pull/31428))
- test: migrate account permission e2e tests to Typescript and Page object modal ([#31402](https://github.com/MetaMask/metamask-extension/pull/31402))
- test: Add E2E coverage for transactions insights on more types of transactions ([#31078](https://github.com/MetaMask/metamask-extension/pull/31078))
- feat(solana): update add account from network picker ([#31358](https://github.com/MetaMask/metamask-extension/pull/31358))
- chore: update node-pty ([#31500](https://github.com/MetaMask/metamask-extension/pull/31500))
- refactor: multichain activity tab ([#31439](https://github.com/MetaMask/metamask-extension/pull/31439))
- chore: sync `master` with `main` `v12.14.2` -> `v12.15.0` ([#31495](https://github.com/MetaMask/metamask-extension/pull/31495))
- Merge origin/main into master-sync
- test: rename more ganache old references ([#31470](https://github.com/MetaMask/metamask-extension/pull/31470))
- chore: bump accounts dependencies ([#31433](https://github.com/MetaMask/metamask-extension/pull/31433))
- chore: default account name visibility/width ([#31202](https://github.com/MetaMask/metamask-extension/pull/31202))
- chore: temporarily ignore `@solana/web3.js (deprecation)` ([#31467](https://github.com/MetaMask/metamask-extension/pull/31467))
- chore: move Snap component tests into their own files ([#31361](https://github.com/MetaMask/metamask-extension/pull/31361))
- test: migrate NFT tests to Typescript and Page object modal ([#31396](https://github.com/MetaMask/metamask-extension/pull/31396))
- test: add mock to fix privacy test flakiness ([#31429](https://github.com/MetaMask/metamask-extension/pull/31429))
- test: MMQA-224 add test eth to weth ([#31278](https://github.com/MetaMask/metamask-extension/pull/31278))
- refactor: migrate tokenRates controller to modular controller init ([#31254](https://github.com/MetaMask/metamask-extension/pull/31254))
- style: Update color of values to text-default ([#30886](https://github.com/MetaMask/metamask-extension/pull/30886))
- style: Update tabs color, hover and animations ([#30907](https://github.com/MetaMask/metamask-extension/pull/30907))
- chore: updating font family from euclid to centra ([#31303](https://github.com/MetaMask/metamask-extension/pull/31303))
- test: rename double and triple ganache references ([#31385](https://github.com/MetaMask/metamask-extension/pull/31385))
- revert(snaps): Revert breaking changes from #31058 ([#31391](https://github.com/MetaMask/metamask-extension/pull/31391))
- test: fix mocha vs jest type conflicts in test files ([#31049](https://github.com/MetaMask/metamask-extension/pull/31049))
- chore: add workflow_dispatch to security-code-scanner ([#30620](https://github.com/MetaMask/metamask-extension/pull/30620))
- chore: Updating @metamask/user-operation-controller to version 31.0.0 ([#31242](https://github.com/MetaMask/metamask-extension/pull/31242))
- refactor: migrate to @metamask/bridge-controller ([#31059](https://github.com/MetaMask/metamask-extension/pull/31059))
- chore(remote-mode): add getIsRemoteModeEnabled selector ([#31334](https://github.com/MetaMask/metamask-extension/pull/31334))

### Added

- feat: add info alert linked to account type ([#31840](https://github.com/MetaMask/metamask-extension/pull/31840))
- feat: Adds Remote Mode settings screen logic ([#32214](https://github.com/MetaMask/metamask-extension/pull/32214))
- feat: Design parity improvements (splash screen and swap setup) ([#32134](https://github.com/MetaMask/metamask-extension/pull/32134))
- feat: prepopulate fromtoken on solana if navigated through assetpicker ([#32143](https://github.com/MetaMask/metamask-extension/pull/32143))
- feat: Remote Mode smart account update info component (and minor refactors) ([#32123](https://github.com/MetaMask/metamask-extension/pull/32123))
- feat: bump `@metamask/providers` to `^21.0.0` ([#31056](https://github.com/MetaMask/metamask-extension/pull/31056))
- feat: upload test runs ([#32103](https://github.com/MetaMask/metamask-extension/pull/32103))
- feat: Adds Remote Mode hardware wallet gating ([#32012](https://github.com/MetaMask/metamask-extension/pull/32012))
- feat: expose Multichain API via window.postMessage for Firefox ([#30142](https://github.com/MetaMask/metamask-extension/pull/30142))
- feat: Add "Create Solana Account" in connection flow when Solana is requested chain by dapp ([#31781](https://github.com/MetaMask/metamask-extension/pull/31781))
- feat: Wires up account pickers in remote mode flow ([#31857](https://github.com/MetaMask/metamask-extension/pull/31857))
- feat: INFRA-2406: Automated RCA questionaire workflow ([#31665](https://github.com/MetaMask/metamask-extension/pull/31665))
- feat: support version 2.0.0 of EIP-5792 ([#31913](https://github.com/MetaMask/metamask-extension/pull/31913))
- feat: add nested transactions tag component ([#31829](https://github.com/MetaMask/metamask-extension/pull/31829))
- feat: Remove QueueController from extension ([#31642](https://github.com/MetaMask/metamask-extension/pull/31642))
- feat: added tx failed e2e test scenario ([#30901](https://github.com/MetaMask/metamask-extension/pull/30901))
- feat: improved e2e test report ([#31323](https://github.com/MetaMask/metamask-extension/pull/31323))
- feat: Adding Base to STX Supported Chains Array (prod) ([#31562](https://github.com/MetaMask/metamask-extension/pull/31562))
- feat: update padding on the add account screen ([#31936](https://github.com/MetaMask/metamask-extension/pull/31936))
- feat: add calls to discover accounts ([#31485](https://github.com/MetaMask/metamask-extension/pull/31485))
- feat: cp-12.16.0 extend sweepstakes ([#31900](https://github.com/MetaMask/metamask-extension/pull/31900))
- feat: Load preinstalled Snaps from JSON files ([#31320](https://github.com/MetaMask/metamask-extension/pull/31320))
- feat: add is_suggested_name segment property ([#31513](https://github.com/MetaMask/metamask-extension/pull/31513))
- feat: multi srp banner ([#31782](https://github.com/MetaMask/metamask-extension/pull/31782))
- feat: cp-12.17.0 solana bridge activity list improvements ([#31546](https://github.com/MetaMask/metamask-extension/pull/31546))
- feat: Remote Mode - Enabling Swaps / Daily Allowance screens and components ([#31582](https://github.com/MetaMask/metamask-extension/pull/31582))
- feat: enable review permissions for non EVM networks ([#31825](https://github.com/MetaMask/metamask-extension/pull/31825))
- feat: Solana Wallet Standard ([#31705](https://github.com/MetaMask/metamask-extension/pull/31705))
- feat: Use chainId / networkClientId from a transaction for STX ([#31776](https://github.com/MetaMask/metamask-extension/pull/31776))
- feat: user to be able to disable smart account update per account ([#31774](https://github.com/MetaMask/metamask-extension/pull/31774))
- feat: support gasless transactions via EIP-7702 ([#31593](https://github.com/MetaMask/metamask-extension/pull/31593))
- feat: Add splash page for smart account upgrade ([#31765](https://github.com/MetaMask/metamask-extension/pull/31765))
- feat: adds deeply liquid stablecoin slippage value of 0.5 ([#31744](https://github.com/MetaMask/metamask-extension/pull/31744))
- feat: SIP-26 Integration ([#29887](https://github.com/MetaMask/metamask-extension/pull/29887))
- feat: add setting to dismiss prompt to enable smart contract ([#31609](https://github.com/MetaMask/metamask-extension/pull/31609))
- feat: fix srp list padding ([#31697](https://github.com/MetaMask/metamask-extension/pull/31697))
- feat: Sol 208 extension asset details UI ([#31407](https://github.com/MetaMask/metamask-extension/pull/31407))
- feat: (MMS-2106) supports copying block explorer link in bridge page ([#31498](https://github.com/MetaMask/metamask-extension/pull/31498))
- feat: cp-12.16.0 remove OneKey device from hardware selection page ([#31549](https://github.com/MetaMask/metamask-extension/pull/31549))
- feat: require network client ID when adding transactions ([#31456](https://github.com/MetaMask/metamask-extension/pull/31456))
- feat: escape / sanitize signTypedData update ([#31377](https://github.com/MetaMask/metamask-extension/pull/31377))
- feat: fetch user balance for transaction's network ([#31441](https://github.com/MetaMask/metamask-extension/pull/31441))
- feat: multichain tokens import ([#31201](https://github.com/MetaMask/metamask-extension/pull/31201))
- feat: for batch transaction simulation section approve rows should be displayed at the top ([#31511](https://github.com/MetaMask/metamask-extension/pull/31511))
- feat: Add clear functionality to SRP import error banner ([#30673](https://github.com/MetaMask/metamask-extension/pull/30673))
- feat: add runway api ([#31524](https://github.com/MetaMask/metamask-extension/pull/31524))
- feat: update native balance by address ([#31510](https://github.com/MetaMask/metamask-extension/pull/31510))
- feat: (MMS-2076) create solana account without redirecting ([#31493](https://github.com/MetaMask/metamask-extension/pull/31493))
- feat: webpack chrome e2e on gha ([#31363](https://github.com/MetaMask/metamask-extension/pull/31363))
- feat: updating popup width of extension from 357px to 400px ([#31443](https://github.com/MetaMask/metamask-extension/pull/31443))
- feat: add new way to customize the Snap account creation flow ([#31285](https://github.com/MetaMask/metamask-extension/pull/31285))
- feat: fetch asset metadata on search ([#31258](https://github.com/MetaMask/metamask-extension/pull/31258))
- feat: add metamaskbot codeowner announcement ([#30668](https://github.com/MetaMask/metamask-extension/pull/30668))
- feat: gas fee token toast ([#31338](https://github.com/MetaMask/metamask-extension/pull/31338))
- feat: Implement the publishBatch hook for smart transactions ([#31267](https://github.com/MetaMask/metamask-extension/pull/31267))
...
- fix: Show Active Badge for Connected Solana Account ([#32169](https://github.com/MetaMask/metamask-extension/pull/32169))
- fix: srp pills ([#32168](https://github.com/MetaMask/metamask-extension/pull/32168))
- fix: cp-12.17.0 mms-2255 double high cost alert ([#32158](https://github.com/MetaMask/metamask-extension/pull/32158))
- fix: update padding for the gas fee pill component ([#32170](https://github.com/MetaMask/metamask-extension/pull/32170))
- fix: Add tracing for UX core flows ([#31732](https://github.com/MetaMask/metamask-extension/pull/31732))
- fix: cp-12.17.0 clamp search token results that don't exist ([#32213](https://github.com/MetaMask/metamask-extension/pull/32213))
- fix: #24744 - Prevent Array.find error ([#32131](https://github.com/MetaMask/metamask-extension/pull/32131))
- fix: ensure the safechain API calls respect basic functionality ([#32200](https://github.com/MetaMask/metamask-extension/pull/32200))
- fix: enable Base in feature flags file for MM Extension ([#32171](https://github.com/MetaMask/metamask-extension/pull/32171))
- fix: bump `@metamask/providers` version to v22.0.1 which contains fix to catch errors thrown when window.ethereum provider is set before we get to it ([#32175](https://github.com/MetaMask/metamask-extension/pull/32175))
- fix: Show Connection Toast when at least one account is connected to Dapp ([#32199](https://github.com/MetaMask/metamask-extension/pull/32199))
- fix: add dom-purify to sanitize announcement notifications ([#32001](https://github.com/MetaMask/metamask-extension/pull/32001))
- fix: Adding migration to remove QueuedRequestController from state ([#32089](https://github.com/MetaMask/metamask-extension/pull/32089))
- fix: Gas timing component should not be visible if an alternate token is used to pay for gas. ([#32167](https://github.com/MetaMask/metamask-extension/pull/32167))
- fix: non-evm aggregated balance when evm network is selected ([#32145](https://github.com/MetaMask/metamask-extension/pull/32145))
- fix: #32045 - Show connect account toast for Solana networks ([#32107](https://github.com/MetaMask/metamask-extension/pull/32107))
- fix: confirmation divider design ([#31431](https://github.com/MetaMask/metamask-extension/pull/31431))
- fix: Disable 'Check Changelog' workflow for now ([#32130](https://github.com/MetaMask/metamask-extension/pull/32130))
- fix: Add Tracing for Assets Flows ([#31739](https://github.com/MetaMask/metamask-extension/pull/31739))
- fix: chromedriver crash on Windows ([#31962](https://github.com/MetaMask/metamask-extension/pull/31962))
- fix: add retries to get-job-id ([#32015](https://github.com/MetaMask/metamask-extension/pull/32015))
- fix: cp-12.17.0 - Center buttons in wider popup ([#31897](https://github.com/MetaMask/metamask-extension/pull/31897))
- fix: flaky test `Import flow allows importing using contract address and not current network` ([#32064](https://github.com/MetaMask/metamask-extension/pull/32064))
- fix: cp-12.16.1 confusing error when typing wrong password ([#31933](https://github.com/MetaMask/metamask-extension/pull/31933))
- fix: flaky test `Smart Transactions Swap` ([#32032](https://github.com/MetaMask/metamask-extension/pull/32032))
- fix: improve mark as read ([#31824](https://github.com/MetaMask/metamask-extension/pull/31824))
- fix: fix rerender for suggested nfts ([#32031](https://github.com/MetaMask/metamask-extension/pull/32031))
- fix: NFT Grid tooltip ([#31625](https://github.com/MetaMask/metamask-extension/pull/31625))
- fix: Updated styles for connections menu ([#31112](https://github.com/MetaMask/metamask-extension/pull/31112))
- fix: cp-12.16.1 fix display nft full image ([#31967](https://github.com/MetaMask/metamask-extension/pull/31967))
- fix: do not wait for snapclient response on account create ([#31940](https://github.com/MetaMask/metamask-extension/pull/31940))
- fix: fix sentry error on getNetworkConfigurationByNetworkClientId ([#31438](https://github.com/MetaMask/metamask-extension/pull/31438))
- fix: flaky test `Import flow Import wallet using Secret Recovery Phrase with pasting word by word` and `MetaMask onboarding should not prevent network requests to basic functionality endpoints when the basic functionality toggle is on` ([#31947](https://github.com/MetaMask/metamask-extension/pull/31947))
- fix: Retry, Cancel/Speed Up popover displays "undefined 10% increase" ([#31866](https://github.com/MetaMask/metamask-extension/pull/31866))
- fix: benchmarks and bundle-size ([#31868](https://github.com/MetaMask/metamask-extension/pull/31868))
- fix: cp-12.17.0 fix clean up fiat conversion logic ([#31938](https://github.com/MetaMask/metamask-extension/pull/31938))
- fix: edge case for `UpdateSnapPermissionList` ([#31828](https://github.com/MetaMask/metamask-extension/pull/31828))
- fix: keyboard shortcut(Alt+Shift+M) broken on Chrome ([#31844](https://github.com/MetaMask/metamask-extension/pull/31844))
- fix: missing padding in retry popover ([#31904](https://github.com/MetaMask/metamask-extension/pull/31904))
- fix: display first party snap accounts in srp account list. ([#31833](https://github.com/MetaMask/metamask-extension/pull/31833))
- fix: retry gas, dont show unvailable emoji ([#31537](https://github.com/MetaMask/metamask-extension/pull/31537))
- fix: Use DS buttons for `PageContainerFooter` ([#31870](https://github.com/MetaMask/metamask-extension/pull/31870))
- fix: flatten transaction list ([#31816](https://github.com/MetaMask/metamask-extension/pull/31816))
- fix: filter NFTs on send flow ([#31850](https://github.com/MetaMask/metamask-extension/pull/31850))
- fix: trigger detectNfts on account switch ([#31481](https://github.com/MetaMask/metamask-extension/pull/31481))
- fix: clear hidden accounts on restore and account list scroll ([#31745](https://github.com/MetaMask/metamask-extension/pull/31745))
- fix: Display "🦊 Smart contract" in "interacting with" row for batch transaction confirmations ([#31507](https://github.com/MetaMask/metamask-extension/pull/31507))
- fix: #30115: Hide import key error ([#31129](https://github.com/MetaMask/metamask-extension/pull/31129))
- fix: Prevent double filtering of tokens ([#31742](https://github.com/MetaMask/metamask-extension/pull/31742))
- fix: cp-12.17.0 upgrade @metamask/eth-ledger-bridge-keyring to fix the ledger signTypedDataV4 with salt ([#31313](https://github.com/MetaMask/metamask-extension/pull/31313))
...
- fix: import srp error handling and style ([#31662](https://github.com/MetaMask/metamask-extension/pull/31662))
- fix: missing solana fiat values in XChain swaps page ([#31686](https://github.com/MetaMask/metamask-extension/pull/31686))
- fix: Failed to construct URL: Invalid URL at new URL ([#31502](https://github.com/MetaMask/metamask-extension/pull/31502))
- fix: update function name in 077-supplement-for-088.ts ([#29971](https://github.com/MetaMask/metamask-extension/pull/29971))
- fix: Add `displayAvatar` prop to Snap `AddressInput` component ([#31746](https://github.com/MetaMask/metamask-extension/pull/31746))
...
- fix: update Keystone keyring package to v0.15.2 ([#31690](https://github.com/MetaMask/metamask-extension/pull/31690))
- fix: carousel e2e test ([#31756](https://github.com/MetaMask/metamask-extension/pull/31756))
- fix: Update routes callbacks per react-perf's warnings ([#31019](https://github.com/MetaMask/metamask-extension/pull/31019))
- fix: add solana modal title ([#31660](https://github.com/MetaMask/metamask-extension/pull/31660))
- fix: remove-duplicated-alerts ([#31695](https://github.com/MetaMask/metamask-extension/pull/31695))
- fix: cp-12.16.0 HW wallet confirmation warning for bridge ([#31679](https://github.com/MetaMask/metamask-extension/pull/31679))
- fix: cp-12.16.0 include networkClientId in stx submitSignedTransactions call ([#31689](https://github.com/MetaMask/metamask-extension/pull/31689))
- fix: solana modal auto focus fix ([#31713](https://github.com/MetaMask/metamask-extension/pull/31713))
- fix: update assets contract controller modular controller init ([#31681](https://github.com/MetaMask/metamask-extension/pull/31681))
- fix: Revert "feat(14507): improve error message for failed txn in activity… ([#31137](https://github.com/MetaMask/metamask-extension/pull/31137))
- fix: CI for external contributions ([#31566](https://github.com/MetaMask/metamask-extension/pull/31566))
- fix: Update blockaid friction modal copy ([#31475](https://github.com/MetaMask/metamask-extension/pull/31475))
- fix: improve fetching nft details for custom contracts ([#31432](https://github.com/MetaMask/metamask-extension/pull/31432))
- fix: switch-ethereun-chain not passing rejectApprovalRequestsForOrigin hook correctly ([#31672](https://github.com/MetaMask/metamask-extension/pull/31672))
- fix: nftDetectionController with new initialization pattern ([#31674](https://github.com/MetaMask/metamask-extension/pull/31674))
- fix: nftController with modular init pattern ([#31658](https://github.com/MetaMask/metamask-extension/pull/31658))
- fix: cp-12.16.0 bump "@metamask/smart-transactions-controller": "^16.3.1" ([#31668](https://github.com/MetaMask/metamask-extension/pull/31668))
- fix: wrap long asset names ([#31657](https://github.com/MetaMask/metamask-extension/pull/31657))
- fix: fix NFT balance in send flow ([#31239](https://github.com/MetaMask/metamask-extension/pull/31239))
- fix: multichain swap transaction to show from amount ([#31592](https://github.com/MetaMask/metamask-extension/pull/31592))
- fix: flaky test Multichain API Call wallet_createSession ([#31603](https://github.com/MetaMask/metamask-extension/pull/31603))
- fix: flaky test `Request Queueing chainId proxy sync should preserve per dapp network selections after connecting and switching without refresh calls` ([#31599](https://github.com/MetaMask/metamask-extension/pull/31599))
- fix: flaky test `MetaMask onboarding should not prevent network requests to basic functionality endpoints when the basic functionality toggle is on` ([#31521](https://github.com/MetaMask/metamask-extension/pull/31521))
...
- fix: cp-12.16.0 add gasless metrics ([#31560](https://github.com/MetaMask/metamask-extension/pull/31560))
- fix: sanitizeTestTitle ([#31574](https://github.com/MetaMask/metamask-extension/pull/31574))
- fix: cp-12.16.0 fix send trx send title ([#31559](https://github.com/MetaMask/metamask-extension/pull/31559))
- fix: small amounts on activity tab ([#31563](https://github.com/MetaMask/metamask-extension/pull/31563))
- fix: For batch transactions sum total of gas needed for all transactions in the batched should be check to show insufficient funds error ([#31555](https://github.com/MetaMask/metamask-extension/pull/31555))
...
- fix: notification details event ([#31526](https://github.com/MetaMask/metamask-extension/pull/31526))
...
- fix: Fix `useTransactionGasFeeEstimate` to calculate gas estimate properly ([#31469](https://github.com/MetaMask/metamask-extension/pull/31469))
- fix: codeowners file name `.yarnrc.yml` ([#31487](https://github.com/MetaMask/metamask-extension/pull/31487))
- fix: Add `enableTxParamsGasFeeUpdates` to `true` in `TransactionController` config ([#31476](https://github.com/MetaMask/metamask-extension/pull/31476))
- fix: cp-12.16.0 show solana fiat values ([#31417](https://github.com/MetaMask/metamask-extension/pull/31417))
- fix: hide accounts by default in reveal srp flow ([#31395](https://github.com/MetaMask/metamask-extension/pull/31395))
- fix: fix button disabled for long tokenId ([#31359](https://github.com/MetaMask/metamask-extension/pull/31359))
- fix: srp toast message ([#31312](https://github.com/MetaMask/metamask-extension/pull/31312))
- fix: `test-e2e-chrome-vault-decryption` job ([#31425](https://github.com/MetaMask/metamask-extension/pull/31425))
- fix: 31266 qr device sign transaction issue ([#31366](https://github.com/MetaMask/metamask-extension/pull/31366))
- fix: handle array image edge cases ([#30494](https://github.com/MetaMask/metamask-extension/pull/30494))
...
- fix: cp-12.15.0 Prevent fullscreen UI from opening every startup ([#31332](https://github.com/MetaMask/metamask-extension/pull/31332))
- fix: token name sort ([#31302](https://github.com/MetaMask/metamask-extension/pull/31302))
- fix: cp-12.15.0 remove sentry cdn url from sentry script ([#31360](https://github.com/MetaMask/metamask-extension/pull/31360))
...
- fix: cp-12.16.0 Follow up on the publishBatch hook ([#31401](https://github.com/MetaMask/metamask-extension/pull/31401))
- fix: cp-12.15.0 support link in EIP-5792 cancel request modal. ([#31386](https://github.com/MetaMask/metamask-extension/pull/31386))
- fix: flaky test `Settings - general tab validate "मानक हिन्दी" language on tooltips` ([#31384](https://github.com/MetaMask/metamask-extension/pull/31384))
- fix: flaky test `Swaps - notifications tests notifications for slippage` ([#31383](https://github.com/MetaMask/metamask-extension/pull/31383))
- fix: flaky test `Switching between account from different networks Create a Solana account and switch to another network` ([#31382](https://github.com/MetaMask/metamask-extension/pull/31382))
...
[12.18.0]: https://github.com/MetaMask/metamask-extension/compare/v12.15.2...v12.18.0
