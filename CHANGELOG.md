...
## [Unreleased]
### Uncategorized
- chore(runway): cherry-pick fix: remove unnecessary method call cp-12.18.0 ([#32449](https://github.com/MetaMask/metamask-extension/pull/32449))
- Update Attributions
- chore: Remove MULTICHAIN_API feature flag and expose Multichain API on all build types cp-12.18.0 cherry-pick ([#32448](https://github.com/MetaMask/metamask-extension/pull/32448))
- chore(runway): cherry-pick fix: patch notification services controller cp-12.17.1 cp-12.18.0 ([#32441](https://github.com/MetaMask/metamask-extension/pull/32441))
- Update Attributions
- feat: use MetaMask build name for solana cp-12.18.0 (#32356) Cherry-pick ([#32356](https://github.com/MetaMask/metamask-extension/pull/32356))
- fix: fix non-evm automatic naming cp-12.18.0 (#32122) Cherry-pick ([#32122](https://github.com/MetaMask/metamask-extension/pull/32122))
- chore(runway): cherry-pick fix: privacy policy in network settings cp-12.18.0 ([#32436](https://github.com/MetaMask/metamask-extension/pull/32436))
- Update Attributions
- chore(runway): cherry-pick fix: cp-12.18.0 use simulation gas for future gas fee tokens ([#32430](https://github.com/MetaMask/metamask-extension/pull/32430))
- Update Attributions
- chore(runway): cherry-pick fix(ledger-mv3-bridge): cp-12.18.0 return `response.success` when payload is undefined ([#32426](https://github.com/MetaMask/metamask-extension/pull/32426))
- test: add e2e tests for wallet-standard (#31989) cp-12.18.0 Cherry-pick ([#31989](https://github.com/MetaMask/metamask-extension/pull/31989))
- Update Attributions
- Revert "chore:  cp-12.18.0 - Remove `MULTICHAIN_API` feature flag and expose Multichain API on all build types (#32351) Cherry-pick ([#32351](https://github.com/MetaMask/metamask-extension/pull/32351))
- chore(runway): cherry-pick fix: Change 'Buy' button for non-EVM networks to use LD feature flag cp-12.18.0 ([#32417](https://github.com/MetaMask/metamask-extension/pull/32417))
- Update Attributions
- chore:  cp-12.18.0 - Remove `MULTICHAIN_API` feature flag and expose Multichain API on all build types (#32351) Cherry-pick ([#32351](https://github.com/MetaMask/metamask-extension/pull/32351))
- Update Attributions
- chore(runway): cherry-pick fix: cp-12.18.0 fix metrics event capturing for advance setting dismissSmartAccountSuggestionEnabled ([#32406](https://github.com/MetaMask/metamask-extension/pull/32406))
- chore: Update the copy for Security & Privacy for Solana (cherry-pick 12.18.0) ([#32334](https://github.com/MetaMask/metamask-extension/pull/32334))
- chore(runway): cherry-pick chore: solana opt-in changes cp-12.18.0 ([#32277](https://github.com/MetaMask/metamask-extension/pull/32277))
- chore(runway): cherry-pick chore:  Don't show Solana banner if the select account is Solana cp-12.18.0 ([#32385](https://github.com/MetaMask/metamask-extension/pull/32385))
- Update Attributions
- cherry-pick: use `to` and `from` to check if transaction is a batch transaction (#32190) cp-12.18.0 ([#32190](https://github.com/MetaMask/metamask-extension/pull/32190))
- chore(runway): cherry-pick chore: bump @metamask/bridge-controller to 17.0.0 to populate quote metadata cp-12.18.0 ([#32315](https://github.com/MetaMask/metamask-extension/pull/32315))
- chore(runway): cherry-pick feat: Changes in upgrade to smart account confirmation page cp-12.18.0 ([#32330](https://github.com/MetaMask/metamask-extension/pull/32330))
- fix: release changelog setup ([#32388](https://github.com/MetaMask/metamask-extension/pull/32388))
- chore: solve conflict from master rebase ([#32384](https://github.com/MetaMask/metamask-extension/pull/32384))
- Merge branch 'master' into Version-v12.18.0
- chore: resolve conflict from master ([#32379](https://github.com/MetaMask/metamask-extension/pull/32379))
- chore: master sync from v12.17.0 & v12.16.2 ([#32372](https://github.com/MetaMask/metamask-extension/pull/32372))
- chore: 12.17.0 conflict resolve ([#32298](https://github.com/MetaMask/metamask-extension/pull/32298))
- chore: 12.17.0 conflict resolve ([#32298](https://github.com/MetaMask/metamask-extension/pull/32298))
- Revert "cheery-pick: Changes in upgrade to smart account confirmation page (#32325)" ([#32325](https://github.com/MetaMask/metamask-extension/pull/32325))
- cheery-pick: Changes in upgrade to smart account confirmation page ([#32325](https://github.com/MetaMask/metamask-extension/pull/32325))
- Merge branch 'Version-v12.17.0' into 12.8.0-conflict-resolve
- Update Attributions
