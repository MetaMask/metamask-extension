...
## [11.11.2]
### Fixed
- [MMI] Fixed bug caused by a PR from confirmations that prevents MMI users from submitting multiple Txs ([#23342](https://github.com/MetaMask/metamask-extension/pull/23342))
