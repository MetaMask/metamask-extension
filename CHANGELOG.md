...
- [FLASK] `snaps-monorepo@0.23.0` ([#16394](https://github.com/MetaMask/metamask-extension/pull/16394))
...
- [FLASK] Fix an issue with updating snaps that have caveat permissions ([#16473](https://github.com/MetaMask/metamask-extension/pull/16473))
