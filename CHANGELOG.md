...
- Fix exchange rate lookups on Solana Swap page to prevent crashing when values are undefined ([#32114g](https://github.com/MetaMask/metamask-extension/pull/32114))
