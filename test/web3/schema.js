...
var methods = {
  hexaNumberMethods: {
    ...
    eth_hashrate: ["eth_hashrate", params.param, "Q"],
    ...
    eth_newFilter: ["eth_newFilter", [params.FilterNewFilter], "Q", 1],
  ...
  booleanMethods: {
    ...
    eth_submitWork: ["eth_submitWork", params.submitWorkParams, "B", 3],
