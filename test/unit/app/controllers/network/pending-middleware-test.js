...
describe('PendingNonceMiddleware', function() {
  ...
  describe('#createPendingTxMiddleware', function() {
    ...
    it('should call next if not a eth_getTransactionByHash request', function(done) {
      const req = { method: 'eth_getBlockByEpochNumber' }
      const res = {}
    ...
    // we don't have pending
    it.skip('should fill the result with a the "pending" tx the result should match the rpc spec', function(done) {
