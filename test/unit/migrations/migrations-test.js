...
const migration2 = require(path.join(
  '..',
  '..',
  '..',
  'app',
...
const migration3 = require(path.join(
  '..',
  '..',
  '..',
  'app',
...
const migration4 = require(path.join(
  '..',
  '..',
  '..',
  'app',
...
const migration5 = require(path.join(
  '..',
  '..',
  '..',
  'app',
...
const migration6 = require(path.join(
  '..',
  '..',
  '..',
  'app',
...
const migration7 = require(path.join(
  '..',
  '..',
  '..',
  'app',
...
const migration8 = require(path.join(
  '..',
  '..',
  '..',
  'app',
...
const migration9 = require(path.join(
  '..',
  '..',
  '..',
  'app',
...
const migration10 = require(path.join(
  '..',
  '..',
  '..',
  'app',
...
const migration11 = require(path.join(
  '..',
  '..',
  '..',
  'app',
...
const migration12 = require(path.join(
  '..',
  '..',
  '..',
  'app',
...
const migration13 = require(path.join(
  '..',
  '..',
  '..',
  'app',
