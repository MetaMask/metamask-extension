//========
// In unit tests for components and hooks we will need a way to make a route
// messenger that can be mocked. This file defines a function that lets us do
// that.
//========
...
/**
 * Creates a route messenger for testing with the specified action handlers.
 *
...
}): RouteMessenger<Actions['type'], UIMessengerEvents['type']> {
