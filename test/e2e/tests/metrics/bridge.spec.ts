  ...
  it('Execute multiple bridge transactions', async function () {
    await withFixtures(
      ...
      async ({ driver, mockedEndpoint: mockedEndpoints }) => {
        ...
        const expectedProperties = JSON.stringify({
          category: 'Unified SwapBridge',
          action_type: 'swapbridge-v1',
          feature_id: 'unified_swap_bridge',
          price_impact: -0.003660017836029515,
          usd_quoted_gas: 241.72268937750394,
          gas_included: false,
          gas_included_7702: false,
          provider: 'lifi_across',
          quoted_time_minutes: 0.8,
          usd_quoted_return: -194.5627915675127,
          chain_id_source: 'eip155:1',
          token_symbol_source: 'DAI',
          token_address_source:
            'eip155:1/erc20:0x6b175474e89094c44da98b954eedeac495271d0f',
          chain_id_destination: 'eip155:59144',
          token_symbol_destination: 'ETH',
          ...
          locale: 'en',
          chain_id: '0x1',
          profile_id: 'MOCK_SRP_IDENTIFIER_1',
          canonical_profile_id: 'MOCK_SRP_IDENTIFIER_1',
        });
        assert.ok(
