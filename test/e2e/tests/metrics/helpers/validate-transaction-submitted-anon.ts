/**
 * Auto-generated validator for "Transaction Submitted Anon" event
...
/**
 * Validates a "Transaction Submitted Anon" event payload
 ...
 */
export function validateTransactionSubmittedAnon(
  event: EventPayload,
  ...
  if (assertFn) {
    ...
    throw new Error(`Validation failed for "Transaction Submitted Anon" event:\n${errors.join('\n')}`);
  }
}
