  ...
  mockServer.forGet(`${BLOCKSTREAM_URL}/api/blocks`).thenJson(200, [
    {
      ...
      weight: 3998296,
      merkle_root:
        '8660d9cea167c6f38272b3e99cba1c0aec8e9dbdb91e5a334ff859c512af62b5',
      previousblockhash:
        '00000000000000000000819c43506e9d147c5d914d61962c1234525f2a127434',
...
export const mockBlockHeight = (mockServer: Mockttp) =>
  mockServer
    ...
    .thenReply(
      200,
      '00000000000000000000dbca63d503f1c9b586c9040e4162ace67cd22dba6da2',
    );
...
export const mockBlockHeight931551 = (mockServer: Mockttp) =>
  mockServer
    ...
    .thenReply(
      200,
      '00000000000000000000d2826c92edb4d7454a16da3e36a9aa9e7a3c53929bde',
    );
    ...
    vin: [
      {
        ...
        prevout: {
          scriptpubkey:
            '5120ed129ee08e1badadbb4fe75f3847213479dd6b9ad2106259d5520891d97f6810',
          scriptpubkey_asm:
            'OP_PUSHNUM_1 OP_PUSHBYTES_32 ed129ee08e1badadbb4fe75f3847213479dd6b9ad2106259d5520891d97f6810',
          scriptpubkey_type: 'v1_p2tr',
          scriptpubkey_address:
            'bc1pa5ffacywrwk6mw60ua0ns3epx3ua66u66ggxykw42gyfrktldqgqukhx7x',
          value: 2132529,
        },
        scriptsig: '',
        scriptsig_asm: '',
