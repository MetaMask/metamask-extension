...
export const TRON_MOCK_TRANSACTION_EXPIRATION_MESSAGE = "5472616e73616374696f6e2065787069726564";
...
const TRON_BLOCK_RESPONSE = {
  ...
  block_header: {
    raw_data: {
      number: 79099699,
      txTrieRoot: "82bee4864136cf3b1e8ca1f67dd8edba1cfcbf37169fd58d16e29223d5ec3425",
      witness_address: "4162398d516b555ac64af24416e05c199c01823048",
      parentHash: "0000000004b6f732a48af7041c4e68a8f472c8072ed98c4a8126bc6d01a9dd0b",
      version: 32,
...
// Feature flags URL
export const FEATURE_FLAGS_URL = "https://client-config.api.cx.metamask.io/v1/flags";
...
export const TRON_SWAP_TOKEN_REGISTRY = {
  TRX: {
    ...
    decimals: 6,
    name: "Tron",
    iconUrl: "https://static.cx.metamask.io/api/v2/tokenIcons/assets/tron/728126428/slip44/195.png",
  },
  USDT: {
    address: "TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t",
 ...
 * @param mockServer
 */
export async function mockTronFeatureFlags(mockServer: Mockttp): Promise<MockedEndpoint> {
  return mockServer
...
export async function mockBroadTransaction(mockServer: Mockttp): Promise<MockedEndpoint> {
  return mockServer.forPost(tronInfuraUrl("/wallet/broadcasttransaction")).thenCallback(() => ({
    statusCode: 200,
    json: {
      result: true,
...
export async function mockTronGetAccount(
  ...
  return mockServer
    .forGet(new RegExp(`^${TRON_INFURA_BASE_URL}/v1/accounts/${TRON_ACCOUNT_ADDRESS}($|\\?)`, "u"))
    .always()
    .thenCallback(() => ({
      statusCode: 200,
      json: {
        data: [
          {
            ...
            trc20: mockZeroBalance
              ...
              : [
                  {
                    TUPM7K8REVzD2UdV4R5fe5M8XbnR2DdoJ6: "3156454956836360132407885",
                  },
                  {
...
export async function createStatefulTronAccountMock(
  ...
  const current = (): TronAccountSnapshot => (broadcasted && after ? after : before);
  ...
  const buildTrc20Array = (snapshot: TronAccountSnapshot) => {
    ...
    for (const [symbol, rawAmount] of Object.entries(snapshot.trc20)) {
      const address = TRON_SWAP_TOKEN_REGISTRY[symbol as TronSwapSymbol]?.address;
...
export async function mockTronGetAccountResource(mockServer: Mockttp): Promise<MockedEndpoint> {
  return mockServer
...
export const DEFAULT_TRON_TRC20_TRANSACTIONS = [
  {
    transaction_id: "0f757bc78562fc03c305d84ce83ddde8dd3c71a76dd014cecc96656bd432c5d1",
    token_info: {
      symbol: "HTX",
      address: "TUPM7K8REVzD2UdV4R5fe5M8XbnR2DdoJ6",
      decimals: 18,
  ...
  {
    transaction_id: "47d6870d229f383e1bacc19967cb7be2c61d5ad4185b6848e91d2bc8c1616de1",
    token_info: {
      symbol: "USDT",
      address: "TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t",
      decimals: 6,
  ...
  {
    transaction_id: "c2f4a66600c3f46cfffdcb1886d72e48e5fe2d650c110ddeb6da7e6fda12ab12",
    token_info: {
      symbol: "USDT",
      address: "TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t",
      decimals: 6,
  ...
  {
    transaction_id: "ac605640c5f44f36c766894d6f1d8dca0290cba857470c46a863e1f52abfc798",
    token_info: {
      symbol: "USDT",
      address: "TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t",
      decimals: 6,
  ...
  {
    transaction_id: "fa1721d1e32a19fae77a7bf7e2f6dd72cd514924eeb2c9f33134d6e4a612bd6f",
    token_info: {
      symbol: "USDT",
      address: "TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t",
      decimals: 6,
  ...
  {
    transaction_id: "28070ab43f0180dc932f05977ffa96e6a6b767f496203961a8f1ccdc12ab5181",
    token_info: {
      symbol: "HTX",
      address: "TUPM7K8REVzD2UdV4R5fe5M8XbnR2DdoJ6",
      decimals: 18,
  ...
  {
    transaction_id: "33d8313c4d7f4999a900602063004352acf4a27e7d08d11bb050f36eaec398b5",
    token_info: {
      symbol: "USDD",
      address: "TXDk8mbtRbXeYuMNS83CfKPaYYT8XWv9Hz",
      decimals: 18,
  ...
  {
    transaction_id: "87951966199dce62daf8071726b1a1a14546191fa3e0d4820021cea2af407912",
    token_info: {
      symbol: "SEED",
      address: "TBwoSTyywvLrgjSgaatxrBhxt3DGpVuENh",
      decimals: 6,
  ...
  {
    transaction_id: "a0f85ddb6b9ebe00d45bf7c9f15a9ac296a333e5df49693d21275a6bd6d6ad0e",
    token_info: {
      symbol: "USDT",
      address: "TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t",
      decimals: 6,
  ...
  {
    transaction_id: "2225c7e900ba240aa82302bb8818118419f07e39c15998fd2dd81a2109d0069d",
    token_info: {
      symbol: "USDT",
      address: "TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t",
      decimals: 6,
...
export async function mockTronGetTrc20Transactions(
  ...
  return mockServer
    .forGet(tronInfuraUrl(`/v1/accounts/${TRON_ACCOUNT_ADDRESS}/transactions/trc20`))
    .thenCallback(() => ({
      statusCode: 200,
      json: {
        data: transactions,
...
export async function mockExchangeRates(mockServer: Mockttp): Promise<MockedEndpoint> {
  return mockServer
...
export async function mockFiatExchangeRates(mockServer: Mockttp): Promise<MockedEndpoint> {
  return mockServer
    ...
    .thenCallback((request) => {
      ...
      const requestedPrices = Object.fromEntries(
        (assetIds ?? Object.keys(pricesByAssetId)).map((assetId) => {
          const marketData = pricesByAssetId[assetId as keyof typeof pricesByAssetId] ?? null;
...
export async function mockTrxNativeSpotPrices(mockServer: Mockttp): Promise<MockedEndpoint[]> {
  ...
  const singleChainEndpoint = await mockServer
    ...
    .thenCallback(() => ({
      statusCode: 200,
      json: {
        "tron:728126428/slip44:195": trxPriceResponse["tron:728126428/slip44:195"],
      },
    }));
...
export async function mockTronGetReward(mockServer: Mockttp): Promise<MockedEndpoint> {
  return mockServer
...
export async function mockTronGetBlock(mockServer: Mockttp): Promise<MockedEndpoint> {
  return mockServer
...
export async function mockTronGetNowBlock(mockServer: Mockttp): Promise<MockedEndpoint> {
  return mockServer
...
export async function mockTronGetBlockByNum(mockServer: Mockttp): Promise<MockedEndpoint> {
  return mockServer
...
export async function mockBridgeGetTronTokens(mockServer: Mockttp): Promise<MockedEndpoint> {
...
export async function mockBridgeGetTronQuote(mockServer: Mockttp): Promise<MockedEndpoint> {
  return mockBridgeGetTronQuoteFor(mockServer, DEFAULT_TRON_QUOTE_FIXTURE);
}

export async function mockBridgeGetTronQuoteEmpty(mockServer: Mockttp): Promise<MockedEndpoint> {
  return mockServer
    .forGet(/^https:\/\/bridge\.(api|dev-api)\.cx\.metamask\.io\/getQuote/u)
    .thenCallback(() => ({
      statusCode: 200,
...
export async function mockTronGetChainParameters(mockServer: Mockttp): Promise<MockedEndpoint> {
  return mockServer
...
export async function mockTronGetNextMaintenanceTime(mockServer: Mockttp): Promise<MockedEndpoint> {
  return mockServer
...
export async function mockTronGetContract(mockServer: Mockttp): Promise<MockedEndpoint> {
  return mockServer
 ...
 * @param mockServer
 */
export async function mockAccountsApiV2WithTron(mockServer: Mockttp): Promise<MockedEndpoint> {
  return mockServer
...
export function createSwitchableTronSwapMocks(): SwitchableTronSwapMocks {
  ...
  const feeEstimationResponse = (buildJson: () => unknown) => () =>
    mode === "default" ? { statusCode: 200, json: buildJson() } : { statusCode: 200 };

  const testSpecificMock = async (mockServer: Mockttp): Promise<MockedEndpoint[]> => [
    ...
    await mockServer
      ...
      .thenCallback(() => ({
        statusCode: 200,
        json: mode === "noQuotes" ? [] : [buildTronQuoteResponseV1(DEFAULT_TRON_QUOTE_FIXTURE)],
      })),
    await mockServer
      .forGet(tronInfuraUrl("/wallet/getchainparameters"))
      .always()
    ...
    await mockServer
      .forPost(tronInfuraUrl("/wallet/getnextmaintenancetime"))
      .always()
      .thenCallback(feeEstimationResponse(buildTronNextMaintenanceTimeResponse)),
    await mockServer
      .forPost(tronInfuraUrl("/wallet/triggerconstantcontract"))
      .always()
      .thenCallback(feeEstimationResponse(buildTronTriggerConstantContractResponse)),
    await mockServer
      .forPost(tronInfuraUrl("/wallet/getcontract"))
      .always()
