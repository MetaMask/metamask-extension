...
export async function mockBridgeGetTronQuote(
  ...
  // TODO: This was meant to be shipped in the same PR as for the local node
  // but changes have been made in the mocks above, so being conservative
  // and keeping this code unreachable for now until we re-enable swap tests.
