...
/**
 * Recreates the legacy check-balance funded profile: the portfolio token set
 * with the native TRX balance raised to `TRX_BALANCE` (106.072 TRX).
 * Expected homepage headers: "106.072 TRX" (native-as-main balance) and
 * "$39.65" fiat (TRX $31.26 + HTX $5.30 + USDT $2.80 + USDD $0.29).
 */
