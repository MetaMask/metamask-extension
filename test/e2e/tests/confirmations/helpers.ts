 ...
 *
 * @param localNodeOptions - The input local node options.
 * @returns The normalized local node options.
 */
 ...
 * @param [localNode] - The local server instance (optional).
 * @param [address] - The address to check the balance for (optional).
 */
 ...
 * @param [options.navigate] - Whether to navigate to the root page prior to unlocking - defaults to true
 * @param [options.waitLoginSuccess] - Whether to wait for the login to succeed - defaults to true
 * @param [options.password] - Password to unlock wallet - defaults to shared WALLET_PASSWORD
 */
 ...
 * @param options.driver - The WebDriver instance controlling the browser.
 * @param [options.snapSigInsights] - Whether to wait for the insights snap to be ready before clicking the sign button.
 */
 ...
 *
 * @param driver - The WebDriver instance.
 * @param mockedEndpoints - mockttp mocked endpoints
 * @param [waitWhilePending] - Wait until no requests are pending
 * @returns
 */
 ...
 * @returns A promise that resolves when the menu is opened and any necessary waits are complete.
 */
