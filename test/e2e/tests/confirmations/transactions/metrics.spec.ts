  ...
  it('Sends a contract interaction type 2 transaction (EIP1559) with the right properties in the metric events', async function () {
    await withFixtures(
      ...
      async ({
        ...
        assert.equal(events[0].properties.ui_customizations, undefined);
        ...
        assert.equal(events[1].properties.ui_customizations, undefined);
        assert.equal(events[1].properties.transaction_advanced_view, undefined);
        assert.equal(
          events[2].event,
          AnonymousTransactionMetaMetricsEvent.submitted,
        );
        assert.equal(events[2].properties.ui_customizations, undefined);
        ...
        assert.equal(events[3].properties.ui_customizations, undefined);
        assert.equal(events[3].properties.transaction_advanced_view, undefined);
        assert.equal(
          events[4].event,
          AnonymousTransactionMetaMetricsEvent.approved,
        );
        assert.equal(events[4].properties.ui_customizations, undefined);
        ...
        assert.equal(events[5].properties.ui_customizations, undefined);
        assert.equal(events[5].properties.transaction_advanced_view, undefined);
        assert.equal(
          events[6].event,
          AnonymousTransactionMetaMetricsEvent.finalized,
        );
        assert.equal(events[6].properties.ui_customizations, undefined);
        ...
        assert.equal(events[7].properties.ui_customizations, undefined);
        ...
        assert.equal(events[8].properties.ui_customizations, undefined);
        ...
        assert.equal(events[9].properties.ui_customizations, undefined);
        assert.equal(events[9].properties.transaction_advanced_view, undefined);
        assert.equal(
          events[10].event,
          AnonymousTransactionMetaMetricsEvent.submitted,
        );
        assert.equal(events[10].properties.ui_customizations, undefined);
        ...
        assert.equal(events[11].properties.ui_customizations, undefined);
        assert.equal(events[11].properties.transaction_advanced_view, true);
        assert.equal(
          events[12].event,
          AnonymousTransactionMetaMetricsEvent.approved,
        );
        assert.equal(events[12].properties.ui_customizations, undefined);
        ...
        assert.equal(events[13].properties.ui_customizations, undefined);
        assert.equal(events[13].properties.transaction_advanced_view, true);
        assert.equal(
          events[14].event,
          AnonymousTransactionMetaMetricsEvent.finalized,
        );
        assert.equal(events[14].properties.ui_customizations, undefined);
        ...
        assert.equal(events[15].properties.ui_customizations, undefined);
