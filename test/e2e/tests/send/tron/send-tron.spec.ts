  ...
  configureTronFixtureSession(
    ...
    ({ getDriver, getFixtures }) => {
      ...
      it('blocks Continue on invalid Tron send form input', async function () {
        ...
        console.log(
          'Checking Continue is blocked when a bad address is entered',
        );
      ...
      describe('confirmed sends', function () {
        ...
        it('confirms a partial TRX send in the activity list', async function () {
          await switchToTronAccountForSend({
        ...
        it('confirms a partial USDT send in the activity list', async function () {
          await switchToTronAccountForSend({
