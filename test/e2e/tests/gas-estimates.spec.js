const { toEthChainIdInt } = require('@metamask/controller-utils');
const {
  convertToHexValue,
  withFixtures,
      ...
      await withFixtures(
        {
          ...
          ganacheOptions: {
            ...
            chainId: toEthChainIdInt(CAIP_CHAIN_IDS.BSC),
          },
          title: this.test.title,
        },
        async ({ driver, ganacheServer }) => {
      ...
      await withFixtures(
        {
          ...
          testSpecificMock: (mockServer) => {
            mockServer
              .forGet(
                `https://gas-api.metaswap.codefi.network/networks/${toEthChainIdInt(CAIP_CHAIN_IDS.BSC)}/gasPrices`,
              )
              .thenCallback(() => {
                return {
                  statusCode: 422,
