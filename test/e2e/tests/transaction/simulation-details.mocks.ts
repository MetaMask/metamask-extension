export const SENDER_ADDRESS_NO_0x_MOCK = '5cfe73b6021e818b776b421b1c4db2474086a7e1';
...
export const INSUFFICIENT_GAS_REQUEST_MOCK = {
  response: {
    ...
    "error": {
      "code": -32000,
      "message": `debug_traceCall failed: w3: 3 calls failed:\ncall[0]: tracing failed: insufficient funds for gas * price + value: address 0x${SENDER_ADDRESS_NO_0x_MOCK} have 0 want 1000000000000000\ncall[1]: tracing failed: insufficient funds for gas * price + value: address 0x${SENDER_ADDRESS_NO_0x_MOCK} have 0 want 1000000000000000\ncall[2]: failed with 500000000 gas: insufficient funds for gas * price + value: address 0x${SENDER_ADDRESS_NO_0x_MOCK} have 0 want 1000000000000000`
    },
    "id": "1"
  },
};
