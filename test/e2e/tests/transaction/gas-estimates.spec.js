...
async function mockBinanceRelatedRequestsWithGasApiDown(mockServer) {
  ...
  const flagMocking = mockLegacySendFeatureFlag(mockServer);
  return [...relatedRequests, gasApiDownRequest, flagMocking];
}
...
async function mockBinanceRelatedRequestsWithGasApiAvailable(mockServer) {
  ...
  const flagMocking = mockLegacySendFeatureFlag(mockServer);
  return [...relatedRequests, gasApiAvailableRequest, flagMocking];
}
