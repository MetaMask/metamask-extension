      ...
      await withFixtures(
        {
          ...
          testSpecificMock: (mockServer) => {
            // A request with the chainId from BSC should happen, but there's currently an issue (#33377) which passes chainId 1
            // The chainId below should be changed to BSC once the issue is fixed
            mockServer
              .forGet(
