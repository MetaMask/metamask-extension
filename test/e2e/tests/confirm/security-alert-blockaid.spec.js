...
async function mockInfura(mockServer) {
  ...
  // await mockServer
  //   .forPost()
  //   .withJsonBodyIncluding({ method: 'eth_getTokenBalance' })
  //   .thenCallback((req) => {
  //     return {
  //       statusCode: 200,
  //       json: {
  ...
  //               "tokenBalance": "0x0000000000000000000000000000000000000000000000487a9a304539440000"
  //             },
  //           ],
  //         },
  //       },
    ...
    await withFixtures(
      ...
      async ({ driver }) => {
        ...
        for (const config of testBenignConfigs) {
          ...
          console.log('tested ', logExpectedDetail);
    ...
    await withFixtures(
      ...
      async ({ driver }) => {
        ...
        for (const config of test) {
          ...
          console.log(`testing ${expectedReason}`);
