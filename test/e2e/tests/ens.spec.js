...
describe('ENS', function () {
  ...
  const sampleAddress2 = '2222222222222222222222222222222222222222';
  ...
  const infuraUrl2 =
    'https://mainnet.infura.io/v3/00000000000000000000000000000002';
      ...
      .thenCallback(() => {
        return {
          ...
          json: {
            jsonrpc: '2.0',
            id: '1111111111111111',
            result: `0x000000000000000000000000${sampleAddress2}`,
          },
        };
      });
  }
  ...
  it.only('domain resolves to a correct address after changing network', async function () {
    await withFixtures(
      {
        fixtures: new FixtureBuilder().withNetworkControllerOnMainnet().build(),
        ganacheOptions: defaultGanacheOptions,
