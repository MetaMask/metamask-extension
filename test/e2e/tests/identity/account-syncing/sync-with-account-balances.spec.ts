    ...
    it('when a user has balances on more accounts than previously synced, it should be handled gracefully', async function () {
      ...
      await withFixtures(
        ...
        async ({ driver }) => {
          ...
          await accountListPage.check_numberOfAvailableAccounts(4, ACCOUNT_TYPE.Ethereum);
      ...
      await withFixtures(
        ...
        async ({ driver }) => {
          ...
          const accountListPage = new AccountListPage(driver);
          await accountListPage.check_pageIsLoaded();
          await accountListPage.check_numberOfAvailableAccounts(6, ACCOUNT_TYPE.Ethereum);
