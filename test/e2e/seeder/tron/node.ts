...
const JAVA_TRON_PRIVATE_NETWORK_PORT_LABELS = {
  backupPort: 'java-tron backup port',
  fullNodePort: 'java-tron HTTP full node port',
  grpcPort: 'java-tron gRPC port',
  grpcSolidityPort: 'java-tron Solidity gRPC port',
  jsonRpcPort: 'java-tron JSON-RPC port',
  jsonRpcSolidityPort: 'java-tron Solidity JSON-RPC port',
  pbftGrpcPort: 'java-tron PBFT gRPC port',
  pbftHttpPort: 'java-tron PBFT HTTP port',
  p2pPort: 'java-tron P2P port',
  solidityHttpPort: 'java-tron Solidity HTTP port',
...
export class TronNode {
  ...
  async #startNativeJavaTron(
    ...
    // java-tron brings up ten configured ports: full-node HTTP (`baseUrl`),
    // solidity HTTP, gRPC, solidity gRPC, PBFT HTTP, PBFT gRPC, JSON-RPC
    // full-node, JSON-RPC solidity, P2P, and backup. The PBFT ports default to
    // fixed listeners unless configured, so they must stay customizable.
