...
describe('MetaMask', function () {
  ...
  describe('Send ETH from dapp using advanced gas controls', () => {
    ...
    it('goes to the settings screen', async () => {
      ...
      const showConversionToggle = await findElement(driver, By.css('.settings-page__content-row:nth-of-type(6) .settings-page__content-item-col > div'))
      ...
      const advancedGasToggle = await findElement(driver, By.css('.settings-page__content-row:nth-of-type(4) .settings-page__content-item-col > div'))
