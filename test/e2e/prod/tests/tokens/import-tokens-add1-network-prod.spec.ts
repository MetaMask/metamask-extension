    ...
    await withProductionFixtures(
      {
        fixtures: new FixtureBuilder()
          .withNetworkControllerOnMonad() // Start with Monad instead of localhost
          .build(),
        title:
          this.test?.fullTitle() ||
      ...
      async ({ driver }) => {
        ...
        // Import LINK token on Monad: 0x779877A7B0D9E8603169DdbD7836e478b4624789
        console.log('[PROD TEST] Importing LINK token on Monad...');
        await assetListPage.importCustomTokenByChain(
          '0x8f', // Monad chain ID in hex
          '0x4917a5ec9fCb5e10f47CBB197aBe6aB63be81fE8', // LINK on Monad
        );
