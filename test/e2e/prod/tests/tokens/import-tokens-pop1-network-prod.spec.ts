  ...
  it('adds Sepolia testnet as custom network and imports tokens', async function () {
    await withProductionFixtures(
      ...
      async ({ driver }) => {
        ...
        console.log('[PROD TEST] Importing tokens on Base...');

        const assetListPage = new AssetListPage(driver);

        // Import LINK token on Base: 0x779877A7B0D9E8603169DdbD7836e478b4624789
        console.log('[PROD TEST] Importing LINK token on Base...');
        await assetListPage.importCustomTokenByChain(
          '0x2105', // Base chain ID in hex
          '0x779877A7B0D9E8603169DdbD7836e478b4624789', // LINK on Base
        );
