 ...
 *
 * Alias of {@link selectTronNetwork}: both now use the same delay-free
 * readiness-wait + filter-selection path. Kept as a separate export so
 * activity flows can name their intent explicitly.
 *
 * @param driver - WebDriver instance
 */
