 ...
 * @param [options.optedIn] - Whether to participate in MetaMetrics. Defaults to false.
...
export async function onboardingMetricsFlow(
  ...
  // Wait for the analyticsId to be present so subsequent screens track events
 ...
 * @param params.optedIn - Whether to participate in MetaMetrics. Defaults to false.
