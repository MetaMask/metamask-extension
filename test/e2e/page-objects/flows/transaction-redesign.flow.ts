...
export const createERC721RevokeSetApprovalForAllTransaction = async (
  driver: Driver,
  contractAddress: string,
) => {
  console.log('Create ERC721 Revoke setApprovalForAll transaction');
...
export const createERC1155RevokeSetApprovalForAllTransaction = async (
  driver: Driver,
  contractAddress: string,
) => {
  console.log('Create ERC1155 Revoke setApprovalForAll transaction');
...
export const assertRevokeSetApprovalForAllTitle = async (driver: Driver) => {
  console.log(
    'Assert contents of revoke set approval for all title and subheading',
  );
  ...
  await dialog.check_revokeSetApprovalForAllTitle();
};
