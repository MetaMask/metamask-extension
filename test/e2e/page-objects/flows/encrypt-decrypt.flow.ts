 ...
 * @param balanceValue - The balance value to check, default is 25 ETH.
 */
// TODO: replace DEFAULT_GANACHE_ETH_BALANCE_DEC with default anvil balance value
export async function getEncryptionKeyInDapp(driver: Driver, encryptionKey: string, balanceValue: string = DEFAULT_GANACHE_ETH_BALANCE_DEC + ' ETH') {
 ...
 */
// TODO: replace DEFAULT_GANACHE_ETH_BALANCE_DEC with default anvil balance value
export async function decryptMessageAndVerifyResult(driver: Driver, message: string, balanceValue: string = DEFAULT_GANACHE_ETH_BALANCE_DEC + ' ETH') {
