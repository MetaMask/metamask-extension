...
class ChromeDriver {
  static async build({
    ...
    // Required for running Chrome reliably in Linux containers/CI.
    // We set this unconditionally (including headless) to avoid
    // "DevToolsActivePort file doesn't exist" startup failures.
