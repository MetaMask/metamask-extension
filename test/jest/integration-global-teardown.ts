/**
 * Jest integration tests global teardown
...
async function globalTeardown(): Promise<void> {
  ...
  try {
    ...
    console.error('Error in integration global teardown:', error);
    throw error;
  }
}
...
async function aggregateTestSnapshots() {
  ...
  const snapshotType = process.env.WARNINGS_SNAPSHOT_TYPE || 'integration';
