...
import { ModalBody } from '../ui/components/component-library/modal-body/modal-body';
...
The `ModalBody` story uses `argTypes` and defaults via `args`:
...
Displays body content within a modal.

<Canvas>
  <Story id="components-componentlibrary-modalbody--default" />
</Canvas>
