...
- Display the component's API using the `<ArgTypes of={YourComponent} />` component from storybook docs. Add descriptions of each prop by using jsDoc style comments in the `propTypes`.
...
<!-- import the component to use for the ArgTypes under ## Props  -->
...
<!-- Display the Props using the ArgTypes. Use JSDoc style comments in the PropTypes of your component to add descriptions for props. See button.component.js Button.propTypes for an example of jsDoc style comments
-->
