      ...
      case OPTION_VALUES.SHAPESHIFT:
        return (
          <div className="buy-ether__action-content-wrapper">
            ...
            <div className="buy-ether__body-text">Trade any leading blockchain asset for any other. Protection by Design. No Account Needed.</div>
            <div className="buy-ether__buttons">
              <button
                className="first-time-flow__button"
              >
  ...
  render() {
    ...
    return (
      <div className="buy-ether">
        ...
        <div className="buy-ether__title">Buy Ether</div>
        ...
        <div className="buy-ether__content-wrapper">
          <div className="buy-ether__content-headline">Purchasing Options</div>
