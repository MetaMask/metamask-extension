 ...
 * @param options.initControllersByName - A collection of controllers keyed by name (excluding
 * those initialized here)
...
export function initControllers({
  ...
  initControllersByName: Omit<ControllerByName, ControllersToInitialize>;
  initFunctions: Record<
    ControllersToInitialize,
    ControllerInitFunction<Controller>
  >;
  ...
  let controllersByName = initControllersByName as ControllerByName;
