 ...
 */
export function getMultichainAccountServiceMessenger(messenger: RootMessenger<Actions, Events>) {
...
export function getMultichainAccountServiceInitMessenger(
  ...
  messenger.delegate({
    ...
    actions: ["PreferencesController:getState", "RemoteFeatureFlagController:getState"],
