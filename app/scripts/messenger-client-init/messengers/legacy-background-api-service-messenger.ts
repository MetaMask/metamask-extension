...
/**
 * Actions that {@link LegacyBackgroundApiService} is allowed to call via its
 * restricted messenger. Shared with the service unit-test harness so the
 * allowlists cannot drift.
 */
export const LEGACY_BACKGROUND_API_SERVICE_ALLOWED_ACTIONS = [
