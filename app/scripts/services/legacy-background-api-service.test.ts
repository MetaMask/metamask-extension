...
import { LEGACY_BACKGROUND_API_SERVICE_ALLOWED_ACTIONS } from '../messenger-client-init/messengers/legacy-background-api-service-messenger';
import {
...
function getMessenger(
  ...
  rootMessenger.delegate({
    ...
    actions: [...LEGACY_BACKGROUND_API_SERVICE_ALLOWED_ACTIONS],
  });
