...
type MigrationInput = Parameters<typeof migration77.migrate>[0];
...
describe('migration #77', () => {
  it('should update the version metadata', async () => {
    ...
    const newStorage = await migration77.migrate(
  ...
  it('should return state unchanged if token list controller is missing', async () => {
    ...
    const newStorage = await migration77.migrate(
      cloneDeep(oldStorage as unknown as MigrationInput),
    );
  ...
  it('should capture an exception if the TokenListController state is invalid', async () => {
    ...
    await migration77.migrate(oldStorage as unknown as MigrationInput);
