...
type MigrationInput = Parameters<typeof migration37.migrate>[0];

type AddressBookControllerFixture = {
...
describe('migration #37', () => {
  it('should update the version metadata', async () => {
    ...
    const newStorage = await migration37.migrate(
  ...
  it('should transform old state to new format', async () => {
    ...
    expect(
      (newStorage.data as AddressBookControllerFixture).AddressBookController
        .addressBook,
    ).toStrictEqual({
      4: {
        '0x1De7e54679bfF0c23856FbF547b2394e723FCA91': {
