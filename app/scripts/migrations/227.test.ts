...
describe(`migration #${VERSION}`, () => {
  ...
  it('removes tracesBeforeMetricsOptIn from MetaMetricsController', async () => {
    const oldStorage: VersionedData = {
      meta: { version: OLD_VERSION },
      data: {
        MetaMetricsController: {
          tracesBeforeMetricsOptIn: [
            { type: 'start', request: { name: 'Transaction' } },
          ],
  ...
  it('leaves MetaMetricsController untouched when it has no tracesBeforeMetricsOptIn', async () => {
    const oldStorage: VersionedData = {
      meta: { version: OLD_VERSION },
      data: {
        MetaMetricsController: {
