...
describe('migration #68', () => {
  ...
  it('should migrate all data', async () => {
    ...
    expect(newStorage.data?.PermissionsController).toBeUndefined();
    expect(newStorage.data?.PermissionsMetadata).toBeUndefined();
  });
  ...
  it('skips malformed permission entries instead of throwing', async () => {
    const oldStorage = {
      meta: {},
      data: {
              ...
              permissions: [
                {
                  ...
                  date: 1,
                  id: 'valid-permission',
                  invoker: 'https://valid.example',
                  parentCapability: 'eth_accounts',
                },
              ],
            },
            'https://missing-permission.example': {
              permissions: [],
            },
            'https://missing-caveat.example': {
              permissions: [
                {
                  caveats: [],
                  date: 2,
                  id: 'missing-caveat',
                  invoker: 'https://missing-caveat.example',
                  parentCapability: 'eth_accounts',
                },
              ],
            },
