...
describe('migration #77', () => {
  ...
  describe('migration #77 supplements', () => {
    ...
    describe('state transformation to ahead of migration 88', () => {
      ...
      it('deletes entries in TokensController.allIgnoredTokens that have decimal chain IDs if there exists an entry with the equivalent chainId in hex', async () => {
        const oldStorage = {
          meta: { version: 87 },
          data: {
            TokenListController: {
      ...
      it('deletes entries in TokensController.allDetectedTokens that have decimal chain IDs if there exists an entry with the equivalent chainId in hex', async () => {
        const oldStorage = {
          meta: { version: 87 },
          data: {
            TokenListController: {
