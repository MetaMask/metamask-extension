 ...
 * @returns Returns an error message, either the same as was passed, or the ending message portion of an isEthjsRpcError
 * @example
 ...
 */
export default function extractEthjsErrorMessage(errorMessage: string): string {
