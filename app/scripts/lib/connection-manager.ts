...
export class ConnectionManager {
   ...
   * @param origin
   * @param _notification
   * @param _notification.method
   * @param _notification.params
   */
  notifyConnections(
    origin: string,
    _notification: { method: string; params?: unknown },
  ): void {
   ...
   * @param _notification.params
   */
  notifyAllConnections(_notification: {
    method: string;
    params?: unknown;
  }): void {
    // TODO: emit notification to all connections via engine
  }
