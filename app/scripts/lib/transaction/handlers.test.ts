...
jest.mock('./metrics', () => ({
  ...
  onTransactionConfirmed: jest.fn().mockResolvedValue({}),
  onTransactionDropped: jest.fn().mockResolvedValue({}),
  onTransactionFailed: jest.fn().mockResolvedValue({}),
...
describe('Transaction handlers', () => {
  ...
  it.each([
    ...
    ['handleTransactionConfirmed', 'onTransactionConfirmed'],
    ['handleTransactionDropped', 'onTransactionDropped'],
    ['handleTransactionFailed', 'onTransactionFailed'],
