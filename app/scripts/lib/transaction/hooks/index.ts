...
export function getTransactionControllerHooks(
  ...
  return {
    ...
    beforeCheckPendingTransactions: beforeCheckPendingTransactionsHook(request),
...
export function afterAddHook({ messenger }: TransactionControllerHookRequest) {
...
export function beforePublishHook({
  messenger,
...
export function beforeSignHook({
  messenger,
}: TransactionControllerHookRequest) {
...
export function beforeCheckPendingTransactionsHook({
  messenger,
}: TransactionControllerHookRequest) {
  return (transactionMeta: TransactionMeta) =>
    messenger.call(
