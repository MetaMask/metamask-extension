...
import { SnapKeyringBuilderAllowActions, SnapKeyringBuilderV2Messenger } from "./types";
...
describe("SnapKeyringV2Impl", () => {
  ...
  describe("assertAccountCanBeUsed", () => {
    it("is a no-op (resolves without throwing or calling the messenger)", async () => {
      ...
      await expect(impl.assertAccountCanBeUsed(mockAccount)).resolves.toBeUndefined();
...
describe("snapKeyringBuilderV2", () => {
  ...
  describe("v1Builder", () => {
    it("creates a KeyringV1Adapter wrapping a SnapKeyringV2 instance", () => {
      ...
      expect((keyring as unknown as KeyringV1Adapter).unwrap()).toBeInstanceOf(SnapKeyringV2);
    });
