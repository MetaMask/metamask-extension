 ...
 * @param txId
 * @param opts
 * @param opts.useSmartTransaction
 */
 ...
 * @param transactionMeta.status
 * @param transactionMeta.chainId
 * @param transactionMeta.type
 * @param transactionMeta.txParams
 * @param transactionMeta.txReceipt
 * @param transactionMeta.txReceipt.status
 * @param transactionMeta.txReceipt.logs
 * @param transactionMeta.simulationFails
 * @param transactionMeta.simulationFails.reason
 * @param opts
 * @param opts.confirmedStatus
 * @param opts.failedStatus
 * @param opts.createNotification
 * @param opts.updateNftOwnership
 * @param opts.trackFailure
 * @param opts.updateTokenBalances
 ...
 * @param transactionMeta.chainId
 * @param opts
 * @param opts.getNetworkConfigurationsByChainId
 */
 ...
 * @param transactionMeta.chainId
 * @param transactionMeta.txParams
 * @param transactionMeta.txParams.data
 * @param transactionMeta.txParams.to
 * @param transactionMeta.txParams.from
 * @param transactionMeta.txReceipt
 * @param transactionMeta.txReceipt.logs
 * @param opts
 * @param opts.tokenMethodTransferFrom
 * @param opts.tokenMethodSafeTransferFrom
 * @param opts.contractInteraction
 * @param opts.transferSingleLogTopicHash
 * @param opts.tokenTransferLogTopicHash
 * @param opts.getNftState
 * @param opts.getNetworkClientIdForChain
 * @param opts.parseStandardTokenTransactionData
 * @param opts.getTokenIdParam
 * @param opts.getTokenValueParam
 * @param opts.isEqualCaseInsensitive
 * @param opts.abiERC721
 * @param opts.abiERC1155
 * @param opts.abiInterface
 */
  ...
  allNftTransferLog.forEach((singleLog) => {
    if (
      ...
      const iface = singleLog.isERC1155NftTransfer
        ? new opts.abiInterface(opts.abiERC1155)
        : new opts.abiInterface(opts.abiERC721);
 ...
 * @param transactionMeta.simulationFails.reason
 * @param opts
 * @param opts.metaMetricsEventCategoryBackground
 ...
 * @param deps
 * @param address
 * @param upgradeContractAddress
 * @param chainId
 * @param opts
 * @param opts.toHex
 * @param opts.findNetworkClientIdByChainId
 * @param opts.createEIP7702UpgradeTransaction
 * @param opts.getAddTransactionRequest
 */
 ...
 * @param request.chainId
 * @param opts
 * @param opts.findAtomicBatchSupportForChain
 * @param opts.checkEip7702Support
 */
