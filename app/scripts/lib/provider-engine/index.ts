...
export class ProviderEngineFactory {
   ...
   * @param _options
   * @param _options.origin
   * @param _options.subjectType
   * @param _options.sender
   * @param _options.tabId
   * @param _options.mainFrameOrigin
   */
  buildEip1193Engine(_options: {
    origin: string;
    subjectType: string;
    sender: unknown;
    tabId?: number;
   ...
   * @param _origin
   */
  buildCommonHooks(_origin: string): Record<string, unknown> {
    return {};
  }
}
