...
describe('submitSmartTransactionHook', () => {
  ...
  describe('shouldShowStatusPage logic', () => {
    ...
    it('does not show status page for perpsDepositAndOrder when there are batch transactions', async () => {
      withRequest(
        {
          options: {
            transactionMeta: {
    ...
    it('does not show status page for perpsRelayDeposit when there are batch transactions', async () => {
      withRequest(
        {
          options: {
            transactionMeta: {
