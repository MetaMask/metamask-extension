  ...
  describe('MetaMaskController Behaviour', () => {
    ...
    describe('MultichainAssetsController', () => {
      ...
      const updatedAssetsList = {
        ...
        params: {
          assets: {
            '21690786-6abd-45d8-a9f0-9ff1d8ca76a1': {
      ...
      beforeEach(() => {
        jest.useFakeTimers();
        jest.spyOn(
          MultichainAssetsController.prototype,
          'updateAccountAssetsList',
        );
      ...
      it('should call updateAccountAssetsList on multichainAssetsController when notify:accountAssetListUpdated is triggered', () => {
        metamaskController.controllerMessenger.publish(
        ...
        expect(
          localMetamaskController.multichainAssetsController
            .updateAccountAssetsList,
        ).toHaveBeenCalled();
      });
    });
