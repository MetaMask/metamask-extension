...
export const SINGLE_CALL_BALANCES_ADDRESS_EUROPA_SKALE =
  '0xb44d3D2865841F4051332AF90EbE028e01f92f7C';
export const SINGLE_CALL_BALANCES_ADDRESS_CALYPSO_SKALE =
  '0x546753F1B9cd13459DB496C42735a503953668f8';
export const SINGLE_CALL_BALANCES_ADDRESS_NEBULA_SKALE =
