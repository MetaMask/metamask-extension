...
export default class MetamaskController extends EventEmitter {
        ...
        if (!prevCompletedOnboarding && currCompletedOnboarding) {
          ...
          if (firstTimeFlowType === FirstTimeFlowType.socialImport) {
            ...
            await Promise.allSettled(
              this.getHDKeyringObjects().map((keyring) =>
                this.discoverAndCreateAccounts(keyring.metadata.id),
              ),
            );
          } else {
  ...
  /**
   * Returns list of HD keyrings.
   *
   * @returns {KeyringObject[]} The list of HD keyrings.
   */
  getHDKeyringObjects() {
  ...
  getHDEntropyIndex() {
    const selectedAccount = this.accountsController.getSelectedAccount();
    const index = this.getHDKeyringObjects().findIndex((keyring) =>
