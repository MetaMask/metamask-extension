...
//=============================================================================
   ...
   */
  async setCustomRpc (rpcTarget, chainId, ticker = 'ETH') {
    this.networkController.setRpcTarget(rpcTarget, chainId, ticker)
    await this.preferencesController.addToFrequentRpcList(rpcTarget, chainId, ticker)
    return rpcTarget
  }
