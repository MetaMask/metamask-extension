...
export default class MetamaskController extends EventEmitter {
  ...
  /**
   * Resolves whether this user has a usable Money Account: the feature flag is
   * on, the address can be derived, and that address has an EIP-7702
   * delegation on Monad. The whole Money surface is hidden when it is not
   * available, so this is the one answer callers need — see
