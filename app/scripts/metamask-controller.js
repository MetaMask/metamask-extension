...
import { registerActions as registerTokenResolutionActions } from './lib/wallet-services/token-resolution';
import {
...
export default class MetamaskController extends EventEmitter {
  ...
  constructor(opts) {
    ...
    registerTokenResolutionActions(this.controllerMessenger, {
      getGlobalChainId: this.#getGlobalChainId.bind(this),
      getMetaMaskState: this._getMetaMaskState.bind(this),
      getNetworkControllerState: () => this.networkController.state,
  ...
  getApi() {
    ...
    return {
      ...
      getTokenStandardAndDetails: (...args) =>
        this.controllerMessenger.call(
          'TokenResolution:getTokenStandardAndDetails',
          ...args,
        ),
      getTokenSymbol: this.getTokenSymbol.bind(this),
      getTokenStandardAndDetailsByChain: (...args) =>
        this.controllerMessenger.call(
