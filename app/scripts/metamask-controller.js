...
export default class MetamaskController extends EventEmitter {
  ...
  //========
  // We can remove `getApi` since everything that was here before should (in
  // theory) be accessible either through the root messenger or the patch-store
  // substream.
  //
  // Note that there are other changes necessary to truly get rid of this,
  // but you get the idea.
  //
  // There are also thousands of lines of Redux action code we can remove, but
  // I'm not going to do that, you can imagine it ;)
  //========
