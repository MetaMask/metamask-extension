...
export default class SwapsController {
  ...
  async fetchAndSetQuotesBase(
    fetchParams,
    fetchParamsMetaData = {},
    isPolledRequest,
    fetchTradesInfoFn,
    getAllQuotesWithGasEstimatesFn,
    findTopQuoteAndCalculateSavingsFn,
    pollForNewQuotesFn,
  ) {
    ...
    if (!approvalRequired && !fetchParams?.balanceError) {
      newQuotes = await getAllQuotesWithGasEstimatesFn(newQuotes);
    }
    ...
    if (Object.values(newQuotes).length === 0) {
      ...
      const [_topAggId, quotesWithSavingsAndFeeData] =
        await findTopQuoteAndCalculateSavingsFn(newQuotes);
      topAggId = _topAggId;
  ...
  async fetchAndSetQuotes(
    ...
    return this.fetchAndSetQuotesBase(
      fetchParams,
      fetchParamsMetaData,
      isPolledRequest,
      this._fetchTradesInfo.bind(this),
      this.getAllQuotesWithGasEstimates.bind(this),
      this._findTopQuoteAndCalculateSavings.bind(this),
      this.pollForNewQuotes.bind(this),
    );
  }
  ...
  async fetchAndSetQuotesV2(
    ...
    return this.fetchAndSetQuotesBase(
      ...
      fetchParamsMetaData,
      isPolledRequest,
      this._fetchQuotesInfoV2.bind(this),
      this.getAllQuotesWithGasEstimatesV2.bind(this),
      this._findTopQuoteAndCalculateSavingsV2.bind(this),
      this.pollForNewQuotesV2.bind(this),
    );
  }
