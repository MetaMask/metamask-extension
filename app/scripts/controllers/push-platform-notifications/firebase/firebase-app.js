 ...
 * limitations under the License.
 */
const getDefaultsFromGlobal = () => getGlobal().FIREBASE_CONFIG;
/**
 * Attempt to read defaults from a JSON string provided to
 * process(.)env(.)FIREBASE_CONFIG or a JSON file whose path is in
...
const getDefaultsFromEnvVariable = () => {
    ...
    const defaultsJsonString = process.env.FIREBASE_CONFIG;
...
const getDefaultsFromCookie = () => {
    ...
    let match;
    try {
        match = document.cookie.match(/FIREBASE_CONFIG=([^;]+)/);
    }
    catch (e) {
...
/**
 * Get the FIREBASE_CONFIG object. It checks in order:
...
const getDefaults = () => {
    try {
        ...
        /**
         * Catch-all for being unable to get FIREBASE_CONFIG due
         * to any environment case we have not accounted for. Log to
         * info instead of swallowing so we can find these unknown cases
         * and add paths for them if needed.
         */
        console.info(`Unable to get FIREBASE_CONFIG due to: ${e}`);
        return;
    }
};
/**
 * Returns Firebase app config stored in the FIREBASE_CONFIG object.
 * @public
 */
