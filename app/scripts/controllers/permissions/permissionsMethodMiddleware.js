 ...
 *
 * @param options
 * @param options.addDomainMetadata
 * @param options.getAccounts
 * @param options.getUnlockPromise
 * @param options.hasPermission
 * @param options.notifyAccountsChanged
 * @param options.requestAccountsPermission
 */
